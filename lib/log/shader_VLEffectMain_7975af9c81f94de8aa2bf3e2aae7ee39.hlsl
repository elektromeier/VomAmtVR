...
@C    InputValue_id232 => ShaderFX.InputValueFloat
@C    InputValue_id241 => ShaderFX.InputValueFloat.i1
...
@R    InstanceWorldInverse_id41 => TransformationInstancing.InstanceWorldInverse [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id253 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id253 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id253 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
@R    CubeMap_id197 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (7-7)]
@R    CubeMap_id208 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[2] [Stage: Pixel, Slot: (8-8)]
...
*****     Stages      *****
***************************
@G    Vertex => 2f36a0b19ee484936ad0abd1bc5092bd
//
...
//
#line 1552 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_7975af9c81f94de8aa2bf3e2aae7ee39.hlsl"
...
@G    Pixel => 7fa0d34592dea3c581fc9a453d038314
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id232;            // Offset:   32 Size:     4
//   float InputValue_id241;            // Offset:   36 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id253    texture  float4          2d             t1      1 
...
// CubeMap_id197                     texture  float4        cube             t7      1 
// CubeMap_id208                     texture  float4        cube             t8      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 1684 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_7975af9c81f94de8aa2bf3e2aae7ee39.hlsl"
...
mad r7.xyz, cb1[2].yyyy, r7.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r7.x <- streams.matSpecular_id57.x; r7.y <- streams.matSpecular_id57.y; r7.z <- streams.matSpecular_id57.z

#line 1489
mad r8.xyz, cb1[2].yyyy, -cb1[0].xyzx, cb1[0].xyzx  // r8.x <- streams.matDiffuse_id55.x; r8.y <- streams.matDiffuse_id55.y; r8.z <- streams.matDiffuse_id55.z
...
rsq r1.w, r1.w
mul r1.xyz, r1.wwww, r1.xyzx  // r1.x <- streams.normalWS_id19.x; r1.y <- streams.normalWS_id19.y; r1.z <- streams.normalWS_id19.z
...
max r2.y, r1.w, l(0.000100)  // r2.y <- streams.NdotV_id74
...
#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t2.xxxx, s1, r6.z  // r5.w <- <SampleTextureAndCompare_id71 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r15.zwzz, t2.xxxx, s1, r6.z  // r6.w <- <SampleTextureAndCompare_id71 return value>
...
#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r17.xyxx, t2.xxxx, s1, r6.z  // r6.w <- <SampleTextureAndCompare_id71 return value>

#line 631
  mad r5.w, r6.x, r6.w, r5.w

#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r18.xyxx, t2.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id71 return value>
...
#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r17.zwzz, t2.xxxx, s1, r6.z

#line 631
  mad r5.w, r9.z, r6.x, r5.w

#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r18.zwzz, t2.xxxx, s1, r6.z
...
#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r14.zwzz, t2.xxxx, s1, r6.z

#line 631
  mad r5.w, r20.y, r6.x, r5.w

#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r13.ywyy, t2.xxxx, s1, r6.z
...
#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r12.ywyy, t2.xxxx, s1, r6.z

#line 631
  mad r5.w, r10.w, r6.x, r5.w

#line 526
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r9.xyxx, t2.xxxx, s1, r6.z
...
#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r15.xyxx, t2.xxxx, s1, r3.z  // r2.w <- <SampleTextureAndCompare_id71 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.zwzz, t2.xxxx, s1, r3.z  // r3.w <- <SampleTextureAndCompare_id71 return value>
...
#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t2.xxxx, s1, r3.z  // r3.w <- <SampleTextureAndCompare_id71 return value>

#line 631
      mad r2.w, r3.x, r3.w, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r18.xyxx, t2.xxxx, s1, r3.z  // r3.x <- <SampleTextureAndCompare_id71 return value>

#line 631
      mad r2.w, r13.x, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r16.xyxx, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r10.y, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r16.zwzz, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r20.x, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r17.zwzz, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r9.z, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r18.zwzz, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r12.x, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r19.xyxx, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r3.y, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r19.zwzz, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r9.w, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r14.zwzz, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r20.y, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r13.ywyy, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r10.z, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r21.xyxx, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r13.z, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r21.zwzz, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r12.z, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r12.ywyy, t2.xxxx, s1, r3.z

#line 631
      mad r2.w, r10.w, r3.x, r2.w

#line 526
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r9.xyxx, t2.xxxx, s1, r3.z
...
#line 1198
  mul r3.xyz, r3.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r3.x <- <ComputeDirectLightContribution_id581 return value>.x; r3.y <- <ComputeDirectLightContribution_id581 return value>.y; r3.z <- <ComputeDirectLightContribution_id581 return value>.z
...
#line 955
mov r4.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r4.xyzw, t3.xyzw  // r0.x <- streams.lightData_id175.x; r0.y <- streams.lightData_id175.y
...
#line 939
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r2.zzzz, t4.yzwx  // r5.w <- realLightIndex
...
#line 942
  ishl r6.w, r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyzw, r6.wwww, t5.xyzw  // r13.x <- pointLight1.x; r13.y <- pointLight1.y; r13.z <- pointLight1.z; r13.w <- pointLight1.w

#line 943
  bfi r5.w, l(31), l(1), r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r5.wwww, t5.xyzw  // r14.x <- pointLight2.x; r14.y <- pointLight2.y; r14.z <- pointLight2.z
...
#line 845
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r2.xyxx, t1.zxyw, s0, l(0.000000)  // r0.y <- environmentLightingDFG.x; r0.z <- environmentLightingDFG.y

#line 846
mad r0.yzw, r7.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id403 return value>.x; r0.z <- <Compute_id403 return value>.y; r0.w <- <Compute_id403 return value>.z

#line 1088
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id582 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id582 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id582 return value>.z
...
#line 831
sample_l_indexable(texturecube)(float,float,float,float) r5.xyz, r5.xyzx, t7.xyzw, s0, r1.w  // r5.x <- <Compute_id316 return value>.x; r5.y <- <Compute_id316 return value>.y; r5.z <- <Compute_id316 return value>.z
...
#line 816
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r3.xyzx, t8.xyzw, s0, r0.x  // r3.x <- <Compute_id336 return value>.x; r3.y <- <Compute_id336 return value>.y; r3.z <- <Compute_id336 return value>.z
...
const static bool TIsNormalXY1_id228 = false;
const static bool TScaleAndBias_id229 = true;
const static bool TInvert_id238 = true;
const static bool TIsEnergyConservative_id250 = false;
static const float PI_id252 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id253;
...
{
    streams.Input_3_id240 = Compute_id391();
}
void Compute_id382(inout PS_STREAMS streams)
{
    streams.Input_2_id231 = Compute_id379();
}
...
float3 Compute_id403(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id253.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id252 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void Compute_id618(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id252 + environmentLightingContribution;
