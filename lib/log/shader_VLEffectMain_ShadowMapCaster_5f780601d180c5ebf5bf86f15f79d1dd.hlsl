...
//
#line 180 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_5f780601d180c5ebf5bf86f15f79d1dd.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id115;
    float2 InputValue_id123;
    float2 InputValue_id130;
    float2 InputValue_id151;
    float2 InputValue_id159;
    float2 InputValue_id166;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id191;
    float2 Texture1TexelSize_id193;
    float2 Texture2TexelSize_id195;
    float2 Texture3TexelSize_id197;
    float2 Texture4TexelSize_id199;
    float2 Texture5TexelSize_id201;
    float2 Texture6TexelSize_id203;
    float2 Texture7TexelSize_id205;
    float2 Texture8TexelSize_id207;
    float2 Texture9TexelSize_id209;
};
Texture2D Texture0_id190;
Texture2D Texture1_id192;
Texture2D Texture2_id194;
Texture2D Texture3_id196;
Texture2D Texture4_id198;
Texture2D Texture5_id200;
Texture2D Texture6_id202;
Texture2D Texture7_id204;
Texture2D Texture8_id206;
Texture2D Texture9_id208;
TextureCube TextureCube0_id210;
TextureCube TextureCube1_id211;
TextureCube TextureCube2_id212;
TextureCube TextureCube3_id213;
Texture3D Texture3D0_id214;
Texture3D Texture3D1_id215;
Texture3D Texture3D2_id216;
Texture3D Texture3D3_id217;
SamplerState Sampler_id218;
SamplerState PointSampler_id219 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id220 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id221 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id222 
{
...
SamplerState AnisotropicSampler_id223 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id224 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id225 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id226 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id227 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id228;
SamplerState Sampler1_id229;
SamplerState Sampler2_id230;
SamplerState Sampler3_id231;
SamplerState Sampler4_id232;
SamplerState Sampler5_id233;
SamplerState Sampler6_id234;
SamplerState Sampler7_id235;
SamplerState Sampler8_id236;
SamplerState Sampler9_id237;
Texture2D DynamicTexture_id105;
SamplerState DynamicSampler_id106;
Texture2D DynamicTexture_id137;
SamplerState DynamicSampler_id138;
Texture2D DynamicTexture_id173;
SamplerState DynamicSampler_id174;
