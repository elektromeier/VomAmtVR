...
//
#line 1527 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_6229f867202b7cf99e44e4667e1786c8.hlsl"
...
@G    Pixel => f69470b7a52393b245b247ff95d926d6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1594 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_6229f867202b7cf99e44e4667e1786c8.hlsl"
...
#line 576
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id183 return value>.x; r8.y <- <FresnelSchlick_id183 return value>.y; r8.z <- <FresnelSchlick_id183 return value>.z
...
#line 572
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 1153
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id565 return value>.x; r7.y <- <ComputeDirectLightContribution_id565 return value>.y; r7.z <- <ComputeDirectLightContribution_id565 return value>.z
...
#line 576
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id183 return value>.x; r13.y <- <FresnelSchlick_id183 return value>.y; r13.z <- <FresnelSchlick_id183 return value>.z
...
#line 572
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 572
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id199 return value>
...
#line 716
  mul r3.w, r3.w, r6.z
  mul r4.w, r10.z, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 415
  dp3 r4.w, -cb0[r2.w + 62].xyzx, r13.xyzx  // r4.w <- cd
...
#line 806
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id387 return value>.x; r0.z <- <Compute_id387 return value>.y; r0.w <- <Compute_id387 return value>.z

#line 1043
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id566 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id566 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id566 return value>.z
...
#line 791
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t6.xyzw, s0, r1.w  // r6.x <- <Compute_id312 return value>.x; r6.y <- <Compute_id312 return value>.y; r6.z <- <Compute_id312 return value>.z
...
#line 776
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t7.xyzw, s0, r0.x  // r3.x <- <Compute_id332 return value>.x; r3.y <- <Compute_id332 return value>.y; r3.z <- <Compute_id332 return value>.z
...
{
    streams.Input_2_id228 = Compute_id375();
}
void Compute_id366(inout PS_STREAMS streams)
{
    streams.Input_1_id219 = Compute_id363();
}
...
float3 Compute_id387(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id241.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float3 Compute_id419(inout PS_STREAMS streams, float3 f0)
{
...
void AfterLightingAndShading_id536()
{
}
...
float3 ComputeEnvironmentLightContribution_id566(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id387(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id510(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id565(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id419(streams, specularColor);
    float geometricShadowing = Compute_id449(streams);
    float normalDistribution = Compute_id479(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id509(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareForLightingAndShading_id533()
{
}
...
{
    float x = Compute_id384(streams);
    return float4(x, x, x, x);
}
float4 Compute_id374(inout PS_STREAMS streams)
{
    float x = Compute_id372(streams);
    return float4(x, x, x, x);
}
...
void Compute_id597(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id533();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id509(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id565(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id510(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id566(streams);
        }
    }
    ...
    {
        AfterLightingAndShading_id536();
    }
}
void Compute_id581(inout PS_STREAMS streams)
{
    float metalness = Compute_id386(streams).r;
...
{
    float glossiness = Compute_id374(streams).r;
