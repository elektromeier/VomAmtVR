...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_0>}]}]}], mixin MaterialSurfaceNormalMap<false,true> [{normalMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_1> [{Value = InputFloat4<ShaderFX.InputValueFloat4.i1,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_1>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_2> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_2>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_3> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_3>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@C    InputValue_id220 => ShaderFX.InputValueFloat4.i1
@C    InputValue_id230 => ShaderFX.InputValueFloat
@C    InputValue_id239 => ShaderFX.InputValueFloat.i1
...
@R    EnvironmentLightingDFG_LUT_id251 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id251 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id251 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
*****     Stages      *****
***************************
@G    Vertex => 8fbcdd2d8b5b9d9867bca8000ac4c2fe
//
...
//
#line 1592 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_6a51484ab1d73532790294cc64a52f0c.hlsl"
...
@G    Pixel => 86b69fd9cc89610b84f3837787397b9d
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 InputValue_id220;           // Offset:   16 Size:    16
//   float InputValue_id230;            // Offset:   32 Size:     4
//   float InputValue_id239;            // Offset:   36 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id251    texture  float4          2d             t0      1 
...
//
#line 1668 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_6a51484ab1d73532790294cc64a52f0c.hlsl"
...
#line 1494
mad r6.xyz, cb1[1].xyzx, l(2.000000, 2.000000, 2.000000, 0.000000), l(-1.000000, -1.000000, -1.000000, 0.000000)  // r6.x <- normal.x; r6.y <- normal.y; r6.z <- normal.z

#line 1485
add r0.w, -cb1[2].x, l(1.000000)  // r0.w <- glossiness

#line 1477
add r7.xyz, cb1[0].xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r7.xyz, cb1[2].yyyy, r7.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r7.x <- streams.matSpecular_id55.x; r7.y <- streams.matSpecular_id55.y; r7.z <- streams.matSpecular_id55.z

#line 1478
mad r8.xyz, cb1[2].yyyy, -cb1[0].xyzx, cb1[0].xyzx  // r8.x <- streams.matDiffuse_id53.x; r8.y <- streams.matDiffuse_id53.y; r8.z <- streams.matDiffuse_id53.z

#line 1253
dp3 r4.x, r6.xyzx, r4.xyzx
dp3 r4.y, r6.xyzx, r5.xyzx
...
#line 1282
movc r2.xyz, v5.xxxx, r2.xyzx, -r2.xyzx  // r2.x <- streams.normalWS_id19.x; r2.y <- streams.normalWS_id19.y; r2.z <- streams.normalWS_id19.z
...
#line 747
  ishl r4.z, r2.w, l(2)
  mov r5.w, l(1.000000)
  dp4 r6.x, r5.xyzw, cb2[r4.z + 29].xyzw  // r6.x <- shadowPosition.x
  dp4 r6.y, r5.xyzw, cb2[r4.z + 30].xyzw  // r6.y <- shadowPosition.y
  dp4 r4.w, r5.xyzw, cb2[r4.z + 31].xyzw  // r4.w <- shadowPosition.z
  dp4 r6.w, r5.xyzw, cb2[r4.z + 32].xyzw  // r6.w <- shadowPosition.w

#line 748
  add r6.z, r4.w, -cb2[81].x  // r6.z <- shadowPosition.z
...
#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.xyxx, t1.xxxx, s1, r6.z  // r4.w <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r15.zwzz, t1.xxxx, s1, r6.z  // r6.w <- <SampleTextureAndCompare_id68 return value>

#line 620
  mul r6.w, r6.w, r10.x
  mad r4.w, r11.x, r4.w, r6.w  // r4.w <- shadow

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r17.xyxx, t1.xxxx, s1, r6.z  // r6.w <- <SampleTextureAndCompare_id68 return value>

#line 620
  mad r4.w, r6.x, r6.w, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r18.xyxx, t1.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id68 return value>

#line 620
  mad r4.w, r13.x, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r16.xyxx, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r10.y, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r16.zwzz, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r20.x, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r17.zwzz, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r9.z, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r18.zwzz, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r12.x, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r19.xyxx, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r6.y, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r19.zwzz, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r9.w, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r14.zwzz, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r20.y, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r13.ywyy, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r10.z, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r21.xyxx, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r13.z, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r21.zwzz, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r12.z, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r12.ywyy, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r10.w, r6.x, r4.w

#line 515
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r9.xyxx, t1.xxxx, s1, r6.z

#line 620
  mad r4.w, r11.y, r6.x, r4.w
...
#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t1.xxxx, s1, r5.z  // r3.w <- <SampleTextureAndCompare_id68 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r15.zwzz, t1.xxxx, s1, r5.z  // r4.z <- <SampleTextureAndCompare_id68 return value>
...
#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r17.xyxx, t1.xxxx, s1, r5.z  // r4.z <- <SampleTextureAndCompare_id68 return value>

#line 620
      mad r3.w, r5.x, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r18.xyxx, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r13.x, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r16.xyxx, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r10.y, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r16.zwzz, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r20.x, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r17.zwzz, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r9.z, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r18.zwzz, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r12.x, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r19.xyxx, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r5.y, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r19.zwzz, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r9.w, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r14.zwzz, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r20.y, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r13.ywyy, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r10.z, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r21.xyxx, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r13.z, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r21.zwzz, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r12.z, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r12.ywyy, t1.xxxx, s1, r5.z

#line 620
      mad r3.w, r10.w, r4.z, r3.w

#line 515
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r9.xyxx, t1.xxxx, s1, r5.z
...
#line 1004
      ...
      mad r6.xyz, r2.wwww, r4.zzzz, r3.wwww  // r6.x <- shadow.x; r6.y <- shadow.y; r6.z <- shadow.z
...
#line 1206
  mul r5.xyz, r6.xyzx, cb2[27].xyzx
...
#line 590
  ...
  mul r1.y, r1.y, r1.y
  mul r1.x, r1.y, r1.x
  mad r1.xyz, r9.xyzx, r1.xxxx, r7.xyzx  // r1.x <- <FresnelSchlick_id184 return value>.x; r1.y <- <FresnelSchlick_id184 return value>.y; r1.z <- <FresnelSchlick_id184 return value>.z
...
#line 1187
  mul r1.xyz, r1.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r1.x <- <ComputeDirectLightContribution_id578 return value>.x; r1.y <- <ComputeDirectLightContribution_id578 return value>.y; r1.z <- <ComputeDirectLightContribution_id578 return value>.z

#line 1314
  mad r1.xyz, r6.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000), r1.xyzx  // r1.x <- directLightingContribution.x; r1.y <- directLightingContribution.y; r1.z <- directLightingContribution.z
...
#line 944
mov r5.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r5.xyzw, t2.xyzw  // r0.x <- streams.lightData_id173.x; r0.y <- streams.lightData_id173.y
...
mov r6.yz, r3.yyzy  // r6.y <- streams.viewWS_id68.y; r6.z <- streams.viewWS_id68.z
mov r9.xy, r8.xyxx  // r9.x <- streams.matDiffuseVisible_id69.x; r9.y <- streams.matDiffuseVisible_id69.y
mov r10.x, r8.z  // r10.x <- streams.matDiffuseVisible_id69.z
mov r10.yzw, r7.xxyz  // r10.y <- streams.matSpecularVisible_id71.x; r10.z <- streams.matSpecularVisible_id71.y; r10.w <- streams.matSpecularVisible_id71.z
...
#line 928
  ld_indexable(buffer)(uint,uint,uint,uint) r3.w, r4.zzzz, t3.yzwx  // r3.w <- realLightIndex
...
#line 462
  mul r3.w, r3.w, r6.w  // r3.w <- attenuation
...
#line 1162
  ...
  mul r14.xyz, r6.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id44.x; r14.y <- streams.lightColorNdotL_id44.y; r14.z <- streams.lightColorNdotL_id44.z
...
#line 1198
  dp3_sat r6.x, r13.xyzx, r15.xyzx  // r6.x <- streams.LdotH_id77
...
#line 590
  ...
  mul r7.w, r7.w, r7.w
  mul r6.x, r6.x, r7.w
  mad r15.xyz, r15.xyzx, r6.xxxx, r10.yzwy  // r15.x <- <FresnelSchlick_id184 return value>.x; r15.y <- <FresnelSchlick_id184 return value>.y; r15.z <- <FresnelSchlick_id184 return value>.z
...
#line 586
  ...
  div r8.w, r6.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id200 return value>
  mad r6.x, r4.w, r7.w, r6.x
  div r6.x, r4.w, r6.x  // r6.x <- <VisibilityhSchlickGGX_id200 return value>

#line 734
  mul r6.x, r6.x, r8.w
  mul r6.w, r4.w, r6.w
  div r6.x, r6.x, r6.w  // r6.x <- <VisibilitySmithSchlickGGX_id202 return value>
...
#line 730
  ...
  div r3.w, r6.w, r3.w  // r3.w <- <NormalDistributionGGX_id214 return value>
...
mov r6.xyz, r8.xyzx  // r6.x <- streams.matDiffuseVisible_id69.x; r6.y <- streams.matDiffuseVisible_id69.y; r6.z <- streams.matDiffuseVisible_id69.z
mov r9.xyz, r7.xyzx  // r9.x <- streams.matSpecularVisible_id71.x; r9.y <- streams.matSpecularVisible_id71.y; r9.z <- streams.matSpecularVisible_id71.z
...
mov r5.xyz, r8.xyzx  // r5.x <- streams.matDiffuseVisible_id69.x; r5.y <- streams.matDiffuseVisible_id69.y; r5.z <- streams.matDiffuseVisible_id69.z
mov r6.xyz, r7.xyzx  // r6.x <- streams.matSpecularVisible_id71.x; r6.y <- streams.matSpecularVisible_id71.y; r6.z <- streams.matSpecularVisible_id71.z
...
#line 590
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r15.xyz, r15.xyzx, r3.wwww, r6.xyzx  // r15.x <- <FresnelSchlick_id184 return value>.x; r15.y <- <FresnelSchlick_id184 return value>.y; r15.z <- <FresnelSchlick_id184 return value>.z
...
#line 425
  dp3 r4.z, -cb0[r2.w + 158].xyzx, r13.xyzx  // r4.z <- cd
...
#line 834
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r4.xyxx, t0.zxyw, s0, l(0.000000)  // r0.y <- environmentLightingDFG.x; r0.z <- environmentLightingDFG.y

#line 835
mad r0.yzw, r7.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id400 return value>.x; r0.z <- <Compute_id400 return value>.y; r0.w <- <Compute_id400 return value>.z

#line 1077
mul r1.xyz, r0.yzwy, cb2[88].xyzx  // r1.x <- <ComputeEnvironmentLightContribution_id579 return value>.x; r1.y <- <ComputeEnvironmentLightContribution_id579 return value>.y; r1.z <- <ComputeEnvironmentLightContribution_id579 return value>.z

#line 1424
mad r1.xyz, r8.xyzx, cb2[88].xyzx, r1.xyzx  // r1.x <- environmentLightingContribution.x; r1.y <- environmentLightingContribution.y; r1.z <- environmentLightingContribution.z
...
#line 820
sample_l_indexable(texturecube)(float,float,float,float) r5.xyz, r5.xyzx, t6.xyzw, s0, r1.w  // r5.x <- <Compute_id313 return value>.x; r5.y <- <Compute_id313 return value>.y; r5.z <- <Compute_id313 return value>.z
...
#line 805
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t7.xyzw, s0, r0.x  // r3.x <- <Compute_id333 return value>.x; r3.y <- <Compute_id333 return value>.y; r3.z <- <Compute_id333 return value>.z
...
const static bool TIsNormalXY1_id226 = false;
const static bool TScaleAndBias_id227 = true;
const static bool TInvert_id236 = true;
const static bool TIsEnergyConservative_id248 = false;
static const float PI_id250 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id251;
...
{
    streams.Input_3_id238 = Compute_id388();
}
void Compute_id379(inout PS_STREAMS streams)
{
    streams.Input_2_id229 = Compute_id376();
}
void Compute_id367(inout PS_STREAMS streams)
{
    streams.Input_1_id219 = Compute_id364();
}
void Compute_id355(inout PS_STREAMS streams)
{
    streams.Input_0_id211 = Compute_id352();
}
...
void Compute_id369(inout PS_STREAMS streams)
{
...
float3 Compute_id400(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id251.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float4 Compute_id373(inout PS_STREAMS streams)
{
    ...
    return Compute_id370(streams);
}
float4 Compute_id361(inout PS_STREAMS streams)
{
    Compute_id357(streams);
    return Compute_id358(streams);
}
void ResetStream_id217()
{
}
void AfterLightingAndShading_id549()
{
}
...
float3 ComputeEnvironmentLightContribution_id579(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id400(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id523(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id578(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id432(streams, specularColor);
    float geometricShadowing = Compute_id462(streams);
    float normalDistribution = Compute_id492(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id522(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id250 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id546()
{
}
...
{
    float x = Compute_id397(streams);
    return float4(x, x, x, x);
}
float4 Compute_id387(inout PS_STREAMS streams)
{
    float x = Compute_id385(streams);
    return float4(x, x, x, x);
}
...
float4 Compute_id363(inout PS_STREAMS streams)
{
...
void Compute_id615(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id546();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id522(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id578(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id523(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id579(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id250 + environmentLightingContribution;
    ...
    {
        AfterLightingAndShading_id549();
    }
}
void Compute_id599(inout PS_STREAMS streams)
{
    float metalness = Compute_id399(streams).r;
...
void Compute_id594(inout PS_STREAMS streams)
{
    float glossiness = Compute_id387(streams).r;
...
{
    float4 normal = Compute_id375(streams);
...
{
    float4 colorBase = Compute_id363(streams);
