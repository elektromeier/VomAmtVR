...
@C    constantFloat_id228 => Material.MetalnessValue
...
//
#line 1501 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_31ae5da633bdee11f941322e197b928f.hlsl"
...
//   float constantFloat_id228;         // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 1568 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_31ae5da633bdee11f941322e197b928f.hlsl"
...
#line 786
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id377 return value>.x; r0.z <- <Compute_id377 return value>.y; r0.w <- <Compute_id377 return value>.z

#line 1018
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id556 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id556 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id556 return value>.z
...
float3 ComputeEnvironmentLightContribution_id556(inout PS_STREAMS streams)
{
    ...
    return Compute_id377(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
float4 Compute_id375()
{
    return float4(constantFloat_id228, constantFloat_id228, constantFloat_id228, constantFloat_id228);
}
...
{
    float metalness = Compute_id375().r;
