...
//
#line 172 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_6d6ccb1a4ac0ff7b302aa1b229281b21.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id163;
    float2 Texture1TexelSize_id165;
    float2 Texture2TexelSize_id167;
    float2 Texture3TexelSize_id169;
    float2 Texture4TexelSize_id171;
    float2 Texture5TexelSize_id173;
    float2 Texture6TexelSize_id175;
    float2 Texture7TexelSize_id177;
    float2 Texture8TexelSize_id179;
    float2 Texture9TexelSize_id181;
};
Texture2D Texture0_id162;
Texture2D Texture1_id164;
Texture2D Texture2_id166;
Texture2D Texture3_id168;
Texture2D Texture4_id170;
Texture2D Texture5_id172;
Texture2D Texture6_id174;
Texture2D Texture7_id176;
Texture2D Texture8_id178;
Texture2D Texture9_id180;
TextureCube TextureCube0_id182;
TextureCube TextureCube1_id183;
TextureCube TextureCube2_id184;
TextureCube TextureCube3_id185;
Texture3D Texture3D0_id186;
Texture3D Texture3D1_id187;
Texture3D Texture3D2_id188;
Texture3D Texture3D3_id189;
SamplerState Sampler_id190;
SamplerState PointSampler_id191 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id192 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id193 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id194 
{
...
SamplerState AnisotropicSampler_id195 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id196 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id197 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id198 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id199 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id200;
SamplerState Sampler1_id201;
SamplerState Sampler2_id202;
SamplerState Sampler3_id203;
SamplerState Sampler4_id204;
SamplerState Sampler5_id205;
SamplerState Sampler6_id206;
SamplerState Sampler7_id207;
SamplerState Sampler8_id208;
SamplerState Sampler9_id209;
