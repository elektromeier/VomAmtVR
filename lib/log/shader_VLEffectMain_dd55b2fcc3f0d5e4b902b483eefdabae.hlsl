...
@R    DynamicSampler_id235 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id265 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id265 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id265 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1663 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_dd55b2fcc3f0d5e4b902b483eefdabae.hlsl"
...
@G    Pixel => 4940e88e70d1785e20e0623fa6889b6e
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// EnvironmentLightingDFG_LUT_id265    texture  float4          2d             t1      1 
...
//
#line 1731 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_dd55b2fcc3f0d5e4b902b483eefdabae.hlsl"
...
#line 1289
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id606 return value>.x; r7.y <- <ComputeDirectLightContribution_id606 return value>.y; r7.z <- <ComputeDirectLightContribution_id606 return value>.z
...
#line 942
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id428 return value>.x; r0.z <- <Compute_id428 return value>.y; r0.w <- <Compute_id428 return value>.z
...
const static bool TIsEnergyConservative_id262 = false;
static const float PI_id264 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id265;
...
{
    streams.Input_11_id252 = Compute_id416();
}
void Compute_id407(inout PS_STREAMS streams)
{
    streams.Input_10_id243 = Compute_id404();
}
...
float3 Compute_id428(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id265.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float3 ComputeEnvironmentLightContribution_id607(inout PS_STREAMS streams)
{
    ...
    return Compute_id428(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id264 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void Compute_id638(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id264 + environmentLightingContribution;
...
{
    float metalness = Compute_id427(streams).r;
...
{
    float glossiness = Compute_id415(streams).r;
