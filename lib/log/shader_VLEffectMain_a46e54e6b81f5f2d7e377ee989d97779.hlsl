...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_0>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_3> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerMaterial>}], mixin AssignVarFloat2<Plus_4> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_5,TEXCOORD0>}, {Right = GetVarFloat2<Input_3>}]}], mixin AssignVarFloat2<Input_6> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i1,PerMaterial>}], mixin AssignVarFloat2<Multiply_7> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_4>}, {Right = GetVarFloat2<Input_6>}]}], mixin AssignVarFloat2<Input_8> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i2,PerMaterial>}], mixin AssignVarFloat2<Plus_9> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_7>}, {Right = GetVarFloat2<Input_8>}]}], mixin AssignVarFloat4<TextureValue_10> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx1,PerMaterial,ObjectSampler_fx2,PerMaterial> [{TexCd = GetVarFloat2<Plus_9>}]}], mixin AssignVarFloat<Member_11> [{Value = mixin GetMemberFloat4Float<r> [{Value = GetVarFloat4<TextureValue_10>}]}]]}]}, {Value = GetVarFloat<Member_11>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_12> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_12>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@R    DynamicTexture_id244 => ObjectTexture_fx1 [Stage: Pixel, Slot: (0-0)]
...
*****     Stages      *****
***************************
@G    Vertex => 7b732eaf8da4d06d287538279f820cc5
//
...
//
#line 1650 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_a46e54e6b81f5f2d7e377ee989d97779.hlsl"
...
@G    Pixel => 0e684bd080c575a80b545670371fa894
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id258;            // Offset:   40 Size:     4
//
// }
//
// cbuffer PerView
...
// DynamicTexture_id244              texture  float4          2d             t0      1 
...
//
#line 1760 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_a46e54e6b81f5f2d7e377ee989d97779.hlsl"
...
#line 601
add r4.xy, v4.xyxx, cb1[1].xyxx  // r4.x <- <Compute_id374 return value>.x; r4.y <- <Compute_id374 return value>.y

#line 585
mad r4.xy, r4.xyxx, cb1[1].zwzz, cb1[2].xyxx  // r4.x <- <Compute_id390 return value>.x; r4.y <- <Compute_id390 return value>.y

#line 581
sample_indexable(texture2d)(float,float,float,float) r0.w, r4.xyxx, t0.yzwx, s2  // r0.w <- <Compute_id394 return value>.x
...
mad r4.xyz, cb1[2].zzzz, r4.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r4.x <- streams.matSpecular_id57.x; r4.y <- streams.matSpecular_id57.y; r4.z <- streams.matSpecular_id57.z

#line 1600
mad r5.xyz, cb1[2].zzzz, -cb1[0].xyzx, cb1[0].xyzx  // r5.x <- streams.matDiffuse_id55.x; r5.y <- streams.matDiffuse_id55.y; r5.z <- streams.matDiffuse_id55.z
...
#line 471
  dp3 r4.w, -cb0[r2.w + 94].xyzx, r13.xyzx  // r4.w <- cd
...
#line 952
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t7.xyzw, s0, r1.w  // r6.x <- <Compute_id316 return value>.x; r6.y <- <Compute_id316 return value>.y; r6.z <- <Compute_id316 return value>.z
...
#line 937
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t8.xyzw, s0, r0.x  // r3.x <- <Compute_id336 return value>.x; r3.y <- <Compute_id336 return value>.y; r3.z <- <Compute_id336 return value>.z
...
const static bool TInvert_id255 = true;
...
struct PS_STREAMS 
{
    ...
    float Member_11_id248;
    float Input_12_id257;
...
{
    return Compute_id395(streams).r;
}
...
{
    streams.Input_12_id257 = Compute_id426();
}
void Compute_id417(inout PS_STREAMS streams)
{
    streams.Member_11_id248 = Compute_id398(streams);
}
...
{
    return streams.Member_11_id248;
}
...
float3 Compute_id438(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id270.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id269 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void Compute_id648(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id269 + environmentLightingContribution;
...
{
    float metalness = Compute_id437(streams).r;
...
{
    float glossiness = Compute_id425(streams).r;
