...
//
#line 169 "C:\Users\elektromeier\Desktop\projects\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_347ed23526a69c137f7eed6684a34d38.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id147;
    float2 Texture1TexelSize_id149;
    float2 Texture2TexelSize_id151;
    float2 Texture3TexelSize_id153;
    float2 Texture4TexelSize_id155;
    float2 Texture5TexelSize_id157;
    float2 Texture6TexelSize_id159;
    float2 Texture7TexelSize_id161;
    float2 Texture8TexelSize_id163;
    float2 Texture9TexelSize_id165;
};
Texture2D Texture0_id146;
Texture2D Texture1_id148;
Texture2D Texture2_id150;
Texture2D Texture3_id152;
Texture2D Texture4_id154;
Texture2D Texture5_id156;
Texture2D Texture6_id158;
Texture2D Texture7_id160;
Texture2D Texture8_id162;
Texture2D Texture9_id164;
TextureCube TextureCube0_id166;
TextureCube TextureCube1_id167;
TextureCube TextureCube2_id168;
TextureCube TextureCube3_id169;
Texture3D Texture3D0_id170;
Texture3D Texture3D1_id171;
Texture3D Texture3D2_id172;
Texture3D Texture3D3_id173;
SamplerState Sampler_id174;
SamplerState PointSampler_id175 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id176 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id177 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id178 
{
...
SamplerState AnisotropicSampler_id179 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id180 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id181 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id182 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id183 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id184;
SamplerState Sampler1_id185;
SamplerState Sampler2_id186;
SamplerState Sampler3_id187;
SamplerState Sampler4_id188;
SamplerState Sampler5_id189;
SamplerState Sampler6_id190;
SamplerState Sampler7_id191;
SamplerState Sampler8_id192;
SamplerState Sampler9_id193;
