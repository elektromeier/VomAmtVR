...
@C    constantColor_id211 => Material.DiffuseValue
@C    constantFloat_id220 => Material.MetalnessValue
@C    InputValue_id226 => ShaderFX.InputValueFloat4
...
//
#line 1556 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_6c58dd18cbdb806e5c99ff3b5cb91054.hlsl"
...
@G    Pixel => e29eb655f0b5446ea5adbf78c70eaa5c
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 constantColor_id211;        // Offset:    0 Size:    16
//   float constantFloat_id220;         // Offset:   16 Size:     4
//   float4 InputValue_id226;           // Offset:   32 Size:    16
//   float InputValue_id234;            // Offset:   48 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 1623 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_6c58dd18cbdb806e5c99ff3b5cb91054.hlsl"
...
#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.xyxx, t1.xxxx, s1, r8.z  // r4.w <- <SampleTextureAndCompare_id70 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.zwzz, t1.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id70 return value>
...
#line 507
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r16.xyxx, t1.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id70 return value>
...
#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r14.xyxx, t1.xxxx, s1, r7.z  // r2.w <- <SampleTextureAndCompare_id70 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.zwzz, t1.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id70 return value>
...
#line 507
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r16.xyxx, t1.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id70 return value>
...
#line 574
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r8.xyz, r8.xyzx, r0.zzzz, r4.xyzx  // r8.x <- <FresnelSchlick_id192 return value>.x; r8.y <- <FresnelSchlick_id192 return value>.y; r8.z <- <FresnelSchlick_id192 return value>.z

#line 570
  mad r0.z, r0.w, l(0.500000), l(0.500000)
  div r0.z, r0.w, r0.z  // r0.z <- <VisibilityhSchlickGGX_id208 return value>
  mad r1.w, r6.y, l(0.500000), l(0.500000)
  div r1.w, r6.y, r1.w  // r1.w <- <VisibilityhSchlickGGX_id208 return value>

#line 713
  mul r0.z, r0.z, r1.w
  mul r0.w, r6.y, r0.w
  div r0.z, r0.z, r0.w  // r0.z <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 1150
  mul r7.xyz, r7.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id578 return value>.x; r7.y <- <ComputeDirectLightContribution_id578 return value>.y; r7.z <- <ComputeDirectLightContribution_id578 return value>.z
...
#line 1137
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id266 return value>
...
#line 574
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r13.xyz, r13.xyzx, r1.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id192 return value>.x; r13.y <- <FresnelSchlick_id192 return value>.y; r13.z <- <FresnelSchlick_id192 return value>.z

#line 570
  mad r1.w, r2.w, l(0.500000), l(0.500000)
  div r1.w, r2.w, r1.w  // r1.w <- <VisibilityhSchlickGGX_id208 return value>
  mad r3.w, r6.w, l(0.500000), l(0.500000)
  div r3.w, r6.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id208 return value>

#line 713
  mul r1.w, r1.w, r3.w
  mul r2.w, r6.w, r2.w
  div r1.w, r1.w, r2.w  // r1.w <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 1115
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id278 return value>
...
#line 574
  ...
  mul r6.w, r6.w, r6.w
  mul r4.w, r4.w, r6.w
  mad r14.xyz, r14.xyzx, r4.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id192 return value>.x; r14.y <- <FresnelSchlick_id192 return value>.y; r14.z <- <FresnelSchlick_id192 return value>.z

#line 570
  mad r4.w, r5.w, l(0.500000), l(0.500000)
  div r4.w, r5.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id208 return value>
  mad r6.w, r1.w, l(0.500000), l(0.500000)
  div r6.w, r1.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id208 return value>

#line 713
  mul r4.w, r4.w, r6.w
  mul r5.w, r1.w, r5.w
  div r4.w, r4.w, r5.w  // r4.w <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 574
  ...
  mul r3.w, r3.w, r3.w
  mul r2.w, r2.w, r3.w
  mad r14.xyz, r14.xyzx, r2.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id192 return value>.x; r14.y <- <FresnelSchlick_id192 return value>.y; r14.z <- <FresnelSchlick_id192 return value>.z

#line 570
  mad r2.w, r4.w, l(0.500000), l(0.500000)
  div r2.w, r4.w, r2.w  // r2.w <- <VisibilityhSchlickGGX_id208 return value>
  mad r3.w, r0.w, l(0.500000), l(0.500000)
  div r3.w, r0.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id208 return value>

#line 713
  mul r2.w, r2.w, r3.w
  mul r3.w, r0.w, r4.w
  div r2.w, r2.w, r3.w  // r2.w <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 417
  dp3 r4.w, -cb0[r2.w + 158].xyzx, r12.xyzx  // r4.w <- cd
...
#line 803
mad r0.xyz, r4.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id400 return value>.x; r0.y <- <Compute_id400 return value>.y; r0.z <- <Compute_id400 return value>.z

#line 1040
mul r2.xyz, r0.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id579 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id579 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id579 return value>.z
...
#line 788
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t6.xyzw, s0, cb2[97].w  // r6.x <- <Compute_id324 return value>.x; r6.y <- <Compute_id324 return value>.y; r6.z <- <Compute_id324 return value>.z
...
#line 773
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t7.xyzw, s0, cb2[111].w  // r3.x <- <Compute_id344 return value>.x; r3.y <- <Compute_id344 return value>.y; r3.z <- <Compute_id344 return value>.z
...
const static bool TInvert_id218 = true;
const static float Value_id214 = 1;
const static bool TIsEnergyConservative_id243 = false;
static const float PI_id245 = 3.14159265358979323846;
const static bool TUseAlphaFromEmissive_id255 = false;
struct PS_STREAMS 
{
...
cbuffer PerMaterial 
{
    float4 constantColor_id211;
    float constantFloat_id220;
    float4 InputValue_id226;
...
float3 FresnelSchlick_id192(float3 f0, float3 f90, float lOrVDotH)
{
...
{
    streams.Input_1_id233 = Compute_id388();
}
void Compute_id379(inout PS_STREAMS streams)
{
    streams.Input_0_id225 = Compute_id376();
}
void Compute_id365()
{
}
...
float NormalDistributionGGX_id222(float alphaR, float nDotH)
{
...
float3 FresnelSchlick_id198(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id192(f0, 1.0f, lOrVDotH);
}
...
float4 Compute_id344(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id339(float3 direction)
{
...
{
    return NormalDistributionGGX_id222(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id462(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id210(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id432(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id198(f0, streams.LdotH_id77);
}
...
{
    Compute_id367();
    return Compute_id368();
}
void ResetStream_id228()
{
}
...
void PrepareEnvironmentLight_id359(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id339(sampleDirection).rgb * Intensity_id208 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id344(streams, sampleDirection).rgb * Intensity_id208 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
void PrepareEnvironmentLight_id354(inout PS_STREAMS streams)
{
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightDiffuseColor_id47 = Compute_id319(sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    sampleDirection = reflect(-streams.viewWS_id68, streams.normalWS_id19);
    sampleDirection = mul(sampleDirection, (float3x3)SkyMatrix_id196);
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id324(streams, sampleDirection).rgb * Intensity_id197 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
...
void PrepareDirectLight_id300(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id302()
{
    return LightCount_id185;
}
int GetMaxLightCount_id303()
{
    return TMaxLightCount_id186;
}
void PrepareDirectLights_id298()
{
}
void PrepareDirectLight_id287(inout PS_STREAMS streams, int lightIndex)
{
...
void PrepareDirectLights_id285()
{
}
...
int GetLightCount_id279(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y >> 16;
}
int GetMaxLightCount_id278(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y >> 16;
}
...
void PrepareMaterialForLightingAndShading_id224(inout PS_STREAMS streams)
{
...
void ResetLightStream_id223(inout PS_STREAMS streams)
{
...
{
    return float4(constantFloat_id220, constantFloat_id220, constantFloat_id220, constantFloat_id220);
}
float4 Compute_id373()
{
    float x = Compute_id371();
    return float4(x, x, x, x);
}
float4 Compute_id363()
{
    return constantColor_id211;
}
...
void Compute_id620(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id223(streams);
    PrepareMaterialForLightingAndShading_id224(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id278(streams);
        int count = GetLightCount_id279(streams);
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id287(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareDirectLights_id298();
        const int maxLightCount = GetMaxLightCount_id303();
        int count = GetLightCount_id302();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id300(streams, i);
            PrepareMaterialPerDirectLight_id30(streams);
    ...
    {
        PrepareEnvironmentLight_id359(streams);
...
{
    streams.matEmissiveIntensity_id63 = Compute_id399(streams).r;
}
void Compute_id599(inout PS_STREAMS streams)
{
    streams.matEmissive_id62 = Compute_id387(streams).rgba;
}
void Compute_id594(inout PS_STREAMS streams)
{
    float metalness = Compute_id374().r;
...
{
    float glossiness = Compute_id373().r;
...
{
    float4 colorBase = Compute_id363();
    streams.matDiffuse_id53 = colorBase;
    streams.matColorBase_id52 = colorBase;
}
void ResetStream_id230(inout PS_STREAMS streams)
{
