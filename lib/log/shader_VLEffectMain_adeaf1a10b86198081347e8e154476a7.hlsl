...
@C    InputValue_id246 => ShaderFX.InputValueFloat
@C    InputValue_id255 => ShaderFX.InputValueFloat.i1
...
@R    DynamicTexture_id236 => ObjectTexture_fx0 [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id267 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1633 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_adeaf1a10b86198081347e8e154476a7.hlsl"
...
@G    Pixel => aea5504991eaf66c05bef5d2b49e124a
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id246;            // Offset:   24 Size:     4
//   float InputValue_id255;            // Offset:   28 Size:     4
//
// }
//
// cbuffer PerView
...
// DynamicTexture_id236              texture  float4          2d             t0      1 
// EnvironmentLightingDFG_LUT_id267    texture  float4          2d             t1      1 
...
//
#line 1743 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_adeaf1a10b86198081347e8e154476a7.hlsl"
...
#line 596
add r4.xy, v4.xyxx, cb1[0].xyxx  // r4.x <- <Compute_id362 return value>.x; r4.y <- <Compute_id362 return value>.y

#line 580
mad r4.xy, r4.xyxx, cb1[0].zwzz, cb1[1].xyxx  // r4.x <- <Compute_id378 return value>.x; r4.y <- <Compute_id378 return value>.y

#line 576
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t0.xyzw, s2  // r4.x <- <Compute_id382 return value>.x; r4.y <- <Compute_id382 return value>.y; r4.z <- <Compute_id382 return value>.z; r4.w <- <Compute_id382 return value>.w
...
#line 651
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id187 return value>.x; r8.y <- <FresnelSchlick_id187 return value>.y; r8.z <- <FresnelSchlick_id187 return value>.z
...
#line 647
  ...
  div r5.w, r1.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id203 return value>
...
#line 651
  ...
  mul r5.w, r5.w, r10.w
  mad r13.xyz, r13.xyzx, r5.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id187 return value>.x; r13.y <- <FresnelSchlick_id187 return value>.y; r13.z <- <FresnelSchlick_id187 return value>.z
...
#line 647
  ...
  div r12.w, r3.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id203 return value>
  mad r5.w, r6.w, r10.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id203 return value>

#line 824
  mul r5.w, r5.w, r12.w
  mul r3.w, r6.w, r3.w
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id205 return value>
...
#line 820
  ...
  div r2.w, r5.w, r2.w  // r2.w <- <NormalDistributionGGX_id217 return value>
...
#line 647
  ...
  div r6.w, r2.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id203 return value>
...
#line 647
  ...
  div r6.w, r5.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id203 return value>
...
#line 824
  mul r3.w, r3.w, r6.w
  mul r5.w, r10.z, r5.w
  div r3.w, r3.w, r5.w  // r3.w <- <VisibilitySmithSchlickGGX_id205 return value>
...
#line 950
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id432 return value>.x; r0.z <- <Compute_id432 return value>.y; r0.w <- <Compute_id432 return value>.z

#line 1187
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id611 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id611 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id611 return value>.z
...
#line 920
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r5.xyzx, t8.xyzw, s0, r0.x  // r3.x <- <Compute_id336 return value>.x; r3.y <- <Compute_id336 return value>.y; r3.z <- <Compute_id336 return value>.z
...
const static bool TInvert_id252 = true;
...
{
    streams.Input_11_id254 = Compute_id420();
}
