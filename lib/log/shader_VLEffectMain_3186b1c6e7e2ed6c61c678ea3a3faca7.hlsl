...
@C    constantFloat_id252 => Material.MetalnessValue
...
@R    DynamicSampler_id235 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id259 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id259 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id259 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1637 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_3186b1c6e7e2ed6c61c678ea3a3faca7.hlsl"
...
//   float constantFloat_id252;         // Offset:   28 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id259    texture  float4          2d             t1      1 
...
//
#line 1705 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_3186b1c6e7e2ed6c61c678ea3a3faca7.hlsl"
...
#line 922
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id418 return value>.x; r0.z <- <Compute_id418 return value>.y; r0.w <- <Compute_id418 return value>.z
...
const static bool TIsEnergyConservative_id256 = false;
static const float PI_id258 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id259;
...
float3 Compute_id418(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id259.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float3 ComputeEnvironmentLightContribution_id597(inout PS_STREAMS streams)
{
    ...
    return Compute_id418(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id258 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void Compute_id628(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id258 + environmentLightingContribution;
...
{
    float metalness = Compute_id416().r;
