...
//
#line 171 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_31a205129c0e593ca9ebee017ff96be1.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id135;
    float2 InputValue_id142;
    float2 InputValue_id163;
    float2 InputValue_id171;
    float2 InputValue_id178;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id203;
    float2 Texture1TexelSize_id205;
    float2 Texture2TexelSize_id207;
    float2 Texture3TexelSize_id209;
    float2 Texture4TexelSize_id211;
    float2 Texture5TexelSize_id213;
    float2 Texture6TexelSize_id215;
    float2 Texture7TexelSize_id217;
    float2 Texture8TexelSize_id219;
    float2 Texture9TexelSize_id221;
};
Texture2D Texture0_id202;
Texture2D Texture1_id204;
Texture2D Texture2_id206;
Texture2D Texture3_id208;
Texture2D Texture4_id210;
Texture2D Texture5_id212;
Texture2D Texture6_id214;
Texture2D Texture7_id216;
Texture2D Texture8_id218;
Texture2D Texture9_id220;
TextureCube TextureCube0_id222;
TextureCube TextureCube1_id223;
TextureCube TextureCube2_id224;
TextureCube TextureCube3_id225;
Texture3D Texture3D0_id226;
Texture3D Texture3D1_id227;
Texture3D Texture3D2_id228;
Texture3D Texture3D3_id229;
SamplerState Sampler_id230;
SamplerState PointSampler_id231 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id232 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id233 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id234 
{
...
SamplerState AnisotropicSampler_id235 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id236 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id237 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id238 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id239 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id240;
SamplerState Sampler1_id241;
SamplerState Sampler2_id242;
SamplerState Sampler3_id243;
SamplerState Sampler4_id244;
SamplerState Sampler5_id245;
SamplerState Sampler6_id246;
SamplerState Sampler7_id247;
SamplerState Sampler8_id248;
SamplerState Sampler9_id249;
...
Texture2D DynamicTexture_id149;
SamplerState DynamicSampler_id150;
Texture2D DynamicTexture_id185;
SamplerState DynamicSampler_id186;
