...
//
#line 2115 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b69aec43d1f64d354a3c1f1fd21e1720.hlsl"
...
@G    Pixel => 4b09b9f425228f5b1a07fbf447ab0ce9
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 2248 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b69aec43d1f64d354a3c1f1fd21e1720.hlsl"
...
#line 769
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r7.xyxx, t2.xyzw, s3  // r7.x <- <Compute_id435 return value>.x; r7.y <- <Compute_id435 return value>.y; r7.z <- <Compute_id435 return value>.z
...
#line 761
add r8.xy, v6.xyxx, cb1[3].xyxx  // r8.x <- <Compute_id468 return value>.x; r8.y <- <Compute_id468 return value>.y

#line 745
mad r8.xy, r8.xyxx, cb1[3].zwzz, cb1[4].xyxx  // r8.x <- <Compute_id484 return value>.x; r8.y <- <Compute_id484 return value>.y

#line 741
sample_indexable(texture2d)(float,float,float,float) r0.w, r8.xyxx, t3.yzwx, s4  // r0.w <- <Compute_id488 return value>.x

#line 2059
add r0.w, -r0.w, l(1.000000)  // r0.w <- glossiness

#line 729
add r8.xy, v6.xyxx, cb1[4].zwzz  // r8.x <- <Compute_id527 return value>.x; r8.y <- <Compute_id527 return value>.y

#line 713
mad r8.xy, r8.xyxx, cb1[5].xyxx, cb1[5].zwzz  // r8.x <- <Compute_id543 return value>.x; r8.y <- <Compute_id543 return value>.y

#line 709
sample_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t4.yzwx, s5  // r1.w <- <Compute_id547 return value>.x
...
mov o0.w, r6.w
ret 
// Approximately 686 instruction slots used
***************************
*************************/
...
const static bool TIsNormalXY1_id276 = false;
