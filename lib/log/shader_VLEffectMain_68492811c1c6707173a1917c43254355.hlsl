...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_0>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_1> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_1>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_2> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_2>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matAmbientOcclusion,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_5> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerMaterial>}], mixin AssignVarFloat2<Plus_6> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_7,TEXCOORD0>}, {Right = GetVarFloat2<Input_5>}]}], mixin AssignVarFloat2<Input_8> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i1,PerMaterial>}], mixin AssignVarFloat2<Multiply_9> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_6>}, {Right = GetVarFloat2<Input_8>}]}], mixin AssignVarFloat2<Input_10> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i2,PerMaterial>}], mixin AssignVarFloat2<Plus_11> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_9>}, {Right = GetVarFloat2<Input_10>}]}], mixin AssignVarFloat4<TextureValue_12> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx3,PerMaterial,ObjectSampler_fx4,PerMaterial> [{TexCd = GetVarFloat2<Plus_11>}]}], mixin AssignVarFloat<Member_13> [{Value = mixin GetMemberFloat4Float<r> [{Value = GetVarFloat4<TextureValue_12>}]}]]}]}, {Value = GetVarFloat<Member_13>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matAmbientOcclusionDirectLightingFactor,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<0>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavity,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavityDiffuse,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavitySpecular,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@C    InputValue_id240 => ShaderFX.InputValueFloat2
@C    InputValue_id248 => ShaderFX.InputValueFloat2.i1
@C    InputValue_id255 => ShaderFX.InputValueFloat2.i2
...
@R    DynamicTexture_id262 => ObjectTexture_fx3 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id262 => ObjectTexture_fx3 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id263 => ObjectSampler_fx4 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id263 => ObjectSampler_fx4 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id303 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id303 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id263 => ObjectSampler_fx4 [Stage: Pixel, Slot: (2-2)]
@R    DynamicTexture_id262 => ObjectTexture_fx3 [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id303 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1849 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_68492811c1c6707173a1917c43254355.hlsl"
...
@G    Pixel => 22d841110c591b362565a3192c272e12
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id240;           // Offset:   24 Size:     8
//   float2 InputValue_id248;           // Offset:   32 Size:     8
//   float2 InputValue_id255;           // Offset:   40 Size:     8
//
// }
//
// cbuffer PerView
...
// DynamicSampler_id263              sampler      NA          NA             s2      1 
// DynamicTexture_id262              texture  float4          2d             t0      1 
// EnvironmentLightingDFG_LUT_id303    texture  float4          2d             t1      1 
...
//
#line 1917 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_68492811c1c6707173a1917c43254355.hlsl"
...
#line 593
add r6.xy, v4.xyxx, cb1[1].zwzz  // r6.x <- <Compute_id414 return value>.x; r6.y <- <Compute_id414 return value>.y

#line 577
mad r6.xy, r6.xyxx, cb1[2].xyxx, cb1[2].zwzz  // r6.x <- <Compute_id430 return value>.x; r6.y <- <Compute_id430 return value>.y

#line 573
sample_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t0.yzwx, s2  // r1.w <- <Compute_id434 return value>.x
...
#line 557
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id69 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t2.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id69 return value>
...
#line 557
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t2.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id69 return value>

#line 690
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 557
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id69 return value>
...
#line 557
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t2.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id69 return value>
...
#line 1195
    iadd r6.w, r3.w, l(-1)
    add r6.w, -cb2[r6.w + 83].x, cb2[r3.w + 83].x  // r6.w <- splitSize

#line 1196
  else 
    mov r6.w, cb2[r3.w + 83].x  // r6.w <- splitSize
  endif 

#line 1197
  add r3.w, -v2.x, cb2[r3.w + 83].x
  div r3.w, r3.w, r6.w  // r3.w <- splitDist

#line 1198
  lt r6.w, r3.w, l(0.200000)
  if_nz r6.w
...
#line 866
      ...
      dp4 r4.w, r7.xyzw, cb2[r5.w + 35].xyzw  // r4.w <- shadowPosition.z
...
#line 557
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.xyxx, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id69 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.zwzz, t2.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id69 return value>
...
#line 557
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r17.xyxx, t2.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id69 return value>

#line 690
      mad r4.w, r7.x, r5.w, r4.w
...
#line 1207
      mad r5.w, r6.z, l(0.000370), -r4.w
      mad r8.xyz, r3.wwww, r5.wwww, r4.wwww  // r8.x <- shadow.x; r8.y <- shadow.y; r8.z <- shadow.z
...
#line 660
  ...
  mul r2.y, r2.y, r2.y
  mul r2.x, r2.y, r2.x
  mad r2.xyz, r9.xyzx, r2.xxxx, r4.xyzx  // r2.x <- <FresnelSchlick_id203 return value>.x; r2.y <- <FresnelSchlick_id203 return value>.y; r2.z <- <FresnelSchlick_id203 return value>.z
...
#line 656
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 1410
  mul r2.xyz, r2.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id680 return value>.x; r2.y <- <ComputeDirectLightContribution_id680 return value>.y; r2.z <- <ComputeDirectLightContribution_id680 return value>.z
...
#line 660
  ...
  mul r5.w, r5.w, r10.w
  mad r13.xyz, r13.xyzx, r5.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id203 return value>.x; r13.y <- <FresnelSchlick_id203 return value>.y; r13.z <- <FresnelSchlick_id203 return value>.z
...
#line 656
  ...
  div r12.w, r4.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 853
  mul r5.w, r5.w, r12.w
  mul r4.w, r6.w, r4.w
  div r4.w, r5.w, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id221 return value>
...
#line 848
  ...
  mad r3.w, r3.w, r10.w, l(1.000000)
  max r3.w, r3.w, l(0.000100)  // r3.w <- d

#line 849
  mul r3.w, r3.w, r3.w
  mul r3.w, r3.w, l(3.141593)
  div r3.w, r5.w, r3.w  // r3.w <- <NormalDistributionGGX_id233 return value>
...
#line 660
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r16.xyz, r16.xyzx, r4.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id203 return value>.x; r16.y <- <FresnelSchlick_id203 return value>.y; r16.z <- <FresnelSchlick_id203 return value>.z
...
#line 656
  ...
  div r6.w, r3.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id219 return value>
  mad r4.w, r11.z, r5.w, r4.w
  div r4.w, r11.z, r4.w  // r4.w <- <VisibilityhSchlickGGX_id219 return value>

#line 853
  mul r4.w, r4.w, r6.w
  mul r3.w, r11.z, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id221 return value>
...
#line 849
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id233 return value>
...
#line 343
  mul r4.w, r4.w, cb0[r3.w + 29].w  // r4.w <- factor
...
#line 1341
  mul r14.xyz, r4.wwww, cb0[r3.w + 30].xyzx
...
#line 1421
  dp3_sat r4.w, r12.xyzx, r15.xyzx  // r4.w <- streams.LdotH_id77
...
#line 660
  ...
  mul r6.z, r6.z, r6.z
  mul r4.w, r4.w, r6.z
  mad r15.xyz, r15.xyzx, r4.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id203 return value>.x; r15.y <- <FresnelSchlick_id203 return value>.y; r15.z <- <FresnelSchlick_id203 return value>.z

#line 655
  mul r4.w, r10.x, l(0.500000)  // r4.w <- k

#line 656
  mad r6.z, -r10.x, l(0.500000), l(1.000000)
  mad r6.w, r5.w, r6.z, r4.w
  div r6.w, r5.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id219 return value>
  mad r4.w, r10.z, r6.z, r4.w
  div r4.w, r10.z, r4.w  // r4.w <- <VisibilityhSchlickGGX_id219 return value>

#line 853
  mul r4.w, r4.w, r6.w
  mul r5.w, r10.z, r5.w
  div r4.w, r4.w, r5.w  // r4.w <- <VisibilitySmithSchlickGGX_id221 return value>
...
#line 337
  mul r4.w, r4.w, cb0[r3.w + 95].z  // r4.w <- factor
...
#line 339
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id115 return value>

#line 476
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation

#line 467
  dp3 r5.w, -cb0[r3.w + 94].xyzx, r13.xyzx  // r5.w <- cd

#line 468
  mad_sat r5.w, r5.w, cb0[r3.w + 95].x, cb0[r3.w + 95].y  // r5.w <- attenuation
...
#line 1319
  mul r14.xyz, r4.wwww, cb0[r3.w + 96].xyzx
  mul r14.xyz, r5.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id44.x; r14.y <- streams.lightColorNdotL_id44.y; r14.z <- streams.lightColorNdotL_id44.z
...
#line 1038
mad r2.xyz, r4.xyzx, r2.xxxx, r2.yyyy  // r2.x <- <Compute_id502 return value>.x; r2.y <- <Compute_id502 return value>.y; r2.z <- <Compute_id502 return value>.z

#line 1300
mul r4.xyz, r0.xyzx, r2.xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id681 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id681 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id681 return value>.z

#line 1667
mad r0.xyz, r5.xyzx, r0.xyzx, r4.xyzx  // r0.x <- environmentLightingContribution.x; r0.y <- environmentLightingContribution.y; r0.z <- environmentLightingContribution.z
...
mad r4.xzw, r7.xxyz, -r4.xxxx, r6.xxyz  // r4.x <- color.x; r4.z <- color.y; r4.w <- color.z

#line 806
mad r2.w, r2.w, r2.w, -r4.y
mad r4.xyz, cb2[97].xyzx, r2.wwww, r4.xzwx  // r4.y <- color.y; r4.z <- color.z

#line 1291
mul r4.xyz, r4.xyzx, cb2[102].xxxx
mul r4.xyz, r1.wwww, r4.xyzx  // r4.x <- streams.envLightDiffuseColor_id47.x; r4.y <- streams.envLightDiffuseColor_id47.y; r4.z <- streams.envLightDiffuseColor_id47.z
...
#line 1023
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t7.xyzw, s0, r2.w  // r6.x <- <Compute_id332 return value>.x; r6.y <- <Compute_id332 return value>.y; r6.z <- <Compute_id332 return value>.z
...
#line 1008
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t8.xyzw, s0, r0.w  // r3.x <- <Compute_id352 return value>.x; r3.y <- <Compute_id352 return value>.y; r3.z <- <Compute_id352 return value>.z
...
mov o0.w, cb1[0].w
ret 
// Approximately 648 instruction slots used
***************************
*************************/
...
const static float Value_id281 = 1;
const static bool TIsEnergyConservative_id300 = false;
static const float PI_id302 = 3.14159265358979323846;
struct PS_STREAMS 
{
    ...
    float Input_1_id219;
    float Input_2_id228;
    float2 Input_5_id239;
    float2 Plus_6_id242;
    float2 Input_8_id247;
    float2 Multiply_9_id250;
    float2 Input_10_id254;
    float2 Plus_11_id257;
    float4 TextureValue_12_id261;
    float Member_13_id266;
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id248;
    float2 InputValue_id255;
};
cbuffer PerView 
{
    float4x4 View_id25;
...
Texture2D EnvironmentLightingDFG_LUT_id303;
...
{
    return Compute_id435(streams).r;
}
float4 Compute_id434(inout PS_STREAMS streams)
{
    return DynamicTexture_id262.Sample(DynamicSampler_id263, Compute_id431(streams));
}
float2 Compute_id430(inout PS_STREAMS streams)
{
    return Compute_id425(streams) + Compute_id427(streams);
}
float2 Compute_id423()
{
...
{
    streams.Member_13_id266 = Compute_id438(streams);
}
void Compute_id455(inout PS_STREAMS streams)
{
    streams.TextureValue_12_id261 = Compute_id434(streams);
}
void Compute_id453(inout PS_STREAMS streams)
{
    streams.Plus_11_id257 = Compute_id430(streams);
}
void Compute_id451(inout PS_STREAMS streams)
{
    streams.Input_10_id254 = Compute_id423();
}
void Compute_id449(inout PS_STREAMS streams)
{
    streams.Multiply_9_id250 = Compute_id422(streams);
}
void Compute_id447(inout PS_STREAMS streams)
{
    streams.Input_8_id247 = Compute_id415();
}
void Compute_id445(inout PS_STREAMS streams)
{
    streams.Plus_6_id242 = Compute_id414(streams);
}
void Compute_id443(inout PS_STREAMS streams)
{
    streams.Input_5_id239 = Compute_id407();
}
void Compute_id441()
{
}
...
{
    streams.Input_2_id228 = Compute_id395();
}
void Compute_id386(inout PS_STREAMS streams)
{
    streams.Input_1_id219 = Compute_id383();
}
void Compute_id374(inout PS_STREAMS streams)
{
    streams.Input_0_id211 = Compute_id371();
}
...
{
    return streams.Member_13_id266;
}
...
float4 Compute_id377(inout PS_STREAMS streams)
{
...
float3 Compute_id502(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id303.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float Compute_id404(inout PS_STREAMS streams)
{
...
void AfterLightingAndShading_id651()
{
}
void AfterLightingAndShading_id632()
{
}
...
float3 ComputeEnvironmentLightContribution_id681(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id502(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id625(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id680(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id534(streams, specularColor);
    float geometricShadowing = Compute_id564(streams);
    float normalDistribution = Compute_id594(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id624(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id302 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id648()
{
}
void PrepareForLightingAndShading_id629()
{
}
...
float4 Compute_id501()
{
    float x = Compute_id499();
...
void Compute_id737(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id629();
    }

    {
        PrepareForLightingAndShading_id648();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id624(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id680(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id625(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id681(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id302 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id632();
    }

    {
        AfterLightingAndShading_id651();
    }
}
void Compute_id721(inout PS_STREAMS streams)
{
    streams.matCavitySpecular_id61 = Compute_id501().r;
}
void Compute_id716(inout PS_STREAMS streams)
{
    streams.matCavityDiffuse_id60 = Compute_id492().r;
}
void Compute_id711(inout PS_STREAMS streams)
{
    streams.matCavity_id59 = Compute_id483().r;
}
void Compute_id706(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusionDirectLightingFactor_id58 = Compute_id474().r;
}
void Compute_id701(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusion_id57 = Compute_id465(streams).r;
}
void Compute_id696(inout PS_STREAMS streams)
{
    float metalness = Compute_id406(streams).r;
...
{
    float glossiness = Compute_id394(streams).r;
...
{
    float4 colorBase = Compute_id382(streams);
