...
//
#line 172 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_aa19eeffb2f0709faeed0a0f1a798a13.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id133;
    float2 Texture1TexelSize_id135;
    float2 Texture2TexelSize_id137;
    float2 Texture3TexelSize_id139;
    float2 Texture4TexelSize_id141;
    float2 Texture5TexelSize_id143;
    float2 Texture6TexelSize_id145;
    float2 Texture7TexelSize_id147;
    float2 Texture8TexelSize_id149;
    float2 Texture9TexelSize_id151;
};
Texture2D Texture0_id132;
Texture2D Texture1_id134;
Texture2D Texture2_id136;
Texture2D Texture3_id138;
Texture2D Texture4_id140;
Texture2D Texture5_id142;
Texture2D Texture6_id144;
Texture2D Texture7_id146;
Texture2D Texture8_id148;
Texture2D Texture9_id150;
TextureCube TextureCube0_id152;
TextureCube TextureCube1_id153;
TextureCube TextureCube2_id154;
TextureCube TextureCube3_id155;
Texture3D Texture3D0_id156;
Texture3D Texture3D1_id157;
Texture3D Texture3D2_id158;
Texture3D Texture3D3_id159;
SamplerState Sampler_id160;
SamplerState PointSampler_id161 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id162 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id163 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id164 
{
...
SamplerState AnisotropicSampler_id165 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id166 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id167 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id168 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id169 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id170;
SamplerState Sampler1_id171;
SamplerState Sampler2_id172;
SamplerState Sampler3_id173;
SamplerState Sampler4_id174;
SamplerState Sampler5_id175;
SamplerState Sampler6_id176;
SamplerState Sampler7_id177;
SamplerState Sampler8_id178;
SamplerState Sampler9_id179;
