...
@R    DynamicTexture_id194 => ObjectTexture_fx0 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id194 => ObjectTexture_fx0 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id195 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id195 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id195 => ObjectSampler_fx1 [Stage: Pixel, Slot: (1-1)]
@R    DynamicTexture_id194 => ObjectTexture_fx0 [Stage: Pixel, Slot: (0-0)]
...
//
#line 1127 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_7be7985c5fc89a7c74235472d8bc5b80.hlsl"
...
@G    Pixel => aedfbf1cc076337010543a290da239c6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id204;            // Offset:    8 Size:     4
//   float InputValue_id213;            // Offset:   12 Size:     4
//
// }
//
// cbuffer PerView
...
// DynamicSampler_id195              sampler      NA          NA             s1      1 
// DynamicTexture_id194              texture  float4          2d             t0      1 
...
//
#line 1194 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_7be7985c5fc89a7c74235472d8bc5b80.hlsl"
...
#line 347
mul r0.zw, v4.xxxy, cb1[0].xxxy  // r0.z <- <Compute_id280 return value>.x; r0.w <- <Compute_id280 return value>.y

#line 343
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.zwzz, t0.xyzw, s1  // r3.x <- <Compute_id284 return value>.x; r3.y <- <Compute_id284 return value>.y; r3.z <- <Compute_id284 return value>.z; r3.w <- <Compute_id284 return value>.w

#line 1046
add r0.z, -cb1[0].z, l(1.000000)  // r0.z <- glossiness

#line 1038
add r4.xyz, r3.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r4.xyz, cb1[0].wwww, r4.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r4.x <- streams.matSpecular_id55.x; r4.y <- streams.matSpecular_id55.y; r4.z <- streams.matSpecular_id55.z

#line 1039
mad r3.xyz, cb1[0].wwww, -r3.xyzx, r3.xyzx  // r3.x <- streams.matDiffuse_id53.x; r3.y <- streams.matDiffuse_id53.y; r3.z <- streams.matDiffuse_id53.z
...
#line 580
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id326 return value>.x; r0.z <- <Compute_id326 return value>.y; r0.w <- <Compute_id326 return value>.z

#line 735
mul r4.xyz, r0.yzwy, cb2[43].xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id505 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id505 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id505 return value>.z
...
struct PS_STREAMS 
{
    ...
    float2 Multiply_3_id188;
    float4 TextureValue_5_id193;
    float Input_6_id203;
    float Input_7_id212;
...
Texture2D DynamicTexture_id194;
SamplerState DynamicSampler_id195;
...
float2 Compute_id281(inout PS_STREAMS streams)
{
    return streams.Multiply_3_id188;
}
...
{
    return DynamicTexture_id194.Sample(DynamicSampler_id195, Compute_id281(streams));
}
...
{
    streams.Input_7_id212 = Compute_id314();
}
void Compute_id305(inout PS_STREAMS streams)
{
    streams.Input_6_id203 = Compute_id302();
}
void Compute_id293(inout PS_STREAMS streams)
{
    streams.TextureValue_5_id193 = Compute_id284(streams);
}
void Compute_id291(inout PS_STREAMS streams)
{
    streams.Multiply_3_id188 = Compute_id280(streams);
}
...
{
    return streams.TextureValue_5_id193;
}
...
float3 Compute_id326(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id225.SampleLevel(LinearSampler_id140, float2(glossiness, nDotV), 0);
...
float3 Compute_id358(inout PS_STREAMS streams, float3 f0)
{
...
void AfterLightingAndShading_id475()
{
}
void AfterLightingAndShading_id456()
{
}
...
float3 ComputeEnvironmentLightContribution_id505(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id326(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
float3 ComputeDirectLightContribution_id504(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id358(streams, specularColor);
    float geometricShadowing = Compute_id388(streams);
    float normalDistribution = Compute_id418(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id224 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id472()
{
}
void PrepareForLightingAndShading_id453()
{
}
...
void Compute_id536(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id453();
    }

    {
        PrepareForLightingAndShading_id472();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id504(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id505(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id224 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id456();
    }

    {
        AfterLightingAndShading_id475();
    }
}
void Compute_id520(inout PS_STREAMS streams)
{
    float metalness = Compute_id325(streams).r;
...
{
    float glossiness = Compute_id313(streams).r;
...
{
    float4 colorBase = Compute_id301(streams);
