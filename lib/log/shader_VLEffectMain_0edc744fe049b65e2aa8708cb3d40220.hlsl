...
@C    constantFloat_id284 => Material.MetalnessValue
...
@R    DynamicSampler_id267 => ObjectSampler_fx11 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id291 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id291 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id291 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (2-2)]
...
//
#line 1831 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_0edc744fe049b65e2aa8708cb3d40220.hlsl"
...
@G    Pixel => fad1748c5d0d605acbe3d3f5158e10fd
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float constantFloat_id284;         // Offset:   48 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id291    texture  float4          2d             t2      1 
...
//
#line 1908 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_0edc744fe049b65e2aa8708cb3d40220.hlsl"
...
#line 606
sample_indexable(texture2d)(float,float,float,float) r7.xy, r7.xyxx, t1.xyzw, s3  // r7.x <- <Compute_id432 return value>.x; r7.y <- <Compute_id432 return value>.y
...
mad r8.xyz, cb1[3].xxxx, r8.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r8.x <- streams.matSpecular_id55.x; r8.y <- streams.matSpecular_id55.y; r8.z <- streams.matSpecular_id55.z

#line 1713
mad r6.xyz, cb1[3].xxxx, -r6.xyzx, r6.xyzx  // r6.x <- streams.matDiffuse_id53.x; r6.y <- streams.matDiffuse_id53.y; r6.z <- streams.matDiffuse_id53.z
...
rsq r0.w, r0.w
mul r2.xyz, r0.wwww, r4.xyzx  // r2.x <- streams.normalWS_id19.x; r2.y <- streams.normalWS_id19.y; r2.z <- streams.normalWS_id19.z
...
max r4.y, r0.w, l(0.000100)  // r4.y <- streams.NdotV_id72
...
#line 935
  mul r4.z, cb2[28].z, cb2[82].x
  dp2 r3.w, r4.zzzz, r3.wwww

#line 1225
  mad r5.xyz, r3.wwww, r2.xyzx, v0.xyzx  // r5.x <- shadowPosition.x; r5.y <- shadowPosition.y; r5.z <- shadowPosition.z

#line 927
  ishl r3.w, r1.w, l(2)
  mov r5.w, l(1.000000)
  dp4 r7.x, r5.xyzw, cb2[r3.w + 29].xyzw  // r7.x <- shadowPosition.x
  dp4 r7.y, r5.xyzw, cb2[r3.w + 30].xyzw  // r7.y <- shadowPosition.y
  dp4 r4.z, r5.xyzw, cb2[r3.w + 31].xyzw  // r4.z <- shadowPosition.z
  dp4 r4.w, r5.xyzw, cb2[r3.w + 32].xyzw  // r4.w <- shadowPosition.w

#line 928
  add r7.z, r4.z, -cb2[81].x  // r7.z <- shadowPosition.z

#line 929
  div r7.xyz, r7.xyzx, r4.wwww

#line 599
  mad r4.zw, r7.xxxy, cb2[28].xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
  round_ni r7.xy, r4.zwzz  // r7.x <- base_uv.x; r7.y <- base_uv.y

#line 600
  add r4.zw, r4.zzzw, -r7.xxxy  // r4.z <- st.x; r4.w <- st.y
...
#line 422
  mad r9.xyzw, r4.zwwz, l(11.000000, 11.000000, 11.000000, 11.000000), l(-28.000000, -28.000000, 17.000000, 17.000000)  // r9.x <- uvW1.x; r9.y <- uvW1.y

#line 423
  mad r10.xyzw, r4.wzzw, l(5.000000, 5.000000, 5.000000, 5.000000), l(-6.000000, -6.000000, 1.000000, 1.000000)  // r10.x <- uvW0.y; r10.y <- uvW0.x

#line 425
  mad r11.xyzw, r4.zwzw, l(4.000000, 4.000000, 4.000000, 4.000000), l(-5.000000, -5.000000, -16.000000, -16.000000)
...
#line 426
  mad r11.xy, r4.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000), l(5.000000, 5.000000, 0.000000, 0.000000)
  div r11.xy, r11.xyxx, r9.wzww
  add r11.xw, r11.yyyx, l(1.000000, 0.000000, 0.000000, 1.000000)  // r11.x <- uv2.y; r11.w <- uv2.x

#line 427
  div r4.zw, r4.zzzw, r10.zzzw
  add r13.xy, r4.zwzz, l(3.000000, 3.000000, 0.000000, 0.000000)  // r13.x <- uv3.x; r13.y <- uv3.y
...
#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r14.xyxx, t3.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t3.xxxx, s1, r7.z  // r8.w <- <SampleTextureAndCompare_id68 return value>

#line 739
  mul r8.w, r8.w, r9.x
  mad r7.w, r10.x, r7.w, r8.w  // r7.w <- shadow

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t3.xxxx, s1, r7.z  // r8.w <- <SampleTextureAndCompare_id68 return value>

#line 739
  mad r4.z, r4.z, r8.w, r7.w  // r4.z <- shadow

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.xyxx, t3.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id68 return value>

#line 739
  mad r4.z, r12.x, r7.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r15.xyxx, t3.xxxx, s1, r7.z

#line 739
  mad r4.z, r9.y, r7.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r15.zwzz, t3.xxxx, s1, r7.z

#line 739
  mad r4.z, r19.z, r7.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r16.zwzz, t3.xxxx, s1, r7.z

#line 739
  mad r4.z, r13.z, r7.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.zwzz, t3.xxxx, s1, r7.z

#line 739
  mad r4.z, r11.x, r7.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r18.xyxx, t3.xxxx, s1, r7.z

#line 739
  mad r4.z, r4.w, r7.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r18.zwzz, t3.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id68 return value>

#line 739
  mad r4.z, r13.w, r4.w, r4.z

#line 594
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r19.xyxx, t3.xxxx, s1, r7.z

#line 739
  mad r4.z, r19.w, r4.w, r4.z
...
#line 1233
    iadd r4.w, r1.w, l(-1)
    add r4.w, -cb2[r4.w + 83].x, cb2[r1.w + 83].x  // r4.w <- splitSize

#line 1234
  else 
    mov r4.w, cb2[r1.w + 83].x  // r4.w <- splitSize
  endif 

#line 1235
  add r1.w, -v2.x, cb2[r1.w + 83].x
  div r1.w, r1.w, r4.w  // r1.w <- splitDist

#line 1236
  lt r4.w, r1.w, l(0.200000)
  if_nz r4.w
...
#line 927
      dp4 r9.x, r5.xyzw, cb2[r3.w + 33].xyzw  // r9.x <- shadowPosition.x
      dp4 r9.y, r5.xyzw, cb2[r3.w + 34].xyzw  // r9.y <- shadowPosition.y
      dp4 r2.w, r5.xyzw, cb2[r3.w + 35].xyzw  // r2.w <- shadowPosition.z
      dp4 r3.w, r5.xyzw, cb2[r3.w + 36].xyzw  // r3.w <- shadowPosition.w

#line 928
      add r9.z, r2.w, -cb2[81].x  // r9.z <- shadowPosition.z

#line 929
      div r5.xyz, r9.xyzx, r3.wwww  // r5.x <- shadowPosition.x; r5.y <- shadowPosition.y; r5.z <- shadowPosition.z
...
#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r15.xyxx, t3.xxxx, s1, r5.z  // r2.w <- <SampleTextureAndCompare_id68 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.zwzz, t3.xxxx, s1, r5.z  // r3.w <- <SampleTextureAndCompare_id68 return value>
...
#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t3.xxxx, s1, r5.z  // r3.w <- <SampleTextureAndCompare_id68 return value>

#line 739
      mad r2.w, r5.x, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r18.xyxx, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r13.x, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r16.xyxx, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r10.y, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r16.zwzz, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r20.x, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.zwzz, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r9.z, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r18.zwzz, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r12.x, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r19.xyxx, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r5.y, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r19.zwzz, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r9.w, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.zwzz, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r20.y, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r13.ywyy, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r10.z, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r21.xyxx, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r13.z, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r21.zwzz, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r12.z, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r12.ywyy, t3.xxxx, s1, r5.z

#line 739
      mad r2.w, r10.w, r3.w, r2.w

#line 594
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r9.xyxx, t3.xxxx, s1, r5.z
...
#line 1245
      mad r3.w, r4.z, l(0.000370), -r2.w
      mad r7.xyz, r1.wwww, r3.wwww, r2.wwww  // r7.x <- shadow.x; r7.y <- shadow.y; r7.z <- shadow.z
...
#line 1442
  ...
  mul r5.xyz, r0.wwww, r5.xyzx  // r5.x <- streams.lightColorNdotL_id44.x; r5.y <- streams.lightColorNdotL_id44.y; r5.z <- streams.lightColorNdotL_id44.z
...
#line 1434
  dp3_sat r0.z, -cb2[26].xyzx, r1.xyzx  // r0.z <- streams.LdotH_id77

#line 1428
  mul r1.xyz, r5.xyzx, r6.xyzx
...
#line 709
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r7.xyz, r7.xyzx, r0.zzzz, r8.xyzx  // r7.x <- <FresnelSchlick_id184 return value>.x; r7.y <- <FresnelSchlick_id184 return value>.y; r7.z <- <FresnelSchlick_id184 return value>.z

#line 705
  mad r0.z, r0.w, l(0.500000), l(0.500000)
  div r0.z, r0.w, r0.z  // r0.z <- <VisibilityhSchlickGGX_id200 return value>
  mad r1.w, r4.y, l(0.500000), l(0.500000)
  div r1.w, r4.y, r1.w  // r1.w <- <VisibilityhSchlickGGX_id200 return value>

#line 914
  mul r0.z, r0.z, r1.w
  mul r0.w, r4.y, r0.w
  div r0.z, r0.z, r0.w  // r0.z <- <VisibilitySmithSchlickGGX_id202 return value>
...
#line 1423
  mul r5.xyz, r5.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000)  // r5.x <- <ComputeDirectLightContribution_id647 return value>.x; r5.y <- <ComputeDirectLightContribution_id647 return value>.y; r5.z <- <ComputeDirectLightContribution_id647 return value>.z

#line 1549
  mad r1.xyz, r1.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000), r5.xyzx  // r1.x <- directLightingContribution.x; r1.y <- directLightingContribution.y; r1.z <- directLightingContribution.z
...
#line 1185
mov r5.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r5.xyzw, t4.xyzw  // r0.x <- streams.lightData_id173.x; r0.y <- streams.lightData_id173.y
...
#line 1169
  ld_indexable(buffer)(uint,uint,uint,uint) r1.w, r4.zzzz, t5.yzwx  // r1.w <- realLightIndex
...
#line 1172
  ishl r2.w, r1.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyzw, r2.wwww, t6.xyzw  // r13.x <- pointLight1.x; r13.y <- pointLight1.y; r13.z <- pointLight1.z; r13.w <- pointLight1.w

#line 1173
  bfi r1.w, l(31), l(1), r1.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r1.wwww, t6.xyzw  // r14.x <- pointLight2.x; r14.y <- pointLight2.y; r14.z <- pointLight2.z
...
#line 1432
  ...
  rsq r1.w, r1.w
  mul r15.xyz, r1.wwww, r15.xyzx  // r15.x <- streams.H_id75.x; r15.y <- streams.H_id75.y; r15.z <- streams.H_id75.z

#line 1434
  dp3_sat r1.w, r13.xyzx, r15.xyzx  // r1.w <- streams.LdotH_id77
...
#line 709
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r15.xyz, r15.xyzx, r1.wwww, r10.yzwy  // r15.x <- <FresnelSchlick_id184 return value>.x; r15.y <- <FresnelSchlick_id184 return value>.y; r15.z <- <FresnelSchlick_id184 return value>.z

#line 705
  mad r1.w, r2.w, l(0.500000), l(0.500000)
  div r1.w, r2.w, r1.w  // r1.w <- <VisibilityhSchlickGGX_id200 return value>
  mad r3.w, r4.w, l(0.500000), l(0.500000)
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id200 return value>

#line 914
  mul r1.w, r1.w, r3.w
  mul r2.w, r4.w, r2.w
  div r1.w, r1.w, r2.w  // r1.w <- <VisibilitySmithSchlickGGX_id202 return value>
...
mov r1.w, r4.y  // r1.w <- streams.NdotV_id72
mov r9.xyz, r2.xyzx  // r9.x <- streams.normalWS_id19.x; r9.y <- streams.normalWS_id19.y; r9.z <- streams.normalWS_id19.z
...
mov r2.w, r4.z  // r2.w <- streams.lightIndex_id174
mov r3.w, l(0)  // r3.w <- i
loop 
  ige r4.w, r3.w, r0.x
  breakc_nz r4.w
...
#line 1144
  ishl r5.w, r4.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r11.xyz, r5.wwww, t7.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z
...
#line 364
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id93 return value>
...
#line 709
  ...
  mul r7.w, r7.w, r7.w
  mul r4.w, r4.w, r7.w
  mad r14.xyz, r14.xyzx, r4.wwww, r7.xyzx  // r14.x <- <FresnelSchlick_id184 return value>.x; r14.y <- <FresnelSchlick_id184 return value>.y; r14.z <- <FresnelSchlick_id184 return value>.z

#line 705
  mad r4.w, r5.w, l(0.500000), l(0.500000)
  div r4.w, r5.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id200 return value>
  mad r7.w, r1.w, l(0.500000), l(0.500000)
  div r7.w, r1.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id200 return value>

#line 914
  mul r4.w, r4.w, r7.w
  mul r5.w, r1.w, r5.w
  div r4.w, r4.w, r5.w  // r4.w <- <VisibilitySmithSchlickGGX_id202 return value>
...
mov r5.xyz, r6.xyzx
mov r7.xyz, r8.xyzx
mov r0.w, r4.y  // r0.w <- streams.NdotV_id72
mov r9.xyz, r2.xyzx
...
#line 1354
  ...
  mul r13.xyz, r4.zzzz, r13.xyzx  // r13.x <- streams.lightColorNdotL_id44.x; r13.y <- streams.lightColorNdotL_id44.y; r13.z <- streams.lightColorNdotL_id44.z

#line 1432
  add r14.xyz, r1.xyzx, r12.xyzx
...
#line 709
  ...
  mul r3.w, r3.w, r3.w
  mul r2.w, r2.w, r3.w
  mad r14.xyz, r14.xyzx, r2.wwww, r7.xyzx  // r14.x <- <FresnelSchlick_id184 return value>.x; r14.y <- <FresnelSchlick_id184 return value>.y; r14.z <- <FresnelSchlick_id184 return value>.z

#line 705
  mad r2.w, r4.z, l(0.500000), l(0.500000)
  div r2.w, r4.z, r2.w  // r2.w <- <VisibilityhSchlickGGX_id200 return value>
  mad r3.w, r0.w, l(0.500000), l(0.500000)
  div r3.w, r0.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id200 return value>

#line 914
  mul r2.w, r2.w, r3.w
  mul r3.w, r0.w, r4.z
  div r2.w, r2.w, r3.w  // r2.w <- <VisibilitySmithSchlickGGX_id202 return value>
...
#line 662
  add r12.xyz, -r0.xyzx, cb0[r2.w + 157].xyzx  // r12.x <- lightVector.x; r12.y <- lightVector.y; r12.z <- lightVector.z
...
#line 504
  dp3 r4.z, -cb0[r2.w + 158].xyzx, r12.xyzx  // r4.z <- cd

#line 505
  mad_sat r4.z, r4.z, cb0[r2.w + 159].x, cb0[r2.w + 159].y  // r4.z <- attenuation
...
#line 1332
  mul r13.xyz, r3.wwww, cb0[r2.w + 160].xyzx
  mul r13.xyz, r4.zzzz, r13.xyzx  // r13.x <- streams.lightColorNdotL_id44.x; r13.y <- streams.lightColorNdotL_id44.y; r13.z <- streams.lightColorNdotL_id44.z
...
#line 1075
mov r4.x, l(0)
sample_l_indexable(texture2d)(float,float,float,float) r0.xy, r4.xyxx, t2.xyzw, s0, l(0.000000)  // r0.x <- environmentLightingDFG.x; r0.y <- environmentLightingDFG.y

#line 1076
mad r0.xyz, r8.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id469 return value>.x; r0.y <- <Compute_id469 return value>.y; r0.z <- <Compute_id469 return value>.z

#line 1313
mul r1.xyz, r0.xyzx, cb2[88].xyzx  // r1.x <- <ComputeEnvironmentLightContribution_id648 return value>.x; r1.y <- <ComputeEnvironmentLightContribution_id648 return value>.y; r1.z <- <ComputeEnvironmentLightContribution_id648 return value>.z
...
#line 1302
dp3 r0.w, r2.xyzx, cb2[98].xyzx  // r0.w <- sampleDirection.x
dp3 r1.w, r2.xyzx, cb2[99].xyzx  // r1.w <- sampleDirection.y
dp3 r2.w, r2.xyzx, cb2[100].xyzx  // r2.w <- sampleDirection.z
...
#line 863
mul r5.xyz, r1.wwww, cb2[93].xyzx
mad r4.yzw, r5.xxyz, r0.wwww, r4.yyzw

#line 864
mul r5.xyz, r1.wwww, cb2[94].xyzx
...
#line 866
mul r5.xyz, r0.wwww, cb2[96].xyzx
...
add r0.w, r0.w, r0.w
mad r3.xyz, r2.xyzx, -r0.wwww, -r3.xyzx  // r3.x <- sampleDirection.x; r3.y <- sampleDirection.y; r3.z <- sampleDirection.z
...
#line 1061
sample_l_indexable(texturecube)(float,float,float,float) r5.xyz, r5.xyzx, t8.xyzw, s0, cb2[97].w  // r5.x <- <Compute_id313 return value>.x; r5.y <- <Compute_id313 return value>.y; r5.z <- <Compute_id313 return value>.z
...
#line 1671
mad r1.xyz, r0.xyzx, r5.xyzx, r1.xyzx

#line 1290
dp3 r0.w, r2.xyzx, cb2[112].xyzx  // r0.w <- sampleDirection.x
dp3 r1.w, r2.xyzx, cb2[113].xyzx  // r1.w <- sampleDirection.y
dp3 r2.x, r2.xyzx, cb2[114].xyzx  // r2.x <- sampleDirection.z

#line 828
mul r2.y, r1.w, r1.w  // r2.y <- y2
...
#line 1046
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t9.xyzw, s0, cb2[111].w  // r3.x <- <Compute_id333 return value>.x; r3.y <- <Compute_id333 return value>.y; r3.z <- <Compute_id333 return value>.z
...
const static bool TIsNormalXY1_id274 = true;
const static bool TScaleAndBias_id275 = true;
const static bool TInvert_id282 = true;
const static float Value_id278 = 1;
const static bool TIsEnergyConservative_id288 = false;
static const float PI_id290 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id291;
...
float3 Compute_id469(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id291.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
void AfterLightingAndShading_id618()
{
}
...
float3 ComputeEnvironmentLightContribution_id648(inout PS_STREAMS streams)
{
    ...
    return Compute_id469(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id592(inout PS_STREAMS streams)
{
...
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id501(streams, specularColor);
    float geometricShadowing = Compute_id531(streams);
    float normalDistribution = Compute_id561(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id591(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id290 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id615()
{
}
...
float4 Compute_id467()
{
    return float4(constantFloat_id284, constantFloat_id284, constantFloat_id284, constantFloat_id284);
}
float4 Compute_id466()
{
    float x = Compute_id464();
...
void Compute_id684(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id615();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id591(streams);
            }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id592(streams);
        }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id290 + environmentLightingContribution;
    ...
    {
        AfterLightingAndShading_id618();
    }
}
void Compute_id668(inout PS_STREAMS streams)
{
    float metalness = Compute_id467().r;
...
void Compute_id663(inout PS_STREAMS streams)
{
    float glossiness = Compute_id466().r;
