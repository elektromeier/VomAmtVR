...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, mixin AssignVarFloat4<BufferItem_1> [{Value = mixin GetItemBufferFloat4<ObjectBuffer_fx0,PerMaterial> [{Index = GetSemanticUInt<SemanticValue_2,SV_InstanceID>}]}], mixin AssignVarFloat4<SRgbToLinear_ShaderFXResult_3> [{Value = mixin SRgbToLinear_ShaderFX [{SRgb = GetVarFloat4<BufferItem_1>}]}]]}]}, {Value = GetVarFloat4<SRgbToLinear_ShaderFXResult_3>}]}]}], mixin MaterialSurfaceNormalMap<true,true> [{normalMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_6> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerMaterial>}], mixin AssignVarFloat2<Plus_7> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_8,TEXCOORD0>}, {Right = GetVarFloat2<Input_6>}]}], mixin AssignVarFloat2<Input_9> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i1,PerMaterial>}], mixin AssignVarFloat2<Multiply_10> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_7>}, {Right = GetVarFloat2<Input_9>}]}], mixin AssignVarFloat2<Input_11> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i2,PerMaterial>}], mixin AssignVarFloat2<Plus_12> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_10>}, {Right = GetVarFloat2<Input_11>}]}], mixin AssignVarFloat4<TextureValue_13> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx4,PerMaterial,ObjectSampler_fx5,PerMaterial> [{TexCd = GetVarFloat2<Plus_12>}]}]]}]}, {Value = GetVarFloat4<TextureValue_13>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_14> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_14>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_15> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_15>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matEmissive,rgba> [{computeColorSource = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat4<float4(1, 1, 1, 1)>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matEmissiveIntensity,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, mixin AssignVarFloat<BufferItem_17> [{Value = mixin GetItemBufferFloat<ObjectBuffer_fx16,PerMaterial> [{Index = GetSemanticUInt<SemanticValue_18,SV_InstanceID>}]}]]}]}, {Value = GetVarFloat<BufferItem_17>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}], MaterialSurfaceEmissiveShading<false>]}]
...
@C    InputValue_id227 => ShaderFX.InputValueFloat2
@C    InputValue_id235 => ShaderFX.InputValueFloat2.i1
@C    InputValue_id242 => ShaderFX.InputValueFloat2.i2
@C    InputValue_id261 => ShaderFX.InputValueFloat
@C    InputValue_id270 => ShaderFX.InputValueFloat.i1
...
@R    DynamicBuffer_id214 => ObjectBuffer_fx0 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id249 => ObjectTexture_fx4 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id249 => ObjectTexture_fx4 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id250 => ObjectSampler_fx5 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id250 => ObjectSampler_fx5 [Stage: None, Slot: (-1--1)]
@R    DynamicBuffer_id287 => ObjectBuffer_fx16 [Stage: None, Slot: (-1--1)]
@R    DynamicBuffer_id287 => ObjectBuffer_fx16 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id301 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id301 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id250 => ObjectSampler_fx5 [Stage: Pixel, Slot: (2-2)]
@R    InstanceWorldInverse_id41 => TransformationInstancing.InstanceWorldInverse [Stage: Pixel, Slot: (0-0)]
@R    DynamicBuffer_id214 => ObjectBuffer_fx0 [Stage: Pixel, Slot: (1-1)]
@R    DynamicTexture_id249 => ObjectTexture_fx4 [Stage: Pixel, Slot: (2-2)]
@R    DynamicBuffer_id287 => ObjectBuffer_fx16 [Stage: Pixel, Slot: (3-3)]
@R    EnvironmentLightingDFG_LUT_id301 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (4-4)]
...
*****     Stages      *****
***************************
@G    Vertex => d9312df7589e476eada6932ce3b1269c
//
...
//
#line 1818 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ed57683d3b739bc6164b93ceb95db84d.hlsl"
...
@G    Pixel => 2f53f75eb4e5af5c9ff58e5cd02e2b86
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float2 InputValue_id227;           // Offset:    0 Size:     8
//   float2 InputValue_id235;           // Offset:    8 Size:     8
//   float2 InputValue_id242;           // Offset:   16 Size:     8
//   float InputValue_id261;            // Offset:   24 Size:     4
//   float InputValue_id270;            // Offset:   28 Size:     4
//
// }
//
// cbuffer PerView
...
// DynamicSampler_id250              sampler      NA          NA             s2      1 
// InstanceWorldInverse_id41         texture  struct         r/o             t0      1 
// DynamicBuffer_id214               texture  float4         buf             t1      1 
// DynamicTexture_id249              texture  float4          2d             t2      1 
// DynamicBuffer_id287               texture   float         buf             t3      1 
// EnvironmentLightingDFG_LUT_id301    texture  float4          2d             t4      1 
...
//
#line 1963 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ed57683d3b739bc6164b93ceb95db84d.hlsl"
...
#line 1807
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r4.xyz, v5.x, l(0), t0.xyzx  // r4.x <- <GetInstanceWorldInverse_id14 return value>._m00; r4.y <- <GetInstanceWorldInverse_id14 return value>._m10; r4.z <- <GetInstanceWorldInverse_id14 return value>._m20
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r5.xyz, v5.x, l(16), t0.xyzx  // r5.x <- <GetInstanceWorldInverse_id14 return value>._m01; r5.y <- <GetInstanceWorldInverse_id14 return value>._m11; r5.z <- <GetInstanceWorldInverse_id14 return value>._m21
ld_structured_indexable(structured_buffer, stride=64)(mixed,mixed,mixed,mixed) r6.xyz, v5.x, l(32), t0.xyzx  // r6.x <- <GetInstanceWorldInverse_id14 return value>._m02; r6.y <- <GetInstanceWorldInverse_id14 return value>._m12; r6.z <- <GetInstanceWorldInverse_id14 return value>._m22

#line 1906
mov r7.x, r4.x
mov r7.y, r5.x
mov r7.z, r6.x
dp3 r8.x, r2.xyzx, r7.xyzx  // r8.x <- streams.tangentToWorld_id20._m00
mov r9.x, r4.y
mov r9.y, r5.y
mov r9.z, r6.y
dp3 r10.x, r2.xyzx, r9.xyzx  // r10.x <- streams.tangentToWorld_id20._m01
mov r6.x, r4.z
mov r6.y, r5.z
dp3 r2.x, r2.xyzx, r6.xyzx  // r2.x <- streams.tangentToWorld_id20._m02
dp3 r8.y, r3.xyzx, r7.xyzx  // r8.y <- streams.tangentToWorld_id20._m10
dp3 r10.y, r3.xyzx, r9.xyzx  // r10.y <- streams.tangentToWorld_id20._m11
dp3 r2.y, r3.xyzx, r6.xyzx  // r2.y <- streams.tangentToWorld_id20._m12
dp3 r8.z, r1.xyzx, r7.xyzx  // r8.z <- streams.tangentToWorld_id20._m20
dp3 r10.z, r1.xyzx, r9.xyzx  // r10.z <- streams.tangentToWorld_id20._m21
dp3 r2.z, r1.xyzx, r6.xyzx  // r2.z <- streams.tangentToWorld_id20._m22

#line 1893
add r1.xyz, -v0.xyzx, cb2[21].xyzx
dp3 r0.z, r1.xyzx, r1.xyzx
rsq r0.z, r0.z
mul r3.xyz, r0.zzzz, r1.xyzx  // r3.x <- streams.viewWS_id70.x; r3.y <- streams.viewWS_id70.y; r3.z <- streams.viewWS_id70.z

#line 647
ld_indexable(buffer)(float,float,float,float) r4.xyzw, v5.xxxx, t1.xyzw  // r4.x <- <Compute_id370 return value>.x; r4.y <- <Compute_id370 return value>.y; r4.z <- <Compute_id370 return value>.z; r4.w <- <Compute_id370 return value>.w
...
mul r6.xyz, r4.xyzx, r5.xyzx  // r6.x <- <SRgbToLinear_id727 return value>.x; r6.y <- <SRgbToLinear_id727 return value>.y; r6.z <- <SRgbToLinear_id727 return value>.z

#line 635
add r7.xy, v6.xyxx, cb1[0].xyxx  // r7.x <- <Compute_id396 return value>.x; r7.y <- <Compute_id396 return value>.y

#line 619
mad r7.xy, r7.xyxx, cb1[0].zwzz, cb1[1].xyxx  // r7.x <- <Compute_id412 return value>.x; r7.y <- <Compute_id412 return value>.y

#line 615
sample_indexable(texture2d)(float,float,float,float) r7.xy, r7.xyxx, t2.xyzw, s2  // r7.x <- <Compute_id416 return value>.x; r7.y <- <Compute_id416 return value>.y
...
mad r4.xyz, cb1[1].wwww, r4.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r4.x <- streams.matSpecular_id57.x; r4.y <- streams.matSpecular_id57.y; r4.z <- streams.matSpecular_id57.z

#line 1751
mad r5.xyz, cb1[1].wwww, -r6.xyzx, r6.xyzx  // r5.x <- streams.matDiffuse_id55.x; r5.y <- streams.matDiffuse_id55.y; r5.z <- streams.matDiffuse_id55.z

#line 603
ld_indexable(buffer)(float,float,float,float) r1.w, v5.xxxx, t3.yzwx  // r1.w <- <Compute_id478 return value>
...
rsq r2.x, r2.x
mul r2.xyz, r2.xxxx, r6.xyzx  // r2.x <- streams.normalWS_id19.x; r2.y <- streams.normalWS_id19.y; r2.z <- streams.normalWS_id19.z
...
#line 1226
  mad r7.xyz, r6.zzzz, r2.xyzx, v0.xyzx  // r7.x <- shadowPosition.x; r7.y <- shadowPosition.y; r7.z <- shadowPosition.z
...
#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r15.xyxx, t5.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id72 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r15.zwzz, t5.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id72 return value>
...
#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t5.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id72 return value>

#line 728
  mad r6.w, r8.x, r8.w, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r18.xyxx, t5.xxxx, s1, r8.z  // r8.x <- <SampleTextureAndCompare_id72 return value>

#line 728
  mad r6.w, r13.x, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r16.xyxx, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r10.y, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r16.zwzz, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r20.x, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r17.zwzz, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r9.z, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r18.zwzz, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r12.x, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r19.xyxx, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r8.y, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r19.zwzz, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r9.w, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r14.zwzz, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r20.y, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r13.ywyy, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r10.z, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r21.xyxx, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r13.z, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r21.zwzz, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r12.z, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r12.ywyy, t5.xxxx, s1, r8.z

#line 728
  mad r6.w, r10.w, r8.x, r6.w

#line 591
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r9.xyxx, t5.xxxx, s1, r8.z
...
#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t5.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id72 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r15.zwzz, t5.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id72 return value>
...
#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t5.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id72 return value>

#line 728
      mad r5.w, r7.x, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r18.xyxx, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r13.x, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r16.xyxx, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r10.y, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r16.zwzz, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r20.x, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.zwzz, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r9.z, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r18.zwzz, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r12.x, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r19.xyxx, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r7.y, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r19.zwzz, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r9.w, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.zwzz, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r20.y, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r13.ywyy, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r10.z, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r21.xyxx, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r13.z, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r21.zwzz, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r12.z, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r12.ywyy, t5.xxxx, s1, r7.z

#line 728
      mad r5.w, r10.w, r6.z, r5.w

#line 591
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r9.xyxx, t5.xxxx, s1, r7.z
...
#line 1448
  ...
  dp3 r0.z, r1.xyzx, r1.xyzx
  rsq r0.z, r0.z
  mul r1.xyz, r0.zzzz, r1.xyzx  // r1.x <- streams.H_id77.x; r1.y <- streams.H_id77.y; r1.z <- streams.H_id77.z

#line 1449
  dp3_sat r0.z, r2.xyzx, r1.xyzx  // r0.z <- streams.NdotH_id78

#line 1450
  dp3_sat r1.x, -cb2[26].xyzx, r1.xyzx  // r1.x <- streams.LdotH_id79
...
#line 698
  ...
  mul r1.y, r1.y, r1.y
  mul r1.x, r1.y, r1.x
  mad r1.xyz, r9.xyzx, r1.xxxx, r4.xyzx  // r1.x <- <FresnelSchlick_id196 return value>.x; r1.y <- <FresnelSchlick_id196 return value>.y; r1.z <- <FresnelSchlick_id196 return value>.z
...
#line 1439
  mul r1.xyz, r1.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r1.x <- <ComputeDirectLightContribution_id669 return value>.x; r1.y <- <ComputeDirectLightContribution_id669 return value>.y; r1.z <- <ComputeDirectLightContribution_id669 return value>.z

#line 1579
  mad r1.xyz, r8.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000), r1.xyzx  // r1.x <- directLightingContribution.x; r1.y <- directLightingContribution.y; r1.z <- directLightingContribution.z
...
#line 1186
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t6.xyzw  // r0.x <- streams.lightData_id175.x; r0.y <- streams.lightData_id175.y
...
mov r7.w, r3.x  // r7.w <- streams.viewWS_id70.x
mov r8.yz, r3.yyzy  // r8.y <- streams.viewWS_id70.y; r8.z <- streams.viewWS_id70.z
mov r9.xy, r5.xyxx  // r9.x <- streams.matDiffuseVisible_id71.x; r9.y <- streams.matDiffuseVisible_id71.y
mov r10.x, r5.z  // r10.x <- streams.matDiffuseVisible_id71.z
mov r10.yzw, r4.xxyz  // r10.y <- streams.matSpecularVisible_id73.x; r10.z <- streams.matSpecularVisible_id73.y; r10.w <- streams.matSpecularVisible_id73.z
mov r2.w, r0.w  // r2.w <- streams.alphaRoughness_id72
...
#line 1170
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r6.zzzz, t7.yzwx  // r5.w <- realLightIndex
...
#line 1173
  ishl r8.w, r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyzw, r8.wwww, t8.xyzw  // r13.x <- pointLight1.x; r13.y <- pointLight1.y; r13.z <- pointLight1.z; r13.w <- pointLight1.w
...
#line 685
  add r13.xyz, -r7.xyzx, r13.xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z

#line 686
  dp3 r5.w, r13.xyzx, r13.xyzx
  sqrt r8.w, r5.w  // r8.w <- lightVectorLength

#line 687
  div r13.xyz, r13.xyzx, r8.wwww  // r13.x <- lightVectorNorm.x; r13.y <- lightVectorNorm.y; r13.z <- lightVectorNorm.z

#line 537
  max r8.w, r5.w, l(0.000100)
...
#line 538
  mul r5.w, r5.w, r8.w  // r5.w <- attenuation

#line 1412
  dp3 r8.w, r11.xyzx, r13.xyzx
  max r8.w, r8.w, l(0.000100)  // r8.w <- streams.NdotL_id51

#line 1414
  mul r14.xyz, r5.wwww, r14.xyzx
  mul r14.xyz, r8.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id46.x; r14.y <- streams.lightColorNdotL_id46.y; r14.z <- streams.lightColorNdotL_id46.z

#line 1448
  mov r8.x, r7.w
  add r15.xyz, r13.xyzx, r8.xyzx
...
#line 1450
  dp3_sat r8.x, r13.xyzx, r15.xyzx  // r8.x <- streams.LdotH_id79
...
#line 698
  ...
  mul r9.z, r9.z, r9.z
  mul r8.x, r8.x, r9.z
  mad r15.xyz, r15.xyzx, r8.xxxx, r10.yzwy  // r15.x <- <FresnelSchlick_id196 return value>.x; r15.y <- <FresnelSchlick_id196 return value>.y; r15.z <- <FresnelSchlick_id196 return value>.z

#line 693
  mul r8.x, r2.w, l(0.500000)  // r8.x <- k

#line 694
  mad r9.z, -r2.w, l(0.500000), l(1.000000)
  mad r9.w, r8.w, r9.z, r8.x
  div r9.w, r8.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r8.x, r6.w, r9.z, r8.x
  div r8.x, r6.w, r8.x  // r8.x <- <VisibilityhSchlickGGX_id212 return value>

#line 898
  mul r8.x, r8.x, r9.w
  mul r8.w, r6.w, r8.w
  div r8.x, r8.x, r8.w  // r8.x <- <VisibilitySmithSchlickGGX_id214 return value>

#line 892
  mul r8.w, r2.w, r2.w  // r8.w <- alphaR2

#line 893
  mul r5.w, r5.w, r5.w
  mad r9.z, r2.w, r2.w, l(-1.000000)
...
#line 894
  ...
  div r5.w, r8.w, r5.w  // r5.w <- <NormalDistributionGGX_id226 return value>
...
mov r8.xyz, r3.xyzx  // r8.x <- streams.viewWS_id70.x
mov r9.xyz, r5.xyzx  // r9.z <- streams.matDiffuseVisible_id71.z
...
#line 1142
  ld_indexable(buffer)(uint,uint,uint,uint) r2.w, r0.yyyy, t7.yzwx  // r2.w <- realLightIndex
...
#line 1145
  ishl r3.w, r2.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r3.wwww, t9.xyzw  // r14.x <- spotLight1.x; r14.y <- spotLight1.y; r14.z <- spotLight1.z
...
#line 1449
  dp3_sat r2.w, r11.xyzx, r16.xyzx  // r2.w <- streams.NdotH_id78
...
#line 698
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r16.xyz, r16.xyzx, r5.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id196 return value>.x; r16.y <- <FresnelSchlick_id196 return value>.y; r16.z <- <FresnelSchlick_id196 return value>.z
...
mov r7.y, r0.w
mov r7.w, r6.y
mov r1.xyz, r3.xyzx  // r1.x <- streams.viewWS_id70.x; r1.y <- streams.viewWS_id70.y; r1.z <- streams.viewWS_id70.z
...
#line 366
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id108 return value>

#line 517
  mul r5.w, r5.w, r6.z  // r5.w <- attenuation

#line 1368
  dp3 r6.z, r10.xyzx, r12.xyzx
  max r6.z, r6.z, l(0.000100)  // r6.z <- streams.NdotL_id51

#line 1370
  mul r14.xyz, r5.wwww, cb0[r3.w + 30].xyzx
  mul r14.xyz, r6.zzzz, r14.xyzx  // r14.x <- streams.lightColorNdotL_id46.x; r14.y <- streams.lightColorNdotL_id46.y; r14.z <- streams.lightColorNdotL_id46.z

#line 1448
  add r15.xyz, r1.xyzx, r12.xyzx
  dp3 r3.w, r15.xyzx, r15.xyzx
  rsq r3.w, r3.w
  mul r15.xyz, r3.wwww, r15.xyzx  // r15.x <- streams.H_id77.x; r15.y <- streams.H_id77.y; r15.z <- streams.H_id77.z

#line 1449
  dp3_sat r3.w, r10.xyzx, r15.xyzx  // r3.w <- streams.NdotH_id78

#line 1450
  dp3_sat r5.w, r12.xyzx, r15.xyzx  // r5.w <- streams.LdotH_id79
...
#line 698
  ...
  mul r6.w, r6.w, r6.w
  mul r5.w, r5.w, r6.w
  mad r15.xyz, r15.xyzx, r5.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id196 return value>.x; r15.y <- <FresnelSchlick_id196 return value>.y; r15.z <- <FresnelSchlick_id196 return value>.z
...
#line 694
  mad r6.w, -r7.y, l(0.500000), l(1.000000)
  mad r7.x, r6.z, r6.w, r5.w
  div r7.x, r6.z, r7.x  // r7.x <- <VisibilityhSchlickGGX_id212 return value>
  mad r5.w, r7.w, r6.w, r5.w
  div r5.w, r7.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id212 return value>
...
#line 898
  mul r5.w, r5.w, r7.x
  mul r6.z, r7.w, r6.z
  div r5.w, r5.w, r6.z  // r5.w <- <VisibilitySmithSchlickGGX_id214 return value>

#line 892
  mul r6.z, r7.y, r7.y  // r6.z <- alphaR2
...
#line 894
  ...
  div r3.w, r6.z, r3.w  // r3.w <- <NormalDistributionGGX_id226 return value>
...
#line 651
  add r13.xyz, -r0.xyzx, cb0[r3.w + 93].xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z
...
#line 358
  mul r5.w, r5.w, cb0[r3.w + 95].z  // r5.w <- factor
...
#line 360
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id118 return value>

#line 510
  mul r5.w, r5.w, r6.z  // r5.w <- attenuation

#line 501
  dp3 r6.z, -cb0[r3.w + 94].xyzx, r13.xyzx  // r6.z <- cd

#line 502
  mad_sat r6.z, r6.z, cb0[r3.w + 95].x, cb0[r3.w + 95].y  // r6.z <- attenuation
...
#line 1346
  dp3 r6.z, r10.xyzx, r13.xyzx
  max r6.z, r6.z, l(0.000100)  // r6.z <- streams.NdotL_id51

#line 1348
  mul r14.xyz, r5.wwww, cb0[r3.w + 96].xyzx
  mul r14.xyz, r6.zzzz, r14.xyzx  // r14.x <- streams.lightColorNdotL_id46.x; r14.y <- streams.lightColorNdotL_id46.y; r14.z <- streams.lightColorNdotL_id46.z
...
#line 1076
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r6.xyxx, t4.zxyw, s0, l(0.000000)  // r0.y <- environmentLightingDFG.x; r0.z <- environmentLightingDFG.y

#line 1077
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id491 return value>.x; r0.z <- <Compute_id491 return value>.y; r0.w <- <Compute_id491 return value>.z

#line 1329
mul r1.xyz, r0.yzwy, cb2[88].xyzx  // r1.x <- <ComputeEnvironmentLightContribution_id670 return value>.x; r1.y <- <ComputeEnvironmentLightContribution_id670 return value>.y; r1.z <- <ComputeEnvironmentLightContribution_id670 return value>.z

#line 1689
mad r1.xyz, r5.xyzx, cb2[88].xyzx, r1.xyzx  // r1.x <- environmentLightingContribution.x; r1.y <- environmentLightingContribution.y; r1.z <- environmentLightingContribution.z

#line 1318
dp3 r2.w, r2.xyzx, cb2[98].xyzx  // r2.w <- sampleDirection.x
dp3 r3.w, r2.xyzx, cb2[99].xyzx  // r3.w <- sampleDirection.y
dp3 r4.x, r2.xyzx, cb2[100].xyzx  // r4.x <- sampleDirection.z
...
add r2.w, r2.w, r2.w
mad r3.xyz, r2.xyzx, -r2.wwww, -r3.xyzx  // r3.x <- sampleDirection.x; r3.y <- sampleDirection.y; r3.z <- sampleDirection.z
...
#line 1062
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t10.xyzw, s0, r2.w  // r6.x <- <Compute_id328 return value>.x; r6.y <- <Compute_id328 return value>.y; r6.z <- <Compute_id328 return value>.z
...
#line 1701
mad r1.xyz, r0.yzwy, r6.xyzx, r1.xyzx

#line 1306
dp3 r2.w, r2.xyzx, cb2[112].xyzx  // r2.w <- sampleDirection.x
dp3 r3.w, r2.xyzx, cb2[113].xyzx  // r3.w <- sampleDirection.y
dp3 r2.x, r2.xyzx, cb2[114].xyzx  // r2.x <- sampleDirection.z

#line 812
mul r2.y, r3.w, r3.w  // r2.y <- y2

#line 813
mul r2.z, r2.x, r2.x  // r2.z <- z2
...
mad r4.xyz, r6.xyzx, -r2.xxxx, r4.xyzx
...
#line 826
mad r2.x, r2.w, r2.w, -r2.y
mad r2.xyz, cb2[111].xyzx, r2.xxxx, r4.xyzx  // r2.x <- color.x; r2.y <- color.y; r2.z <- color.z

#line 1308
mul r2.xyz, r2.xyzx, cb2[116].xxxx  // r2.x <- streams.envLightDiffuseColor_id49.x; r2.y <- streams.envLightDiffuseColor_id49.y; r2.z <- streams.envLightDiffuseColor_id49.z
...
#line 1047
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t11.xyzw, s0, r0.x  // r3.x <- <Compute_id348 return value>.x; r3.y <- <Compute_id348 return value>.y; r3.z <- <Compute_id348 return value>.z
...
const static bool TIsNormalXY1_id257 = true;
const static bool TScaleAndBias_id258 = true;
const static bool TInvert_id267 = true;
const static float4 Value_id281 = float4(1, 1, 1, 1);
const static bool TIsEnergyConservative_id298 = false;
static const float PI_id300 = 3.14159265358979323846;
const static bool TUseAlphaFromEmissive_id310 = false;
struct PS_STREAMS 
{
    ...
    float2 Input_6_id226;
    float2 Plus_7_id229;
    float2 Input_9_id234;
    float2 Multiply_10_id237;
    float2 Input_11_id241;
    float2 Plus_12_id244;
    float4 TextureValue_13_id248;
    float Input_14_id260;
    float Input_15_id269;
    float BufferItem_17_id286;
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id235;
    float2 InputValue_id242;
    float InputValue_id261;
...
SamplerState DynamicSampler_id250;
Buffer<float> DynamicBuffer_id287;
Texture2D EnvironmentLightingDFG_LUT_id301;
...
float SmoothDistanceAttenuation_id118(float squaredDistance, float lightInvSquareRadius)
{
...
uint Compute_id475(inout PS_STREAMS streams)
{
    return streams.InstanceID_id13;
}
float2 Compute_id413(inout PS_STREAMS streams)
{
    return streams.Plus_12_id244;
}
float2 Compute_id409(inout PS_STREAMS streams)
{
    return streams.Input_11_id241;
}
float2 Compute_id407(inout PS_STREAMS streams)
{
    return streams.Multiply_10_id237;
}
float2 Compute_id401(inout PS_STREAMS streams)
{
    return streams.Input_9_id234;
}
float2 Compute_id399(inout PS_STREAMS streams)
{
    return streams.Plus_7_id229;
}
float2 Compute_id393(inout PS_STREAMS streams)
{
    return streams.Input_6_id226;
}
float2 Compute_id391(inout PS_STREAMS streams)
{
    return streams.TexCoord_id142;
}
float4 SRgbToLinear_id727(float4 sRGBa)
{
...
float GetAngularAttenuation_id120(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float GetDistanceAttenuation_id119(float lightVectorLength, float lightInvSquareRadius)
{
    float d2 = lightVectorLength * lightVectorLength;
    float attenuation = 1.0 / (max(d2, 0.01 * 0.01));
    attenuation *= SmoothDistanceAttenuation_id118(d2, lightInvSquareRadius);
    return attenuation;
}
...
void CalculateAdjustedShadowSpacePixelPosition_id78(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    ...
    const float4 topRightTexelWS = Project_id64(float4(ShadowMapTextureTexelSize_id93.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
...
void CalculateAdjustedShadowSpacePixelPositionPerspective_id77(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    ...
    const float4 topRightTexelWS = Project_id64(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id93.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
...
{
    return DynamicBuffer_id287[Compute_id475(streams)];
}
float Compute_id454()
{
...
float4 Compute_id416(inout PS_STREAMS streams)
{
    return DynamicTexture_id249.Sample(DynamicSampler_id250, Compute_id413(streams));
}
...
{
    return InputValue_id242;
}
float2 Compute_id404(inout PS_STREAMS streams)
{
    return Compute_id399(streams) * Compute_id401(streams);
}
float2 Compute_id397()
{
    return InputValue_id235;
}
float2 Compute_id396(inout PS_STREAMS streams)
{
    return Compute_id391(streams) + Compute_id393(streams);
}
float2 Compute_id389()
{
    return InputValue_id227;
}
float4 Compute_id374(inout PS_STREAMS streams)
{
    return SRgbToLinear_id727(Compute_id371(streams));
}
float4 Compute_id370(inout PS_STREAMS streams)
{
    return DynamicBuffer_id214[Compute_id367(streams)];
}
float ComputeAttenuation_id121(float3 PositionWS, float3 AngleOffsetAndInvSquareRadius, float3 DirectionWS, float3 position, inout float3 lightVectorNorm)
{
    ...
    float attenuation = GetDistanceAttenuation_id119(lightVectorLength, lightInvSquareRadius);
    attenuation *= GetAngularAttenuation_id120(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
    return attenuation;
}
float ComputeAttenuation_id109(PointLightDataInternal light, float3 position, inout float3 lightVectorNorm)
{
    float3 lightVector = light.PositionWS - position;
    float lightVectorLength = length(lightVector);
    lightVectorNorm = lightVector / lightVectorLength;
    float lightInvSquareRadius = light.InvSquareRadius;
    return GetDistanceAttenuation_id110(lightVectorLength, lightInvSquareRadius);
}
...
{
    streams.BufferItem_17_id286 = Compute_id478(streams);
}
void Compute_id480()
{
}
...
{
    streams.Input_15_id269 = Compute_id454();
}
void Compute_id445(inout PS_STREAMS streams)
{
    streams.Input_14_id260 = Compute_id442();
}
void Compute_id433(inout PS_STREAMS streams)
{
    streams.TextureValue_13_id248 = Compute_id416(streams);
}
void Compute_id431(inout PS_STREAMS streams)
{
    streams.Plus_12_id244 = Compute_id412(streams);
}
void Compute_id429(inout PS_STREAMS streams)
{
    streams.Input_11_id241 = Compute_id405();
}
void Compute_id427(inout PS_STREAMS streams)
{
    streams.Multiply_10_id237 = Compute_id404(streams);
}
void Compute_id425(inout PS_STREAMS streams)
{
    streams.Input_9_id234 = Compute_id397();
}
void Compute_id423(inout PS_STREAMS streams)
{
    streams.Plus_7_id229 = Compute_id396(streams);
}
void Compute_id421(inout PS_STREAMS streams)
{
    streams.Input_6_id226 = Compute_id389();
}
void Compute_id419()
{
}
...
float4 EvaluateSphericalHarmonics_id140(float3 sphericalColors[TOrder_id192 * TOrder_id192], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float4 EvaluateSphericalHarmonics_id131(float3 sphericalColors[TOrder_id192 * TOrder_id192], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ProcessLight_id122(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id121(light.PositionWS, light.AngleOffsetAndInvSquareRadius, light.DirectionWS, streams.PositionWS_id22.xyz, lightVectorNorm);
...
void ProcessLight_id111(inout PS_STREAMS streams, PointLightDataInternal light)
{
    float3 lightVectorNorm;
    float attenuation = ComputeAttenuation_id109(light, streams.PositionWS_id22.xyz, lightVectorNorm);
...
float ComputeThicknessFromCascade_id69(float3 pixelPositionWS, float3 meshNormalWS, int cascadeIndex, int lightIndex, bool isOrthographic)
{
    ...
    return FilterThickness_id66(pixelPositionWS, meshNormalWS, DepthRanges_id158[arrayIndex], WorldToShadowCascadeUV_id155[arrayIndex], InverseWorldToShadowCascadeUV_id156[arrayIndex], isOrthographic);
}
...
{
    return streams.BufferItem_17_id286;
}
...
float4 Compute_id436(inout PS_STREAMS streams)
{
    return streams.TextureValue_13_id248;
}
...
{
    return EvaluateSphericalHarmonics_id131(SphericalColors_id195, direction);
}
...
float3 Compute_id491(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id301.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
void PrepareDirectLightCore_id114(inout PS_STREAMS streams, int lightIndex)
{
    ...
    ProcessLight_id122(streams, data);
}
...
void PrepareDirectLightCore_id104(inout PS_STREAMS streams, int lightIndex)
{
    ...
    ProcessLight_id111(streams, data);
}
...
float3 ComputeShadow_id59(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id67(OffsetScales_id160[lightIndex], streams.NdotL_id51, streams.normalWS_id19);
...
float Compute_id488(inout PS_STREAMS streams)
{
    ...
    return Compute_id485(streams);
}
float4 Compute_id472()
{
    Compute_id468();
...
float Compute_id463(inout PS_STREAMS streams)
{
    ...
    return Compute_id460(streams);
}
float Compute_id451(inout PS_STREAMS streams)
{
    Compute_id447(streams);
    return Compute_id448(streams);
}
float4 Compute_id439(inout PS_STREAMS streams)
{
...
void AfterLightingAndShading_id640()
{
}
void AfterLightingAndShading_id621()
{
}
...
float3 ComputeEnvironmentLightContribution_id670(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    return Compute_id491(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
float3 ComputeEnvironmentLightContribution_id614(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id304(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id86 = ComputeShadow_id115(streams, streams.PositionWS_id22.xyz, lightIndex);
    ...
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id116(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id117(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
...
void PrepareDirectLight_id291(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id51 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id44), 0.0001f);
    streams.shadowColor_id86 = ComputeShadow_id105(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id46 = streams.lightColor_id45 * streams.lightAttenuation_id48 * streams.shadowColor_id86 * streams.NdotL_id51 * streams.lightDirectAmbientOcclusion_id52;
    streams.lightSpecularColorNdotL_id47 = streams.lightColorNdotL_id46;
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id106(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id107(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
...
void PrepareDirectLight_id279(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id51 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id44), 0.0001f);
    streams.shadowColor_id86 = ComputeShadow_id94(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id46 = streams.lightColor_id45 * streams.lightAttenuation_id48 * streams.shadowColor_id86 * streams.NdotL_id51 * streams.lightDirectAmbientOcclusion_id52;
    streams.lightSpecularColorNdotL_id47 = streams.lightColorNdotL_id46;
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id95(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id96(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
...
void PrepareDirectLight_id266(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id51 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id44), 0.0001f);
    streams.shadowColor_id86 = ComputeShadow_id83(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id46 = streams.lightColor_id45 * streams.lightAttenuation_id48 * streams.shadowColor_id86 * streams.NdotL_id51 * streams.lightDirectAmbientOcclusion_id52;
    streams.lightSpecularColorNdotL_id47 = streams.lightColorNdotL_id46;
    streams.lightColorNdotL_id46 *= ComputeTextureProjection_id84(streams.PositionWS_id22.xyz, lightIndex);
    float3 reflectionVectorWS = reflect(-streams.viewWS_id70, streams.normalWS_id19);
    streams.lightSpecularColorNdotL_id47 *= ComputeSpecularTextureProjection_id85(streams.PositionWS_id22.xyz, reflectionVectorWS, lightIndex);
}
...
float3 ComputeDirectLightContribution_id669(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id523(streams, specularColor);
    float geometricShadowing = Compute_id553(streams);
    float normalDistribution = Compute_id583(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id47 * streams.matDiffuseSpecularAlphaBlend_id67.y;
}
float3 ComputeDirectLightContribution_id613(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id300 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareForLightingAndShading_id637()
{
}
void PrepareForLightingAndShading_id618()
{
}
...
float4 Compute_id490(inout PS_STREAMS streams)
{
    float x = Compute_id488(streams);
    return float4(x, x, x, x);
}
float4 Compute_id474()
{
    return Compute_id472();
}
float4 Compute_id465(inout PS_STREAMS streams)
{
    float x = Compute_id463(streams);
    return float4(x, x, x, x);
}
float4 Compute_id453(inout PS_STREAMS streams)
{
    float x = Compute_id451(streams);
    return float4(x, x, x, x);
}
float4 Compute_id441(inout PS_STREAMS streams)
{
...
void Compute_id716(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id618();
    }

    {
        PrepareForLightingAndShading_id637();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id613(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id669(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id614(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id670(streams);
        }
    }
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id300 + environmentLightingContribution;
    streams.shadingColorAlpha_id76 = streams.matDiffuse_id55.a;

    {
        AfterLightingAndShading_id621();
    }

    {
        AfterLightingAndShading_id640();
    }
}
void Compute_id700(inout PS_STREAMS streams)
{
    streams.matEmissiveIntensity_id65 = Compute_id490(streams).r;
}
void Compute_id695(inout PS_STREAMS streams)
{
    streams.matEmissive_id64 = Compute_id474().rgba;
}
void Compute_id690(inout PS_STREAMS streams)
{
    float metalness = Compute_id465(streams).r;
...
void Compute_id685(inout PS_STREAMS streams)
{
    float glossiness = Compute_id453(streams).r;
...
void Compute_id680(inout PS_STREAMS streams)
{
    float4 normal = Compute_id441(streams);
...
void Compute_id675(inout PS_STREAMS streams)
{
...
void Compute_id55(inout PS_STREAMS streams)
{
    ...
    {
        Compute_id690(streams);
    }

    {
        Compute_id695(streams);
    }
    ...
    {
        Compute_id716(streams);
    }

    {
        Compute_id717(streams);
    }
}
