...
//
#line 172 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_24742d1720cea32811b3963b7d7c3236.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id131;
    float2 Texture1TexelSize_id133;
    float2 Texture2TexelSize_id135;
    float2 Texture3TexelSize_id137;
    float2 Texture4TexelSize_id139;
    float2 Texture5TexelSize_id141;
    float2 Texture6TexelSize_id143;
    float2 Texture7TexelSize_id145;
    float2 Texture8TexelSize_id147;
    float2 Texture9TexelSize_id149;
};
Texture2D Texture0_id130;
Texture2D Texture1_id132;
Texture2D Texture2_id134;
Texture2D Texture3_id136;
Texture2D Texture4_id138;
Texture2D Texture5_id140;
Texture2D Texture6_id142;
Texture2D Texture7_id144;
Texture2D Texture8_id146;
Texture2D Texture9_id148;
TextureCube TextureCube0_id150;
TextureCube TextureCube1_id151;
TextureCube TextureCube2_id152;
TextureCube TextureCube3_id153;
Texture3D Texture3D0_id154;
Texture3D Texture3D1_id155;
Texture3D Texture3D2_id156;
Texture3D Texture3D3_id157;
SamplerState Sampler_id158;
SamplerState PointSampler_id159 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id160 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id161 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id162 
{
...
SamplerState AnisotropicSampler_id163 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id164 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id165 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id166 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id167 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id168;
SamplerState Sampler1_id169;
SamplerState Sampler2_id170;
SamplerState Sampler3_id171;
SamplerState Sampler4_id172;
SamplerState Sampler5_id173;
SamplerState Sampler6_id174;
SamplerState Sampler7_id175;
SamplerState Sampler8_id176;
SamplerState Sampler9_id177;
Texture2D DynamicTexture_id105;
SamplerState DynamicSampler_id106;
Texture2D EnvironmentLightingDFG_LUT_id188;
