...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_0>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_1> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matAmbientOcclusion,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_2> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_2>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matAmbientOcclusionDirectLightingFactor,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<0>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavity,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavityDiffuse,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavitySpecular,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@C    InputValue_id238 => ShaderFX.InputValueFloat.i1
...
@R    EnvironmentLightingDFG_LUT_id274 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id274 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id274 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
//
#line 1689 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_4f57b7d98bd7615fbe03251f52989c74.hlsl"
...
@G    Pixel => 23723e9cd390b56563deb04f2a84627e
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id227;            // Offset:   16 Size:     4
//   float InputValue_id238;            // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id274    texture  float4          2d             t0      1 
...
//
#line 1756 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_4f57b7d98bd7615fbe03251f52989c74.hlsl"
...
#line 578
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r8.xyz, r8.xyzx, r0.zzzz, r4.xyzx  // r8.x <- <FresnelSchlick_id203 return value>.x; r8.y <- <FresnelSchlick_id203 return value>.y; r8.z <- <FresnelSchlick_id203 return value>.z
...
#line 1250
  mul r7.xyz, r7.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id630 return value>.x; r7.y <- <ComputeDirectLightContribution_id630 return value>.y; r7.z <- <ComputeDirectLightContribution_id630 return value>.z
...
#line 578
  ...
  mul r6.w, r6.w, r6.w
  mul r4.w, r4.w, r6.w
  mad r14.xyz, r14.xyzx, r4.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id203 return value>.x; r14.y <- <FresnelSchlick_id203 return value>.y; r14.z <- <FresnelSchlick_id203 return value>.z

#line 574
  mad r4.w, r5.w, l(0.500000), l(0.500000)
  div r4.w, r5.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id219 return value>
  mad r6.w, r1.w, l(0.500000), l(0.500000)
  div r6.w, r1.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 574
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 1150
mul r0.xyz, cb1[1].yyyy, cb2[88].xyzx  // r0.x <- lightColor.x; r0.y <- lightColor.y; r0.z <- lightColor.z
...
#line 878
mad r2.xyz, r4.xyzx, r2.xxxx, r2.yyyy  // r2.x <- <Compute_id452 return value>.x; r2.y <- <Compute_id452 return value>.y; r2.z <- <Compute_id452 return value>.z

#line 1140
mul r4.xyz, r0.xyzx, r2.xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id631 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id631 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id631 return value>.z
...
mul r4.xyz, r4.xyzx, cb1[1].yyyy  // r4.x <- streams.envLightDiffuseColor_id47.x; r4.y <- streams.envLightDiffuseColor_id47.y; r4.z <- streams.envLightDiffuseColor_id47.z
...
#line 863
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t6.xyzw, s0, cb2[97].w  // r6.x <- <Compute_id332 return value>.x; r6.y <- <Compute_id332 return value>.y; r6.z <- <Compute_id332 return value>.z

#line 1135
mul r6.xyz, r6.xyzx, cb2[102].xxxx
mul r6.xyz, r6.xyzx, cb1[1].yyyy  // r6.x <- streams.envLightSpecularColor_id48.x; r6.y <- streams.envLightSpecularColor_id48.y; r6.z <- streams.envLightSpecularColor_id48.z
...
mul r1.xyz, r1.xyzx, cb1[1].yyyy  // r1.x <- streams.envLightDiffuseColor_id47.x; r1.y <- streams.envLightDiffuseColor_id47.y; r1.z <- streams.envLightDiffuseColor_id47.z
...
#line 848
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t7.xyzw, s0, cb2[111].w  // r3.x <- <Compute_id352 return value>.x; r3.y <- <Compute_id352 return value>.y; r3.z <- <Compute_id352 return value>.z

#line 1123
mul r3.xyz, r3.xyzx, cb2[116].xxxx
mul r3.xyz, r3.xyzx, cb1[1].yyyy  // r3.x <- streams.envLightSpecularColor_id48.x; r3.y <- streams.envLightSpecularColor_id48.y; r3.z <- streams.envLightSpecularColor_id48.z
...
mov o0.w, cb1[0].w
ret 
// Approximately 573 instruction slots used
***************************
*************************/
...
const static float Value_id246 = 0;
const static bool TIsEnergyConservative_id271 = false;
static const float PI_id273 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id274;
...
{
    streams.Input_2_id237 = Compute_id404();
}
void Compute_id395(inout PS_STREAMS streams)
{
    streams.Input_1_id226 = Compute_id392();
}
void Compute_id383()
{
}
...
float3 Compute_id452(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id274.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float Compute_id544(inout PS_STREAMS streams)
{
...
float3 Compute_id484(inout PS_STREAMS streams, float3 f0)
{
...
{
    Compute_id445();
    return Compute_id446();
}
float Compute_id440()
{
    Compute_id436();
    return Compute_id437();
}
float Compute_id431()
{
    Compute_id427();
...
void AfterLightingAndShading_id601()
{
}
void AfterLightingAndShading_id582()
{
}
...
float3 ComputeEnvironmentLightContribution_id631(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id452(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id575(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id630(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id484(streams, specularColor);
    float geometricShadowing = Compute_id514(streams);
    float normalDistribution = Compute_id544(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id574(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id273 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id598()
{
}
void PrepareForLightingAndShading_id579()
{
}
...
float4 Compute_id451()
{
    float x = Compute_id449();
    return float4(x, x, x, x);
}
float4 Compute_id442()
{
    float x = Compute_id440();
    return float4(x, x, x, x);
}
float4 Compute_id433()
{
    float x = Compute_id431();
    return float4(x, x, x, x);
}
float4 Compute_id424()
{
    float x = Compute_id422();
    return float4(x, x, x, x);
}
float4 Compute_id415(inout PS_STREAMS streams)
{
    float x = Compute_id413(streams);
    return float4(x, x, x, x);
}
...
float4 Compute_id391()
{
    float x = Compute_id389();
    return float4(x, x, x, x);
}
...
void Compute_id687(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id579();
    }

    {
        PrepareForLightingAndShading_id598();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id574(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id630(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id575(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id631(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id273 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id582();
    }

    {
        AfterLightingAndShading_id601();
    }
}
void Compute_id671(inout PS_STREAMS streams)
{
    streams.matCavitySpecular_id61 = Compute_id451().r;
}
void Compute_id666(inout PS_STREAMS streams)
{
    streams.matCavityDiffuse_id60 = Compute_id442().r;
}
void Compute_id661(inout PS_STREAMS streams)
{
    streams.matCavity_id59 = Compute_id433().r;
}
void Compute_id656(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusionDirectLightingFactor_id58 = Compute_id424().r;
}
void Compute_id651(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusion_id57 = Compute_id415(streams).r;
}
...
{
    float glossiness = Compute_id391().r;
