...
//
#line 1984 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_3badc969ec7b0f03e36542a26839e3d1.hlsl"
...
@G    Pixel => 646d8d208626f3142a5340e6835121ab
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 2117 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_3badc969ec7b0f03e36542a26839e3d1.hlsl"
...
#line 1937
mad r7.xyz, cb1[2].xyzx, l(2.000000, 2.000000, 2.000000, 0.000000), l(-1.000000, -1.000000, -1.000000, 0.000000)  // r7.x <- normal.x; r7.y <- normal.y; r7.z <- normal.z

#line 723
add r8.xy, v6.xyxx, cb1[3].xyxx  // r8.x <- <Compute_id427 return value>.x; r8.y <- <Compute_id427 return value>.y

#line 707
mad r8.xy, r8.xyxx, cb1[3].zwzz, cb1[4].xyxx  // r8.x <- <Compute_id443 return value>.x; r8.y <- <Compute_id443 return value>.y

#line 703
sample_indexable(texture2d)(float,float,float,float) r0.w, r8.xyxx, t2.yzwx, s3  // r0.w <- <Compute_id447 return value>.x

#line 1928
add r0.w, -r0.w, l(1.000000)  // r0.w <- glossiness

#line 691
add r8.xy, v6.xyxx, cb1[4].zwzz  // r8.x <- <Compute_id486 return value>.x; r8.y <- <Compute_id486 return value>.y

#line 675
mad r8.xy, r8.xyxx, cb1[5].xyxx, cb1[5].zwzz  // r8.x <- <Compute_id502 return value>.x; r8.y <- <Compute_id502 return value>.y

#line 671
sample_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t3.yzwx, s4  // r1.w <- <Compute_id506 return value>.x

#line 1920
add r8.xyz, r6.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r8.xyz, r1.wwww, r8.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r8.x <- streams.matSpecular_id57.x; r8.y <- streams.matSpecular_id57.y; r8.z <- streams.matSpecular_id57.z

#line 1921
mad r6.xyz, r1.wwww, -r6.xyzx, r6.xyzx  // r6.x <- streams.matDiffuse_id55.x; r6.y <- streams.matDiffuse_id55.y; r6.z <- streams.matDiffuse_id55.z

#line 1696
mul r3.xyz, r3.xyzx, r7.yyyy
mad r2.xyz, r7.xxxx, r2.xyzx, r3.xyzx
mad r1.xyz, r7.zzzz, r1.xyzx, r2.xyzx
...
const static bool TIsNormalXY1_id252 = false;
