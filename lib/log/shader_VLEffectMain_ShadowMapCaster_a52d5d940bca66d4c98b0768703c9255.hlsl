...
//
#line 168 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_a52d5d940bca66d4c98b0768703c9255.hlsl"
...
Texture2D Texture0_id108;
Texture2D Texture1_id110;
Texture2D Texture2_id112;
Texture2D Texture3_id114;
Texture2D Texture4_id116;
Texture2D Texture5_id118;
Texture2D Texture6_id120;
Texture2D Texture7_id122;
Texture2D Texture8_id124;
Texture2D Texture9_id126;
TextureCube TextureCube0_id128;
TextureCube TextureCube1_id129;
TextureCube TextureCube2_id130;
TextureCube TextureCube3_id131;
Texture3D Texture3D0_id132;
Texture3D Texture3D1_id133;
Texture3D Texture3D2_id134;
Texture3D Texture3D3_id135;
SamplerState Sampler_id136;
SamplerState PointSampler_id137 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id138 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id139 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id140 
{
...
SamplerState AnisotropicSampler_id141 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id142 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id143 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id144 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id145 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id146;
SamplerState Sampler1_id147;
SamplerState Sampler2_id148;
SamplerState Sampler3_id149;
SamplerState Sampler4_id150;
SamplerState Sampler5_id151;
SamplerState Sampler6_id152;
SamplerState Sampler7_id153;
SamplerState Sampler8_id154;
SamplerState Sampler9_id155;
Texture2D EnvironmentLightingDFG_LUT_id203;
