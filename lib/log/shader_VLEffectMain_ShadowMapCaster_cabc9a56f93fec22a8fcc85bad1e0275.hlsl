...
//
#line 176 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_cabc9a56f93fec22a8fcc85bad1e0275.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id124;
    float2 InputValue_id132;
    float2 InputValue_id139;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id164;
    float2 Texture1TexelSize_id166;
    float2 Texture2TexelSize_id168;
    float2 Texture3TexelSize_id170;
    float2 Texture4TexelSize_id172;
    float2 Texture5TexelSize_id174;
    float2 Texture6TexelSize_id176;
    float2 Texture7TexelSize_id178;
    float2 Texture8TexelSize_id180;
    float2 Texture9TexelSize_id182;
};
Texture2D Texture0_id163;
Texture2D Texture1_id165;
Texture2D Texture2_id167;
Texture2D Texture3_id169;
Texture2D Texture4_id171;
Texture2D Texture5_id173;
Texture2D Texture6_id175;
Texture2D Texture7_id177;
Texture2D Texture8_id179;
Texture2D Texture9_id181;
TextureCube TextureCube0_id183;
TextureCube TextureCube1_id184;
TextureCube TextureCube2_id185;
TextureCube TextureCube3_id186;
Texture3D Texture3D0_id187;
Texture3D Texture3D1_id188;
Texture3D Texture3D2_id189;
Texture3D Texture3D3_id190;
SamplerState Sampler_id191;
SamplerState PointSampler_id192 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id193 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id194 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id195 
{
...
SamplerState AnisotropicSampler_id196 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id197 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id198 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id199 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id200 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id201;
SamplerState Sampler1_id202;
SamplerState Sampler2_id203;
SamplerState Sampler3_id204;
SamplerState Sampler4_id205;
SamplerState Sampler5_id206;
SamplerState Sampler6_id207;
SamplerState Sampler7_id208;
SamplerState Sampler8_id209;
SamplerState Sampler9_id210;
Texture2D DynamicTexture_id105;
SamplerState DynamicSampler_id106;
Texture2D DynamicTexture_id146;
SamplerState DynamicSampler_id147;
Texture2D EnvironmentLightingDFG_LUT_id221;
