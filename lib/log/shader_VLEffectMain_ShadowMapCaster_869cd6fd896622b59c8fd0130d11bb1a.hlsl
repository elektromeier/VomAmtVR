...
//
#line 166 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_869cd6fd896622b59c8fd0130d11bb1a.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id139;
    float2 Texture1TexelSize_id141;
    float2 Texture2TexelSize_id143;
    float2 Texture3TexelSize_id145;
    float2 Texture4TexelSize_id147;
    float2 Texture5TexelSize_id149;
    float2 Texture6TexelSize_id151;
    float2 Texture7TexelSize_id153;
    float2 Texture8TexelSize_id155;
    float2 Texture9TexelSize_id157;
};
Texture2D Texture0_id138;
Texture2D Texture1_id140;
Texture2D Texture2_id142;
Texture2D Texture3_id144;
Texture2D Texture4_id146;
Texture2D Texture5_id148;
Texture2D Texture6_id150;
Texture2D Texture7_id152;
Texture2D Texture8_id154;
Texture2D Texture9_id156;
TextureCube TextureCube0_id158;
TextureCube TextureCube1_id159;
TextureCube TextureCube2_id160;
TextureCube TextureCube3_id161;
Texture3D Texture3D0_id162;
Texture3D Texture3D1_id163;
Texture3D Texture3D2_id164;
Texture3D Texture3D3_id165;
SamplerState Sampler_id166;
SamplerState PointSampler_id167 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id168 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id169 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id170 
{
...
SamplerState AnisotropicSampler_id171 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id172 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id173 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id174 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id175 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id176;
SamplerState Sampler1_id177;
SamplerState Sampler2_id178;
SamplerState Sampler3_id179;
SamplerState Sampler4_id180;
SamplerState Sampler5_id181;
SamplerState Sampler6_id182;
SamplerState Sampler7_id183;
SamplerState Sampler8_id184;
SamplerState Sampler9_id185;
