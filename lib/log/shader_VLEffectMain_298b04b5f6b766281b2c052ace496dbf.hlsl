...
@C    InputValue_id314 => ShaderFX.InputValueFloat2.i9
@C    InputValue_id322 => ShaderFX.InputValueFloat2.i10
@C    InputValue_id329 => ShaderFX.InputValueFloat2.i11
...
@R    DynamicSampler_id301 => ObjectSampler_fx21 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id336 => ObjectTexture_fx31 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id336 => ObjectTexture_fx31 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id337 => ObjectSampler_fx32 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id337 => ObjectSampler_fx32 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id353 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id353 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id337 => ObjectSampler_fx32 [Stage: Pixel, Slot: (5-5)]
...
@R    DynamicTexture_id336 => ObjectTexture_fx31 [Stage: Pixel, Slot: (3-3)]
@R    EnvironmentLightingDFG_LUT_id353 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (4-4)]
@R    ShadowMapTexture_id89 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: Pixel, Slot: (5-5)]
@R    LightClusters_id175 => LightClustered.LightClusters [Stage: Pixel, Slot: (6-6)]
@R    LightIndices_id176 => LightClustered.LightIndices [Stage: Pixel, Slot: (7-7)]
@R    PointLights_id180 => LightClusteredPointGroup.PointLights [Stage: Pixel, Slot: (8-8)]
@R    SpotLights_id181 => LightClusteredSpotGroup.SpotLights [Stage: Pixel, Slot: (9-9)]
@R    CubeMap_id195 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (10-10)]
@R    CubeMap_id206 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[2] [Stage: Pixel, Slot: (11-11)]
...
//
#line 2155 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_298b04b5f6b766281b2c052ace496dbf.hlsl"
...
@G    Pixel => d50c740de212bbadaa8ed8132c8f04c5
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float2 InputValue_id314;           // Offset:   72 Size:     8
//   float2 InputValue_id322;           // Offset:   80 Size:     8
//   float2 InputValue_id329;           // Offset:   88 Size:     8
//
// }
//
// cbuffer PerView
...
// DynamicSampler_id337              sampler      NA          NA             s5      1 
...
// DynamicTexture_id336              texture  float4          2d             t3      1 
// EnvironmentLightingDFG_LUT_id353    texture  float4          2d             t4      1 
// ShadowMapTexture_id89             texture  float4          2d             t5      1 
// LightClusters_id175               texture   uint2          3d             t6      1 
// LightIndices_id176                texture    uint         buf             t7      1 
// PointLights_id180                 texture  float4         buf             t8      1 
// SpotLights_id181                  texture  float4         buf             t9      1 
// CubeMap_id195                     texture  float4        cube            t10      1 
// CubeMap_id206                     texture  float4        cube            t11      1 
// PerDraw                           cbuffer      NA          NA            cb0      1 
...
//
#line 2232 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_298b04b5f6b766281b2c052ace496dbf.hlsl"
...
#line 718
add r8.xy, v5.xyxx, cb1[4].zwzz  // r8.x <- <Compute_id524 return value>.x; r8.y <- <Compute_id524 return value>.y

#line 702
mad r8.xy, r8.xyxx, cb1[5].xyxx, cb1[5].zwzz  // r8.x <- <Compute_id540 return value>.x; r8.y <- <Compute_id540 return value>.y

#line 698
sample_indexable(texture2d)(float,float,float,float) r1.w, r8.xyxx, t3.yzwx, s5  // r1.w <- <Compute_id544 return value>.x

#line 2040
add r8.xyz, r6.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r8.xyz, r1.wwww, r8.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r8.x <- streams.matSpecular_id55.x; r8.y <- streams.matSpecular_id55.y; r8.z <- streams.matSpecular_id55.z

#line 2041
mad r6.xyz, r1.wwww, -r6.xyzx, r6.xyzx  // r6.x <- streams.matDiffuse_id53.x; r6.y <- streams.matDiffuse_id53.y; r6.z <- streams.matDiffuse_id53.z
...
#line 682
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.xyxx, t5.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r15.zwzz, t5.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id68 return value>
...
#line 682
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.w, r17.xyxx, t5.xxxx, s1, r7.z  // r7.w <- <SampleTextureAndCompare_id68 return value>

#line 891
  mad r4.w, r7.x, r7.w, r4.w

#line 682
  sample_c_lz_indexable(texture2d)(float,float,float,float) r7.x, r18.xyxx, t5.xxxx, s1, r7.z  // r7.x <- <SampleTextureAndCompare_id68 return value>
...
#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t5.xxxx, s1, r5.z  // r3.w <- <SampleTextureAndCompare_id68 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r15.zwzz, t5.xxxx, s1, r5.z  // r4.z <- <SampleTextureAndCompare_id68 return value>
...
#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r17.xyxx, t5.xxxx, s1, r5.z  // r4.z <- <SampleTextureAndCompare_id68 return value>

#line 891
      mad r3.w, r5.x, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r18.xyxx, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r13.x, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r16.xyxx, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r10.y, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r16.zwzz, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r20.x, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r17.zwzz, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r9.z, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r18.zwzz, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r12.x, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r19.xyxx, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r5.y, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r19.zwzz, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r9.w, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r14.zwzz, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r20.y, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r13.ywyy, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r10.z, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r21.xyxx, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r13.z, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r21.zwzz, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r12.z, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r12.ywyy, t5.xxxx, s1, r5.z

#line 891
      mad r3.w, r10.w, r4.z, r3.w

#line 682
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r9.xyxx, t5.xxxx, s1, r5.z
...
#line 1750
  mul r1.xyz, r1.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r1.x <- <ComputeDirectLightContribution_id754 return value>.x; r1.y <- <ComputeDirectLightContribution_id754 return value>.y; r1.z <- <ComputeDirectLightContribution_id754 return value>.z
...
#line 1507
mov r5.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r5.xyzw, t6.xyzw  // r0.x <- streams.lightData_id173.x; r0.y <- streams.lightData_id173.y
...
#line 1491
  ld_indexable(buffer)(uint,uint,uint,uint) r3.w, r4.zzzz, t7.yzwx  // r3.w <- realLightIndex
...
#line 1495
  ...
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r3.wwww, t8.xyzw  // r14.x <- pointLight2.x; r14.y <- pointLight2.y; r14.z <- pointLight2.z
...
#line 1397
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r4.xyxx, t4.zxyw, s0, l(0.000000)  // r0.y <- environmentLightingDFG.x; r0.z <- environmentLightingDFG.y

#line 1398
mad r0.yzw, r8.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id576 return value>.x; r0.z <- <Compute_id576 return value>.y; r0.w <- <Compute_id576 return value>.z

#line 1640
mul r1.xyz, r0.yzwy, cb2[88].xyzx  // r1.x <- <ComputeEnvironmentLightContribution_id755 return value>.x; r1.y <- <ComputeEnvironmentLightContribution_id755 return value>.y; r1.z <- <ComputeEnvironmentLightContribution_id755 return value>.z
...
#line 1383
sample_l_indexable(texturecube)(float,float,float,float) r5.xyz, r5.xyzx, t10.xyzw, s0, r1.w  // r5.x <- <Compute_id313 return value>.x; r5.y <- <Compute_id313 return value>.y; r5.z <- <Compute_id313 return value>.z
...
#line 1368
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t11.xyzw, s0, r0.x  // r3.x <- <Compute_id333 return value>.x; r3.y <- <Compute_id333 return value>.y; r3.z <- <Compute_id333 return value>.z
...
const static bool TIsEnergyConservative_id350 = false;
static const float PI_id352 = 3.14159265358979323846;
struct PS_STREAMS 
{
    ...
    float2 Input_33_id313;
    float2 Plus_34_id316;
    float2 Input_36_id321;
    float2 Multiply_37_id324;
    float2 Input_38_id328;
    float2 Plus_39_id331;
    float4 TextureValue_40_id335;
    float Member_41_id340;
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id314;
    float2 InputValue_id322;
    float2 InputValue_id329;
};
cbuffer PerView 
{
    float4x4 View_id25;
...
Texture2D DynamicTexture_id336;
SamplerState DynamicSampler_id337;
Texture2D EnvironmentLightingDFG_LUT_id353;
...
float4 Compute_id545(inout PS_STREAMS streams)
{
    return streams.TextureValue_40_id335;
}
float2 Compute_id541(inout PS_STREAMS streams)
{
    return streams.Plus_39_id331;
}
float2 Compute_id537(inout PS_STREAMS streams)
{
    return streams.Input_38_id328;
}
float2 Compute_id535(inout PS_STREAMS streams)
{
    return streams.Multiply_37_id324;
}
float2 Compute_id529(inout PS_STREAMS streams)
{
    return streams.Input_36_id321;
}
float2 Compute_id527(inout PS_STREAMS streams)
{
    return streams.Plus_34_id316;
}
float2 Compute_id521(inout PS_STREAMS streams)
{
    return streams.Input_33_id313;
}
float2 Compute_id519(inout PS_STREAMS streams)
{
...
float Compute_id548(inout PS_STREAMS streams)
{
    return Compute_id545(streams).r;
}
float4 Compute_id544(inout PS_STREAMS streams)
{
    return DynamicTexture_id336.Sample(DynamicSampler_id337, Compute_id541(streams));
}
float2 Compute_id540(inout PS_STREAMS streams)
{
    return Compute_id535(streams) + Compute_id537(streams);
}
float2 Compute_id533()
{
    return InputValue_id329;
}
float2 Compute_id532(inout PS_STREAMS streams)
{
    return Compute_id527(streams) * Compute_id529(streams);
}
float2 Compute_id525()
{
...
{
    streams.Member_41_id340 = Compute_id548(streams);
}
void Compute_id565(inout PS_STREAMS streams)
{
    streams.TextureValue_40_id335 = Compute_id544(streams);
}
void Compute_id563(inout PS_STREAMS streams)
{
    streams.Plus_39_id331 = Compute_id540(streams);
}
void Compute_id561(inout PS_STREAMS streams)
{
    streams.Input_38_id328 = Compute_id533();
}
void Compute_id559(inout PS_STREAMS streams)
{
    streams.Multiply_37_id324 = Compute_id532(streams);
}
void Compute_id557(inout PS_STREAMS streams)
{
    streams.Input_36_id321 = Compute_id525();
}
void Compute_id555(inout PS_STREAMS streams)
{
    streams.Plus_34_id316 = Compute_id524(streams);
}
void Compute_id553(inout PS_STREAMS streams)
{
    streams.Input_33_id313 = Compute_id517();
}
void Compute_id551()
{
}
...
float Compute_id570(inout PS_STREAMS streams)
{
    return streams.Member_41_id340;
}
void Compute_id569(inout PS_STREAMS streams)
{
...
float3 Compute_id576(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id353.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
void AfterLightingAndShading_id725()
{
}
void AfterLightingAndShading_id706()
{
}
...
float3 ComputeEnvironmentLightContribution_id755(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id576(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id699(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id754(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id608(streams, specularColor);
    float geometricShadowing = Compute_id638(streams);
    float normalDistribution = Compute_id668(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id698(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id352 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id722()
{
}
void PrepareForLightingAndShading_id703()
{
}
...
float4 Compute_id575(inout PS_STREAMS streams)
{
    float x = Compute_id573(streams);
...
void Compute_id791(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id703();
    }

    {
        PrepareForLightingAndShading_id722();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id698(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id754(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id699(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id755(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id352 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id706();
    }

    {
        AfterLightingAndShading_id725();
    }
}
void Compute_id775(inout PS_STREAMS streams)
{
    float metalness = Compute_id575(streams).r;
...
void Compute_id770(inout PS_STREAMS streams)
{
...
void Compute_id760(inout PS_STREAMS streams)
{
...
void Compute_id51(inout PS_STREAMS streams)
{
    ...
    {
        Compute_id770(streams);
    }

    {
        Compute_id775(streams);
    }

    {
        Compute_id791(streams);
    }
}
