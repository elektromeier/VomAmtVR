...
//
#line 177 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_6c9f8cb8d095e829485ff1fc985719bb.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id201;
    float2 Texture1TexelSize_id203;
    float2 Texture2TexelSize_id205;
    float2 Texture3TexelSize_id207;
    float2 Texture4TexelSize_id209;
    float2 Texture5TexelSize_id211;
    float2 Texture6TexelSize_id213;
    float2 Texture7TexelSize_id215;
    float2 Texture8TexelSize_id217;
    float2 Texture9TexelSize_id219;
};
Texture2D Texture0_id200;
Texture2D Texture1_id202;
Texture2D Texture2_id204;
Texture2D Texture3_id206;
Texture2D Texture4_id208;
Texture2D Texture5_id210;
Texture2D Texture6_id212;
Texture2D Texture7_id214;
Texture2D Texture8_id216;
Texture2D Texture9_id218;
TextureCube TextureCube0_id220;
TextureCube TextureCube1_id221;
TextureCube TextureCube2_id222;
TextureCube TextureCube3_id223;
Texture3D Texture3D0_id224;
Texture3D Texture3D1_id225;
Texture3D Texture3D2_id226;
Texture3D Texture3D3_id227;
SamplerState Sampler_id228;
SamplerState PointSampler_id229 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id230 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id231 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id232 
{
...
SamplerState AnisotropicSampler_id233 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id234 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id235 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id236 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id237 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id238;
SamplerState Sampler1_id239;
SamplerState Sampler2_id240;
SamplerState Sampler3_id241;
SamplerState Sampler4_id242;
SamplerState Sampler5_id243;
SamplerState Sampler6_id244;
SamplerState Sampler7_id245;
SamplerState Sampler8_id246;
SamplerState Sampler9_id247;
...
Texture2D DynamicTexture_id183;
SamplerState DynamicSampler_id184;
