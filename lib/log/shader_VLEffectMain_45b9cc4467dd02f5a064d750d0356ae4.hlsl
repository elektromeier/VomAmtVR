...
@R    EnvironmentLightingDFG_LUT_id260 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
//
#line 1565 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_45b9cc4467dd02f5a064d750d0356ae4.hlsl"
...
@G    Pixel => a7cafc62534969dc92dcf2ddf41afda4
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id248;            // Offset:   24 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id260    texture  float4          2d             t0      1 
...
//
#line 1686 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_45b9cc4467dd02f5a064d750d0356ae4.hlsl"
...
#line 517
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t1.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id74 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id74 return value>
...
#line 517
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id74 return value>

#line 622
  mad r5.w, r6.z, r8.w, r5.w

#line 517
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id74 return value>
...
#line 517
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t1.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id74 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id74 return value>
...
#line 517
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id74 return value>
...
#line 592
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id196 return value>.x; r8.y <- <FresnelSchlick_id196 return value>.y; r8.z <- <FresnelSchlick_id196 return value>.z
...
#line 588
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id212 return value>

#line 739
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id214 return value>
...
#line 735
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id226 return value>
...
#line 1208
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id602 return value>.x; r7.y <- <ComputeDirectLightContribution_id602 return value>.y; r7.z <- <ComputeDirectLightContribution_id602 return value>.z
...
#line 349
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id88 return value>
...
#line 592
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id196 return value>.x; r13.y <- <FresnelSchlick_id196 return value>.y; r13.z <- <FresnelSchlick_id196 return value>.z
...
#line 588
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id212 return value>
...
#line 343
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id99 return value>
...
#line 1218
  dp3_sat r1.w, r8.xyzx, r16.xyzx  // r1.w <- streams.NdotH_id78
...
#line 588
  ...
  div r3.w, r7.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id212 return value>
...
#line 735
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id226 return value>
...
#line 558
  add r12.xyz, -r0.xyzx, cb0[r2.x + 29].xyzx  // r12.x <- lightVector.x; r12.y <- lightVector.y; r12.z <- lightVector.z
...
#line 337
  mul r2.z, r2.z, r2.z  // r2.z <- <SmoothDistanceAttenuation_id110 return value>
...
#line 1217
  ...
  rsq r2.x, r2.x
  mul r15.xyz, r2.xxxx, r15.xyzx  // r15.x <- streams.H_id77.x; r15.y <- streams.H_id77.y; r15.z <- streams.H_id77.z

#line 1218
  dp3_sat r2.x, r7.xyzx, r15.xyzx  // r2.x <- streams.NdotH_id78

#line 1219
  dp3_sat r2.z, r12.xyzx, r15.xyzx  // r2.z <- streams.LdotH_id79
...
#line 592
  ...
  mul r4.w, r4.w, r4.w
  mul r2.z, r2.z, r4.w
  mad r15.xyz, r15.xyzx, r2.zzzz, r10.xyzx  // r15.x <- <FresnelSchlick_id196 return value>.x; r15.y <- <FresnelSchlick_id196 return value>.y; r15.z <- <FresnelSchlick_id196 return value>.z
...
#line 588
  ...
  div r5.w, r3.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r2.z, r2.w, r4.w, r2.z
  div r2.z, r2.w, r2.z  // r2.z <- <VisibilityhSchlickGGX_id212 return value>

#line 739
  mul r2.z, r2.z, r5.w
  mul r3.w, r2.w, r3.w
  div r2.z, r2.z, r3.w  // r2.z <- <VisibilitySmithSchlickGGX_id214 return value>
...
#line 735
  ...
  div r2.x, r3.w, r2.x  // r2.x <- <NormalDistributionGGX_id226 return value>
...
#line 331
  mul r2.z, r2.z, r2.z  // r2.z <- <SmoothDistanceAttenuation_id120 return value>
...
#line 1219
  dp3_sat r2.z, r13.xyzx, r15.xyzx  // r2.z <- streams.LdotH_id79
...
#line 851
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id424 return value>.x; r0.z <- <Compute_id424 return value>.y; r0.w <- <Compute_id424 return value>.z

#line 1098
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id603 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id603 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id603 return value>.z
...
#line 836
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t6.xyzw, s0, r1.w  // r6.x <- <Compute_id328 return value>.x; r6.y <- <Compute_id328 return value>.y; r6.z <- <Compute_id328 return value>.z
...
#line 821
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t7.xyzw, s0, r0.x  // r3.x <- <Compute_id348 return value>.x; r3.y <- <Compute_id348 return value>.y; r3.z <- <Compute_id348 return value>.z
...
mov o0.w, cb1[0].w
ret 
// Approximately 641 instruction slots used
***************************
*************************/
...
const static bool TUseAlphaFromEmissive_id269 = false;
struct PS_STREAMS 
{
...
{
    streams.Input_3_id247 = Compute_id412();
}
void Compute_id403()
{
}
...
float3 Compute_id424(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id260.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
void AfterLightingAndShading_id573()
{
}
void AfterLightingAndShading_id554()
{
}
...
float3 ComputeEnvironmentLightContribution_id603(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    return Compute_id424(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
float3 ComputeDirectLightContribution_id602(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id456(streams, specularColor);
    float geometricShadowing = Compute_id486(streams);
    float normalDistribution = Compute_id516(streams);
...
void PrepareForLightingAndShading_id570()
{
}
void PrepareForLightingAndShading_id551()
{
}
...
void Compute_id645(inout PS_STREAMS streams)
{
...
void Compute_id644(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id551();
    }

    {
        PrepareForLightingAndShading_id570();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id602(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id603(streams);
        }
    }
    ...
    {
        AfterLightingAndShading_id554();
    }

    {
        AfterLightingAndShading_id573();
    }
}
void Compute_id628(inout PS_STREAMS streams)
{
    streams.matEmissiveIntensity_id65 = Compute_id423(streams).r;
}
void Compute_id623(inout PS_STREAMS streams)
{
...
void Compute_id608(inout PS_STREAMS streams)
{
