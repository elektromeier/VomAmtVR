...
//
#line 170 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_d5a3606cc816df8871d8832878146302.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id123;
    float2 Texture1TexelSize_id125;
    float2 Texture2TexelSize_id127;
    float2 Texture3TexelSize_id129;
    float2 Texture4TexelSize_id131;
    float2 Texture5TexelSize_id133;
    float2 Texture6TexelSize_id135;
    float2 Texture7TexelSize_id137;
    float2 Texture8TexelSize_id139;
    float2 Texture9TexelSize_id141;
};
Texture2D Texture0_id122;
Texture2D Texture1_id124;
Texture2D Texture2_id126;
Texture2D Texture3_id128;
Texture2D Texture4_id130;
Texture2D Texture5_id132;
Texture2D Texture6_id134;
Texture2D Texture7_id136;
Texture2D Texture8_id138;
Texture2D Texture9_id140;
TextureCube TextureCube0_id142;
TextureCube TextureCube1_id143;
TextureCube TextureCube2_id144;
TextureCube TextureCube3_id145;
Texture3D Texture3D0_id146;
Texture3D Texture3D1_id147;
Texture3D Texture3D2_id148;
Texture3D Texture3D3_id149;
SamplerState Sampler_id150;
SamplerState PointSampler_id151 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id152 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id153 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id154 
{
...
SamplerState AnisotropicSampler_id155 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id156 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id157 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id158 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id159 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id160;
SamplerState Sampler1_id161;
SamplerState Sampler2_id162;
SamplerState Sampler3_id163;
SamplerState Sampler4_id164;
SamplerState Sampler5_id165;
SamplerState Sampler6_id166;
SamplerState Sampler7_id167;
SamplerState Sampler8_id168;
SamplerState Sampler9_id169;
Texture2D DynamicTexture_id91;
SamplerState DynamicSampler_id92;
Texture2D EnvironmentLightingDFG_LUT_id180;
