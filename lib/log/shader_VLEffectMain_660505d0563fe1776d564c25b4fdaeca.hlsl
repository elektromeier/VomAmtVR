...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_0>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_1> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_1>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_2> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_2>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matAmbientOcclusion,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_3> [{Value = InputFloat<ShaderFX.InputValueFloat.i2,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_3>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matAmbientOcclusionDirectLightingFactor,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<0>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavity,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavityDiffuse,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceSetStreamFromComputeColor<matCavitySpecular,r> [{computeColorSource = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid]}]}, {Value = ConstantFloat<1>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@C    InputValue_id240 => ShaderFX.InputValueFloat.i2
...
@R    EnvironmentLightingDFG_LUT_id276 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id276 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id276 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
//
#line 1696 "C:\Users\elektromeier\Desktop\projects\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_660505d0563fe1776d564c25b4fdaeca.hlsl"
...
@G    Pixel => 3dbdd4c442e0cf0dbf1c301e5e766887
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id240;            // Offset:   24 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id276    texture  float4          2d             t0      1 
...
//
#line 1763 "C:\Users\elektromeier\Desktop\projects\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_660505d0563fe1776d564c25b4fdaeca.hlsl"
...
#line 509
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t1.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id69 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id69 return value>
...
#line 509
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id69 return value>

#line 614
  mad r5.w, r6.z, r8.w, r5.w

#line 509
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id69 return value>
...
#line 509
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t1.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id69 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id69 return value>
...
#line 509
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id69 return value>
...
#line 584
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id203 return value>.x; r8.y <- <FresnelSchlick_id203 return value>.y; r8.z <- <FresnelSchlick_id203 return value>.z
...
#line 580
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 1257
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id633 return value>.x; r7.y <- <ComputeDirectLightContribution_id633 return value>.y; r7.z <- <ComputeDirectLightContribution_id633 return value>.z
...
#line 584
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r13.xyzx, r4.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id203 return value>.x; r13.y <- <FresnelSchlick_id203 return value>.y; r13.z <- <FresnelSchlick_id203 return value>.z
...
#line 580
  ...
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id219 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 580
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id219 return value>
...
#line 740
  mul r3.w, r3.w, r6.z
  mul r4.w, r10.z, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id221 return value>
...
#line 1157
mul r0.xyz, cb1[1].zzzz, cb2[88].xyzx  // r0.x <- lightColor.x; r0.y <- lightColor.y; r0.z <- lightColor.z
...
#line 884
sample_l_indexable(texture2d)(float,float,float,float) r2.xy, r6.xyxx, t0.xyzw, s0, l(0.000000)  // r2.x <- environmentLightingDFG.x; r2.y <- environmentLightingDFG.y

#line 885
mad r2.xyz, r4.xyzx, r2.xxxx, r2.yyyy  // r2.x <- <Compute_id455 return value>.x; r2.y <- <Compute_id455 return value>.y; r2.z <- <Compute_id455 return value>.z

#line 1147
mul r4.xyz, r0.xyzx, r2.xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id634 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id634 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id634 return value>.z
...
mul r4.xyz, r4.xyzx, cb1[1].zzzz  // r4.x <- streams.envLightDiffuseColor_id47.x; r4.y <- streams.envLightDiffuseColor_id47.y; r4.z <- streams.envLightDiffuseColor_id47.z
...
#line 870
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t6.xyzw, s0, r1.w  // r6.x <- <Compute_id332 return value>.x; r6.y <- <Compute_id332 return value>.y; r6.z <- <Compute_id332 return value>.z

#line 1142
mul r6.xyz, r6.xyzx, cb2[102].xxxx
mul r6.xyz, r6.xyzx, cb1[1].zzzz  // r6.x <- streams.envLightSpecularColor_id48.x; r6.y <- streams.envLightSpecularColor_id48.y; r6.z <- streams.envLightSpecularColor_id48.z
...
mul r1.xyz, r1.xyzx, cb1[1].zzzz  // r1.x <- streams.envLightDiffuseColor_id47.x; r1.y <- streams.envLightDiffuseColor_id47.y; r1.z <- streams.envLightDiffuseColor_id47.z
...
#line 855
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t7.xyzw, s0, r0.w  // r3.x <- <Compute_id352 return value>.x; r3.y <- <Compute_id352 return value>.y; r3.z <- <Compute_id352 return value>.z

#line 1130
mul r3.xyz, r3.xyzx, cb2[116].xxxx
mul r3.xyz, r3.xyzx, cb1[1].zzzz  // r3.x <- streams.envLightSpecularColor_id48.x; r3.y <- streams.envLightSpecularColor_id48.y; r3.z <- streams.envLightSpecularColor_id48.z
...
const static float Value_id248 = 0;
const static float Value_id254 = 1;
const static bool TIsEnergyConservative_id273 = false;
static const float PI_id275 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id276;
...
{
    streams.Input_3_id239 = Compute_id407();
}
...
float3 Compute_id455(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id276.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
{
    Compute_id448();
    return Compute_id449();
}
float Compute_id443()
{
    Compute_id439();
    return Compute_id440();
}
float Compute_id434()
{
    Compute_id430();
...
float3 ComputeEnvironmentLightContribution_id634(inout PS_STREAMS streams)
{
    ...
    return Compute_id455(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id275 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
float4 Compute_id454()
{
    float x = Compute_id452();
    return float4(x, x, x, x);
}
float4 Compute_id445()
{
    float x = Compute_id443();
    return float4(x, x, x, x);
}
float4 Compute_id436()
{
    float x = Compute_id434();
    return float4(x, x, x, x);
}
float4 Compute_id427()
{
    float x = Compute_id425();
    return float4(x, x, x, x);
}
...
void Compute_id690(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id275 + environmentLightingContribution;
...
{
    streams.matCavitySpecular_id61 = Compute_id454().r;
}
void Compute_id669(inout PS_STREAMS streams)
{
    streams.matCavityDiffuse_id60 = Compute_id445().r;
}
void Compute_id664(inout PS_STREAMS streams)
{
    streams.matCavity_id59 = Compute_id436().r;
}
void Compute_id659(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusionDirectLightingFactor_id58 = Compute_id427().r;
}
void Compute_id654(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusion_id57 = Compute_id418(streams).r;
}
...
void Compute_id52(inout PS_STREAMS streams)
{
    ...
    {
        Compute_id664(streams);
    }

    {
        Compute_id669(streams);
    }
