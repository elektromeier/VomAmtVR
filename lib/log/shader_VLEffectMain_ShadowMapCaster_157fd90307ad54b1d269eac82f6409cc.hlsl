...
//
#line 177 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_157fd90307ad54b1d269eac82f6409cc.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id198;
    float2 Texture1TexelSize_id200;
    float2 Texture2TexelSize_id202;
    float2 Texture3TexelSize_id204;
    float2 Texture4TexelSize_id206;
    float2 Texture5TexelSize_id208;
    float2 Texture6TexelSize_id210;
    float2 Texture7TexelSize_id212;
    float2 Texture8TexelSize_id214;
    float2 Texture9TexelSize_id216;
};
Texture2D Texture0_id197;
Texture2D Texture1_id199;
Texture2D Texture2_id201;
Texture2D Texture3_id203;
Texture2D Texture4_id205;
Texture2D Texture5_id207;
Texture2D Texture6_id209;
Texture2D Texture7_id211;
Texture2D Texture8_id213;
Texture2D Texture9_id215;
TextureCube TextureCube0_id217;
TextureCube TextureCube1_id218;
TextureCube TextureCube2_id219;
TextureCube TextureCube3_id220;
Texture3D Texture3D0_id221;
Texture3D Texture3D1_id222;
Texture3D Texture3D2_id223;
Texture3D Texture3D3_id224;
SamplerState Sampler_id225;
SamplerState PointSampler_id226 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id227 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id228 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id229 
{
...
SamplerState AnisotropicSampler_id230 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id231 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id232 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id233 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id234 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id235;
SamplerState Sampler1_id236;
SamplerState Sampler2_id237;
SamplerState Sampler3_id238;
SamplerState Sampler4_id239;
SamplerState Sampler5_id240;
SamplerState Sampler6_id241;
SamplerState Sampler7_id242;
SamplerState Sampler8_id243;
SamplerState Sampler9_id244;
