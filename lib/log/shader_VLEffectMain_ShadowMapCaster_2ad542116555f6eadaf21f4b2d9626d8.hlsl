...
//
#line 173 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_2ad542116555f6eadaf21f4b2d9626d8.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float4 InputValue_id115;
    float2 InputValue_id125;
    float2 InputValue_id133;
    float2 InputValue_id140;
    float InputValue_id161;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id174;
    float2 Texture1TexelSize_id176;
    float2 Texture2TexelSize_id178;
    float2 Texture3TexelSize_id180;
    float2 Texture4TexelSize_id182;
    float2 Texture5TexelSize_id184;
    float2 Texture6TexelSize_id186;
    float2 Texture7TexelSize_id188;
    float2 Texture8TexelSize_id190;
    float2 Texture9TexelSize_id192;
};
Texture2D Texture0_id173;
Texture2D Texture1_id175;
Texture2D Texture2_id177;
Texture2D Texture3_id179;
Texture2D Texture4_id181;
Texture2D Texture5_id183;
Texture2D Texture6_id185;
Texture2D Texture7_id187;
Texture2D Texture8_id189;
Texture2D Texture9_id191;
TextureCube TextureCube0_id193;
TextureCube TextureCube1_id194;
TextureCube TextureCube2_id195;
TextureCube TextureCube3_id196;
Texture3D Texture3D0_id197;
Texture3D Texture3D1_id198;
Texture3D Texture3D2_id199;
Texture3D Texture3D3_id200;
SamplerState Sampler_id201;
SamplerState PointSampler_id202 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id203 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id204 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id205 
{
...
SamplerState AnisotropicSampler_id206 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id207 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id208 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id209 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id210 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id211;
SamplerState Sampler1_id212;
SamplerState Sampler2_id213;
SamplerState Sampler3_id214;
SamplerState Sampler4_id215;
SamplerState Sampler5_id216;
SamplerState Sampler6_id217;
SamplerState Sampler7_id218;
SamplerState Sampler8_id219;
SamplerState Sampler9_id220;
Texture2D DynamicTexture_id105;
SamplerState DynamicSampler_id106;
Texture2D DynamicTexture_id147;
SamplerState DynamicSampler_id148;
