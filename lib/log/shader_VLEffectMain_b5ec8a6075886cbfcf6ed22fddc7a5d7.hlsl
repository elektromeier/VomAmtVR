...
//
#line 1687 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b5ec8a6075886cbfcf6ed22fddc7a5d7.hlsl"
...
@G    Pixel => ebd613ca11dc5d6282f741f2e6114453
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1755 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b5ec8a6075886cbfcf6ed22fddc7a5d7.hlsl"
...
#line 597
  add r13.xyz, -r0.xyzx, cb0[r2.x + 61].xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z
...
#line 333
  mul r2.z, r2.z, cb0[r2.x + 63].z  // r2.z <- factor
...
#line 459
  dp3 r3.w, -cb0[r2.x + 62].xyzx, r13.xyzx  // r3.w <- cd

#line 460
  mad_sat r3.w, r3.w, cb0[r2.x + 63].x, cb0[r2.x + 63].y  // r3.w <- attenuation
...
#line 1199
  mul r14.xyz, r2.zzzz, cb0[r2.x + 64].xyzx
  mul r14.xyz, r3.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id44.x; r14.y <- streams.lightColorNdotL_id44.y; r14.z <- streams.lightColorNdotL_id44.z
