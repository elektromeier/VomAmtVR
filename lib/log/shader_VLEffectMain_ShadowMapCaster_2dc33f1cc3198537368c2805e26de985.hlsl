...
*****     Stages      *****
***************************
@G    Vertex => 3c56f23b461b2a938841409f780bd523
//
...
//
#line 166 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_2dc33f1cc3198537368c2805e26de985.hlsl"
...
#line 197
mad r0.xyz, r1.xyzx, v2.zzzz, r0.xyzx  // r0.x <- streams.meshNormalWS_id16.x; r0.y <- streams.meshNormalWS_id16.y; r0.z <- streams.meshNormalWS_id16.z
...
cbuffer PerMaterial 
{
    float4 InputValue_id85;
    float2 InputValue_id93;
    float2 InputValue_id101;
    float2 InputValue_id108;
    float InputValue_id129;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id142;
    float2 Texture1TexelSize_id144;
    float2 Texture2TexelSize_id146;
    float2 Texture3TexelSize_id148;
    float2 Texture4TexelSize_id150;
    float2 Texture5TexelSize_id152;
    float2 Texture6TexelSize_id154;
    float2 Texture7TexelSize_id156;
    float2 Texture8TexelSize_id158;
    float2 Texture9TexelSize_id160;
};
Texture2D Texture0_id141;
Texture2D Texture1_id143;
Texture2D Texture2_id145;
Texture2D Texture3_id147;
Texture2D Texture4_id149;
Texture2D Texture5_id151;
Texture2D Texture6_id153;
Texture2D Texture7_id155;
Texture2D Texture8_id157;
Texture2D Texture9_id159;
TextureCube TextureCube0_id161;
TextureCube TextureCube1_id162;
TextureCube TextureCube2_id163;
TextureCube TextureCube3_id164;
Texture3D Texture3D0_id165;
Texture3D Texture3D1_id166;
Texture3D Texture3D2_id167;
Texture3D Texture3D3_id168;
SamplerState Sampler_id169;
SamplerState PointSampler_id170 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id171 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id172 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id173 
{
...
SamplerState AnisotropicSampler_id174 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id175 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id176 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id177 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id178 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id179;
SamplerState Sampler1_id180;
SamplerState Sampler2_id181;
SamplerState Sampler3_id182;
SamplerState Sampler4_id183;
SamplerState Sampler5_id184;
SamplerState Sampler6_id185;
SamplerState Sampler7_id186;
SamplerState Sampler8_id187;
SamplerState Sampler9_id188;
StructuredBuffer<InstanceTransform> InstanceWorld_id39;
StructuredBuffer<InstanceTransform> InstanceWorldInverse_id40;
Texture2D DynamicTexture_id115;
SamplerState DynamicSampler_id116;
