...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin BlendMixer_TextureFX [{BlendResult = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat4<TextureValue_3> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx1,PerUpdate,ObjectSampler_fx2,PerUpdate> [{TexCd = GetSemanticFloat2<SemanticValue_4,TEXCOORD0>}]}], ComputeVoid, ComputeVoid, mixin AssignVarFloat4<TextureValue_7> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx5,PerUpdate,ObjectSampler_fx6,PerUpdate> [{TexCd = GetSemanticFloat2<SemanticValue_4,TEXCOORD0>}]}], mixin AssignVarFloat4<BlendAverage_8> [{Value = mixin ColorToFloat4 [{Value = mixin ComputeColorAverage [{color1 = mixin Float4ToColor [{Value = GetVarFloat4<TextureValue_3>}]}, {color2 = mixin Float4ToColor [{Value = GetVarFloat4<TextureValue_7>}]}]}]}]]}]}, {Value = GetVarFloat4<BlendAverage_8>}]}, {Fader = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_0>}]}]
@P Fader: mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_0>}]
...
@S    ComputeColorAverage => e07f55537394401a421bebc4bf467ec2
...
//
#line 328 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_TextureFXEffect_e473a64b226ce05822f789a42263cd5d.hlsl"
...
//
#line 195 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_TextureFXEffect_e473a64b226ce05822f789a42263cd5d.hlsl"
...
{
    streams.Default_0_id110 = Compute_id67();
}
...
{
    return streams.Default_0_id110;
}
