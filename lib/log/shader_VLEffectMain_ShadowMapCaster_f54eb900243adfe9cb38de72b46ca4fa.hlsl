...
//
#line 167 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_f54eb900243adfe9cb38de72b46ca4fa.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id118;
    float2 InputValue_id139;
    float2 InputValue_id147;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id179;
    float2 Texture1TexelSize_id181;
    float2 Texture2TexelSize_id183;
    float2 Texture3TexelSize_id185;
    float2 Texture4TexelSize_id187;
    float2 Texture5TexelSize_id189;
    float2 Texture6TexelSize_id191;
    float2 Texture7TexelSize_id193;
    float2 Texture8TexelSize_id195;
    float2 Texture9TexelSize_id197;
};
Texture2D Texture0_id178;
Texture2D Texture1_id180;
Texture2D Texture2_id182;
Texture2D Texture3_id184;
Texture2D Texture4_id186;
Texture2D Texture5_id188;
Texture2D Texture6_id190;
Texture2D Texture7_id192;
Texture2D Texture8_id194;
Texture2D Texture9_id196;
TextureCube TextureCube0_id198;
TextureCube TextureCube1_id199;
TextureCube TextureCube2_id200;
TextureCube TextureCube3_id201;
Texture3D Texture3D0_id202;
Texture3D Texture3D1_id203;
Texture3D Texture3D2_id204;
Texture3D Texture3D3_id205;
SamplerState Sampler_id206;
SamplerState PointSampler_id207 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id208 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id209 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id210 
{
...
SamplerState AnisotropicSampler_id211 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id212 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id213 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id214 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id215 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id216;
SamplerState Sampler1_id217;
SamplerState Sampler2_id218;
SamplerState Sampler3_id219;
SamplerState Sampler4_id220;
SamplerState Sampler5_id221;
SamplerState Sampler6_id222;
SamplerState Sampler7_id223;
SamplerState Sampler8_id224;
SamplerState Sampler9_id225;
...
Texture2D DynamicTexture_id161;
SamplerState DynamicSampler_id162;
