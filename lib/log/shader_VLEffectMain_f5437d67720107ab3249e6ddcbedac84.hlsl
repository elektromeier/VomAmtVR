...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_2> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerMaterial>}], mixin AssignVarFloat2<Multiply_3> [{Value = mixin MultiplyFloat2 [{Left = GetSemanticFloat2<SemanticValue_4,TEXCOORD0>}, {Right = GetVarFloat2<Input_2>}]}], mixin AssignVarFloat4<TextureValue_5> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx0,PerMaterial,ObjectSampler_fx1,PerMaterial> [{TexCd = GetVarFloat2<Multiply_3>}]}]]}]}, {Value = GetVarFloat4<TextureValue_5>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_6> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_6>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_7> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_7>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@R    DynamicTexture_id220 => ObjectTexture_fx0 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id220 => ObjectTexture_fx0 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id221 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id221 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id221 => ObjectSampler_fx1 [Stage: Pixel, Slot: (2-2)]
@R    DynamicTexture_id220 => ObjectTexture_fx0 [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id251 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1593 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_f5437d67720107ab3249e6ddcbedac84.hlsl"
...
@G    Pixel => a44adf654e4e5c1554367045ae274552
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id230;            // Offset:    8 Size:     4
//   float InputValue_id239;            // Offset:   12 Size:     4
//
// }
//
// cbuffer PerView
...
// DynamicSampler_id221              sampler      NA          NA             s2      1 
// DynamicTexture_id220              texture  float4          2d             t0      1 
// EnvironmentLightingDFG_LUT_id251    texture  float4          2d             t1      1 
...
//
#line 1661 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_f5437d67720107ab3249e6ddcbedac84.hlsl"
...
#line 550
mul r4.xy, v4.xyxx, cb1[0].xyxx  // r4.x <- <Compute_id358 return value>.x; r4.y <- <Compute_id358 return value>.y

#line 546
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t0.xyzw, s2  // r4.x <- <Compute_id362 return value>.x; r4.y <- <Compute_id362 return value>.y; r4.z <- <Compute_id362 return value>.z; r4.w <- <Compute_id362 return value>.w

#line 1512
add r0.w, -cb1[0].z, l(1.000000)  // r0.w <- glossiness

#line 1504
add r5.xyz, r4.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r5.xyz, cb1[0].wwww, r5.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r5.x <- streams.matSpecular_id55.x; r5.y <- streams.matSpecular_id55.y; r5.z <- streams.matSpecular_id55.z

#line 1505
mad r4.xyz, cb1[0].wwww, -r4.xyzx, r4.xyzx  // r4.x <- streams.matDiffuse_id53.x; r4.y <- streams.matDiffuse_id53.y; r4.z <- streams.matDiffuse_id53.z
...
#line 1219
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id582 return value>.x; r7.y <- <ComputeDirectLightContribution_id582 return value>.y; r7.z <- <ComputeDirectLightContribution_id582 return value>.z
...
#line 872
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id404 return value>.x; r0.z <- <Compute_id404 return value>.y; r0.w <- <Compute_id404 return value>.z

#line 1109
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id583 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id583 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id583 return value>.z
...
#line 857
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t7.xyzw, s0, r1.w  // r6.x <- <Compute_id312 return value>.x; r6.y <- <Compute_id312 return value>.y; r6.z <- <Compute_id312 return value>.z
...
#line 842
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r5.xyzx, t8.xyzw, s0, r0.x  // r3.x <- <Compute_id332 return value>.x; r3.y <- <Compute_id332 return value>.y; r3.z <- <Compute_id332 return value>.z
...
struct PS_STREAMS 
{
    ...
    float2 Multiply_3_id214;
    float4 TextureValue_5_id219;
    float Input_6_id229;
    float Input_7_id238;
...
Texture2D DynamicTexture_id220;
SamplerState DynamicSampler_id221;
...
{
    return streams.Multiply_3_id214;
}
...
{
    return DynamicTexture_id220.Sample(DynamicSampler_id221, Compute_id359(streams));
}
...
{
    streams.Input_7_id238 = Compute_id392();
}
void Compute_id383(inout PS_STREAMS streams)
{
    streams.Input_6_id229 = Compute_id380();
}
void Compute_id371(inout PS_STREAMS streams)
{
    streams.TextureValue_5_id219 = Compute_id362(streams);
}
void Compute_id369(inout PS_STREAMS streams)
{
    streams.Multiply_3_id214 = Compute_id358(streams);
}
...
{
    return streams.TextureValue_5_id219;
}
...
float3 Compute_id404(float3 specularColor, float alphaR, float nDotV)
{
...
float Compute_id496(inout PS_STREAMS streams)
{
...
float3 Compute_id436(inout PS_STREAMS streams, float3 f0)
{
...
void AfterLightingAndShading_id534()
{
}
...
float3 ComputeEnvironmentLightContribution_id583(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id404(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
float3 ComputeDirectLightContribution_id582(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id436(streams, specularColor);
    float geometricShadowing = Compute_id466(streams);
    float normalDistribution = Compute_id496(streams);
...
void PrepareForLightingAndShading_id531()
{
}
...
void Compute_id614(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id531();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id582(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id583(streams);
        }
    }
...
{
    float metalness = Compute_id403(streams).r;
...
{
    float glossiness = Compute_id391(streams).r;
...
{
    float4 colorBase = Compute_id379(streams);
