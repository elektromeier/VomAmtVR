...
//
#line 172 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_29ed9c7a30d71bb7e89b2459b16c2c63.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id137;
    float2 Texture1TexelSize_id139;
    float2 Texture2TexelSize_id141;
    float2 Texture3TexelSize_id143;
    float2 Texture4TexelSize_id145;
    float2 Texture5TexelSize_id147;
    float2 Texture6TexelSize_id149;
    float2 Texture7TexelSize_id151;
    float2 Texture8TexelSize_id153;
    float2 Texture9TexelSize_id155;
};
Texture2D Texture0_id136;
Texture2D Texture1_id138;
Texture2D Texture2_id140;
Texture2D Texture3_id142;
Texture2D Texture4_id144;
Texture2D Texture5_id146;
Texture2D Texture6_id148;
Texture2D Texture7_id150;
Texture2D Texture8_id152;
Texture2D Texture9_id154;
TextureCube TextureCube0_id156;
TextureCube TextureCube1_id157;
TextureCube TextureCube2_id158;
TextureCube TextureCube3_id159;
Texture3D Texture3D0_id160;
Texture3D Texture3D1_id161;
Texture3D Texture3D2_id162;
Texture3D Texture3D3_id163;
SamplerState Sampler_id164;
SamplerState PointSampler_id165 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id166 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id167 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id168 
{
...
SamplerState AnisotropicSampler_id169 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id170 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id171 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id172 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id173 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id174;
SamplerState Sampler1_id175;
SamplerState Sampler2_id176;
SamplerState Sampler3_id177;
SamplerState Sampler4_id178;
SamplerState Sampler5_id179;
SamplerState Sampler6_id180;
SamplerState Sampler7_id181;
SamplerState Sampler8_id182;
SamplerState Sampler9_id183;
Texture2D DynamicTexture_id105;
SamplerState DynamicSampler_id106;
Texture2D EnvironmentLightingDFG_LUT_id194;
