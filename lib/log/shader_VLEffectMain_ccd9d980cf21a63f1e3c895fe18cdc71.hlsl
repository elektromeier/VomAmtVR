...
@C    constantFloat_id202 => Material.MetalnessValue
...
@R    EnvironmentLightingDFG_LUT_id209 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id209 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id209 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
//
#line 1035 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ccd9d980cf21a63f1e3c895fe18cdc71.hlsl"
...
//   float constantFloat_id202;         // Offset:   20 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id209    texture  float4          2d             t0      1 
...
//
#line 1101 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ccd9d980cf21a63f1e3c895fe18cdc71.hlsl"
...
#line 494
mad r0.yzw, r3.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id299 return value>.x; r0.z <- <Compute_id299 return value>.y; r0.w <- <Compute_id299 return value>.z

#line 644
mul r3.xyz, r0.yzwy, cb2[43].xyzx  // r3.x <- <ComputeEnvironmentLightContribution_id478 return value>.x; r3.y <- <ComputeEnvironmentLightContribution_id478 return value>.y; r3.z <- <ComputeEnvironmentLightContribution_id478 return value>.z
...
float3 Compute_id299(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id209.SampleLevel(LinearSampler_id140, float2(glossiness, nDotV), 0);
...
float Compute_id391(inout PS_STREAMS streams)
{
...
float3 Compute_id331(inout PS_STREAMS streams, float3 f0)
{
...
void AfterLightingAndShading_id448()
{
}
void AfterLightingAndShading_id429()
{
}
...
float3 ComputeEnvironmentLightContribution_id478(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id299(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
float3 ComputeDirectLightContribution_id477(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id331(streams, specularColor);
    float geometricShadowing = Compute_id361(streams);
    float normalDistribution = Compute_id391(streams);
...
void PrepareForLightingAndShading_id445()
{
}
void PrepareForLightingAndShading_id426()
{
}
...
void Compute_id509(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id426();
    }

    {
        PrepareForLightingAndShading_id445();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id477(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id478(streams);
        }
    }
    ...
    {
        AfterLightingAndShading_id429();
    }

    {
        AfterLightingAndShading_id448();
    }
}
void Compute_id493(inout PS_STREAMS streams)
{
    float metalness = Compute_id297().r;
