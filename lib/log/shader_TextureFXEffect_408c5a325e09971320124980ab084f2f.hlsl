...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Levels_TextureFX [{Control = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_0>}]}]
...
//
#line 235 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_TextureFXEffect_408c5a325e09971320124980ab084f2f.hlsl"
...
//
#line 214 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_TextureFXEffect_408c5a325e09971320124980ab084f2f.hlsl"
...
{
    streams.Default_0_id94 = Compute_id35();
}
...
float4 Shading_id28(inout PS_STREAMS streams)
{
    ...
    return lerp(col, Filter_id33(col), Compute_id34(streams));
}
