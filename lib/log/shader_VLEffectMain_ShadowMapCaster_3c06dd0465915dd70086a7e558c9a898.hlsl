...
//
#line 173 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_3c06dd0465915dd70086a7e558c9a898.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id169;
    float2 InputValue_id177;
    float2 InputValue_id184;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
Texture2D DynamicTexture_id191;
SamplerState DynamicSampler_id192;
Texture2D EnvironmentLightingDFG_LUT_id232;
