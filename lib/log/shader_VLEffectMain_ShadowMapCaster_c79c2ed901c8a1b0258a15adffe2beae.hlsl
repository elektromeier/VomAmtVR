...
//
#line 164 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_c79c2ed901c8a1b0258a15adffe2beae.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id106;
    float2 InputValue_id113;
    float InputValue_id132;
    float InputValue_id141;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id152;
    float2 Texture1TexelSize_id154;
    float2 Texture2TexelSize_id156;
    float2 Texture3TexelSize_id158;
    float2 Texture4TexelSize_id160;
    float2 Texture5TexelSize_id162;
    float2 Texture6TexelSize_id164;
    float2 Texture7TexelSize_id166;
    float2 Texture8TexelSize_id168;
    float2 Texture9TexelSize_id170;
};
Texture2D Texture0_id151;
Texture2D Texture1_id153;
Texture2D Texture2_id155;
Texture2D Texture3_id157;
Texture2D Texture4_id159;
Texture2D Texture5_id161;
Texture2D Texture6_id163;
Texture2D Texture7_id165;
Texture2D Texture8_id167;
Texture2D Texture9_id169;
TextureCube TextureCube0_id171;
TextureCube TextureCube1_id172;
TextureCube TextureCube2_id173;
TextureCube TextureCube3_id174;
Texture3D Texture3D0_id175;
Texture3D Texture3D1_id176;
Texture3D Texture3D2_id177;
Texture3D Texture3D3_id178;
SamplerState Sampler_id179;
SamplerState PointSampler_id180 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id181 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id182 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id183 
{
...
SamplerState AnisotropicSampler_id184 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id185 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id186 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id187 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id188 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id189;
SamplerState Sampler1_id190;
SamplerState Sampler2_id191;
SamplerState Sampler3_id192;
SamplerState Sampler4_id193;
SamplerState Sampler5_id194;
SamplerState Sampler6_id195;
SamplerState Sampler7_id196;
SamplerState Sampler8_id197;
SamplerState Sampler9_id198;
...
Texture2D DynamicTexture_id120;
SamplerState DynamicSampler_id121;
Buffer<float> DynamicBuffer_id216;
