...
@C    InputValue_id227 => ShaderFX.InputValueFloat4
...
@R    DynamicBuffer_id214 => ObjectBuffer_fx0 [Stage: None, Slot: (-1--1)]
@R    DynamicBuffer_id263 => ObjectBuffer_fx7 [Stage: None, Slot: (-1--1)]
@R    DynamicBuffer_id263 => ObjectBuffer_fx7 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id277 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id277 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    DynamicBuffer_id263 => ObjectBuffer_fx7 [Stage: Pixel, Slot: (2-2)]
@R    EnvironmentLightingDFG_LUT_id277 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (3-3)]
...
*****     Stages      *****
***************************
@G    Vertex => 6b0fb08e8a722fb013f7a75b0204f488
//
...
//
#line 1682 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_2ed009a2299adc4ddffb59186e33b0e3.hlsl"
...
@G    Pixel => e7cfc9c7afcef18105885266464f35a1
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// {
//
//   float4 InputValue_id227;           // Offset:    0 Size:    16
...
// DynamicBuffer_id263               texture   float         buf             t2      1 
// EnvironmentLightingDFG_LUT_id277    texture  float4          2d             t3      1 
...
//
#line 1826 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_2ed009a2299adc4ddffb59186e33b0e3.hlsl"
...
mul r6.xyz, r4.xyzx, r5.xyzx  // r6.x <- <SRgbToLinear_id686 return value>.x; r6.y <- <SRgbToLinear_id686 return value>.y; r6.z <- <SRgbToLinear_id686 return value>.z

#line 1631
mad r7.xy, cb1[0].xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)  // r7.x <- normal.x; r7.y <- normal.y
...
#line 1615
mad r5.xyz, cb1[1].yyyy, -r6.xyzx, r6.xyzx  // r5.x <- streams.matDiffuse_id55.x; r5.y <- streams.matDiffuse_id55.y; r5.z <- streams.matDiffuse_id55.z

#line 560
ld_indexable(buffer)(float,float,float,float) r1.w, v5.xxxx, t2.yzwx  // r1.w <- <Compute_id437 return value>

#line 1369
mad r7.xy, cb1[0].xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
...
#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r15.xyxx, t4.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id72 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r15.zwzz, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id72 return value>
...
#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id72 return value>

#line 661
  mad r6.w, r8.x, r8.w, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r18.xyxx, t4.xxxx, s1, r8.z  // r8.x <- <SampleTextureAndCompare_id72 return value>

#line 661
  mad r6.w, r13.x, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r16.xyxx, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r10.y, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r16.zwzz, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r20.x, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r17.zwzz, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r9.z, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r18.zwzz, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r12.x, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r19.xyxx, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r8.y, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r19.zwzz, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r9.w, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r14.zwzz, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r20.y, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r13.ywyy, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r10.z, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r21.xyxx, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r13.z, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r21.zwzz, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r12.z, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r12.ywyy, t4.xxxx, s1, r8.z

#line 661
  mad r6.w, r10.w, r8.x, r6.w

#line 548
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.x, r9.xyxx, t4.xxxx, s1, r8.z
...
#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t4.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id72 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r15.zwzz, t4.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id72 return value>
...
#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t4.xxxx, s1, r7.z  // r6.z <- <SampleTextureAndCompare_id72 return value>

#line 661
      mad r5.w, r7.x, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r18.xyxx, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r13.x, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r16.xyxx, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r10.y, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r16.zwzz, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r20.x, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.zwzz, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r9.z, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r18.zwzz, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r12.x, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r19.xyxx, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r7.y, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r19.zwzz, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r9.w, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r14.zwzz, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r20.y, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r13.ywyy, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r10.z, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r21.xyxx, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r13.z, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r21.zwzz, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r12.z, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r12.ywyy, t4.xxxx, s1, r7.z

#line 661
      mad r5.w, r10.w, r6.z, r5.w

#line 548
      sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r9.xyxx, t4.xxxx, s1, r7.z
...
#line 1303
  mul r1.xyz, r1.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r1.x <- <ComputeDirectLightContribution_id628 return value>.x; r1.y <- <ComputeDirectLightContribution_id628 return value>.y; r1.z <- <ComputeDirectLightContribution_id628 return value>.z
...
#line 1050
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t5.xyzw  // r0.x <- streams.lightData_id175.x; r0.y <- streams.lightData_id175.y
...
#line 1034
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r6.zzzz, t6.yzwx  // r5.w <- realLightIndex
...
#line 1037
  ishl r8.w, r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyzw, r8.wwww, t7.xyzw  // r13.x <- pointLight1.x; r13.y <- pointLight1.y; r13.z <- pointLight1.z; r13.w <- pointLight1.w
...
#line 1009
  ishl r3.w, r2.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r3.wwww, t8.xyzw  // r14.x <- spotLight1.x; r14.y <- spotLight1.y; r14.z <- spotLight1.z
...
#line 941
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id450 return value>.x; r0.z <- <Compute_id450 return value>.y; r0.w <- <Compute_id450 return value>.z

#line 1193
mul r1.xyz, r0.yzwy, cb2[88].xyzx  // r1.x <- <ComputeEnvironmentLightContribution_id629 return value>.x; r1.y <- <ComputeEnvironmentLightContribution_id629 return value>.y; r1.z <- <ComputeEnvironmentLightContribution_id629 return value>.z
...
#line 926
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t9.xyzw, s0, r2.w  // r6.x <- <Compute_id328 return value>.x; r6.y <- <Compute_id328 return value>.y; r6.z <- <Compute_id328 return value>.z
...
#line 911
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t10.xyzw, s0, r0.x  // r3.x <- <Compute_id348 return value>.x; r3.y <- <Compute_id348 return value>.y; r3.z <- <Compute_id348 return value>.z
...
const static bool TIsNormalXY1_id233 = true;
const static bool TScaleAndBias_id234 = true;
const static bool TInvert_id243 = true;
const static float4 Value_id257 = float4(1, 1, 1, 1);
const static bool TIsEnergyConservative_id274 = false;
static const float PI_id276 = 3.14159265358979323846;
const static bool TUseAlphaFromEmissive_id286 = false;
struct PS_STREAMS 
{
    ...
    float4 Input_4_id226;
    float Input_5_id236;
    float Input_6_id245;
    float BufferItem_8_id262;
...
Buffer<float> DynamicBuffer_id263;
Texture2D EnvironmentLightingDFG_LUT_id277;
...
uint Compute_id434(inout PS_STREAMS streams)
{
    return streams.InstanceID_id13;
}
float4 SRgbToLinear_id686(float4 sRGBa)
{
...
{
    return DynamicBuffer_id263[Compute_id434(streams)];
}
float Compute_id413()
{
...
{
    streams.BufferItem_8_id262 = Compute_id437(streams);
}
void Compute_id439()
{
}
...
{
    streams.Input_6_id245 = Compute_id413();
}
void Compute_id404(inout PS_STREAMS streams)
{
    streams.Input_5_id236 = Compute_id401();
}
...
float Compute_id444(inout PS_STREAMS streams)
{
    return streams.BufferItem_8_id262;
}
...
float3 Compute_id450(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id277.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
float3 Compute_id482(inout PS_STREAMS streams, float3 f0)
{
...
float Compute_id447(inout PS_STREAMS streams)
{
    Compute_id443(streams);
    return Compute_id444(streams);
}
float4 Compute_id431()
{
    Compute_id427();
    return Compute_id428();
}
...
void AfterLightingAndShading_id599()
{
}
...
float3 ComputeEnvironmentLightContribution_id629(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    return Compute_id450(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
float3 ComputeDirectLightContribution_id628(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id482(streams, specularColor);
    float geometricShadowing = Compute_id512(streams);
    float normalDistribution = Compute_id542(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id276 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareForLightingAndShading_id596()
{
}
...
float4 Compute_id449(inout PS_STREAMS streams)
{
    float x = Compute_id447(streams);
    return float4(x, x, x, x);
}
float4 Compute_id433()
{
    return Compute_id431();
}
float4 Compute_id424(inout PS_STREAMS streams)
{
    float x = Compute_id422(streams);
    return float4(x, x, x, x);
}
...
void Compute_id676(inout PS_STREAMS streams)
{
...
void Compute_id675(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id596();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id628(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id629(streams);
        }
    }
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id276 + environmentLightingContribution;
    ...
    {
        AfterLightingAndShading_id599();
    }
}
void Compute_id659(inout PS_STREAMS streams)
{
    streams.matEmissiveIntensity_id65 = Compute_id449(streams).r;
}
void Compute_id654(inout PS_STREAMS streams)
{
    streams.matEmissive_id64 = Compute_id433().rgba;
}
void Compute_id649(inout PS_STREAMS streams)
{
    float metalness = Compute_id424(streams).r;
...
{
    float glossiness = Compute_id412(streams).r;
...
{
    float4 normal = Compute_id400(streams);
...
void Compute_id634(inout PS_STREAMS streams)
{
