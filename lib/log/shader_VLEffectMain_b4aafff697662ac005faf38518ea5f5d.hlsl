...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_0> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerMaterial>}]]}]}, {Value = GetVarFloat4<Input_0>}]}]}], mixin MaterialSurfaceNormalMap<true,true> [{normalMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_3> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerMaterial>}], mixin AssignVarFloat2<Plus_4> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_5,TEXCOORD0>}, {Right = GetVarFloat2<Input_3>}]}], mixin AssignVarFloat2<Input_6> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i1,PerMaterial>}], mixin AssignVarFloat2<Multiply_7> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_4>}, {Right = GetVarFloat2<Input_6>}]}], mixin AssignVarFloat2<Input_8> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i2,PerMaterial>}], mixin AssignVarFloat2<Plus_9> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_7>}, {Right = GetVarFloat2<Input_8>}]}], mixin AssignVarFloat4<TextureValue_10> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx1,PerMaterial,ObjectSampler_fx2,PerMaterial> [{TexCd = GetVarFloat2<Plus_9>}]}]]}]}, {Value = GetVarFloat4<TextureValue_10>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_11> [{Value = InputFloat<ShaderFX.InputValueFloat,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_11>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_12> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerMaterial>}]]}]}, {Value = GetVarFloat<Input_12>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@C    InputValue_id222 => ShaderFX.InputValueFloat2
@C    InputValue_id230 => ShaderFX.InputValueFloat2.i1
@C    InputValue_id237 => ShaderFX.InputValueFloat2.i2
@C    InputValue_id256 => ShaderFX.InputValueFloat
@C    InputValue_id265 => ShaderFX.InputValueFloat.i1
...
@R    InstanceWorldInverse_id41 => TransformationInstancing.InstanceWorldInverse [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id244 => ObjectTexture_fx1 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id244 => ObjectTexture_fx1 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id245 => ObjectSampler_fx2 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id245 => ObjectSampler_fx2 [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id245 => ObjectSampler_fx2 [Stage: Pixel, Slot: (2-2)]
@R    InstanceWorldInverse_id41 => TransformationInstancing.InstanceWorldInverse [Stage: Pixel, Slot: (0-0)]
@R    DynamicTexture_id244 => ObjectTexture_fx1 [Stage: Pixel, Slot: (1-1)]
@R    EnvironmentLightingDFG_LUT_id277 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (2-2)]
...
//
//   } Lights_id186[16];                // Offset:  464 Size:   508 [unused]
//   int LightCount_id187;              // Offset:  972 Size:     4 [unused]
//   
...
//
//   } Lights_id189[8];                 // Offset:  976 Size:   508 [unused]
...
//
#line 1692 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b4aafff697662ac005faf38518ea5f5d.hlsl"
...
@G    Pixel => 32b2184485d672fbb0ecdc4713335616
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  480
//
//   } Lights_id186[16];                // Offset:  464 Size:   508
//   int LightCount_id187;              // Offset:  972 Size:     4
//   
//   struct SpotLightData
//   {
//       
...
//       float3 Color;                  // Offset: 1024
//
//   } Lights_id189[8];                 // Offset:  976 Size:   508
//   float4 _padding_PerDraw_Lighting;  // Offset: 1488 Size:    16 [unused]
//
// }
//
...
//   float2 InputValue_id222;           // Offset:   16 Size:     8
//   float2 InputValue_id230;           // Offset:   24 Size:     8
//   float2 InputValue_id237;           // Offset:   32 Size:     8
//   float InputValue_id256;            // Offset:   40 Size:     4
//   float InputValue_id265;            // Offset:   44 Size:     4
//
// }
//
// cbuffer PerView
...
// DynamicSampler_id245              sampler      NA          NA             s2      1 
// InstanceWorldInverse_id41         texture  struct         r/o             t0      1 
// DynamicTexture_id244              texture  float4          2d             t1      1 
// EnvironmentLightingDFG_LUT_id277    texture  float4          2d             t2      1 
...
//
#line 1825 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b4aafff697662ac005faf38518ea5f5d.hlsl"
...
#line 609
add r6.xy, v6.xyxx, cb1[1].xyxx  // r6.x <- <Compute_id374 return value>.x; r6.y <- <Compute_id374 return value>.y

#line 593
mad r6.xy, r6.xyxx, cb1[1].zwzz, cb1[2].xyxx  // r6.x <- <Compute_id390 return value>.x; r6.y <- <Compute_id390 return value>.y

#line 589
sample_indexable(texture2d)(float,float,float,float) r6.xy, r6.xyxx, t1.xyzw, s2  // r6.x <- <Compute_id394 return value>.x; r6.y <- <Compute_id394 return value>.y
...
#line 1632
add r1.w, -cb1[2].z, l(1.000000)  // r1.w <- glossiness

#line 1624
add r7.xyz, cb1[0].xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r7.xyz, cb1[2].wwww, r7.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r7.x <- streams.matSpecular_id57.x; r7.y <- streams.matSpecular_id57.y; r7.z <- streams.matSpecular_id57.z

#line 1625
mad r8.xyz, cb1[2].wwww, -cb1[0].xyzx, cb1[0].xyzx  // r8.x <- streams.matDiffuse_id55.x; r8.y <- streams.matDiffuse_id55.y; r8.z <- streams.matDiffuse_id55.z
...
#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.xyxx, t3.xxxx, s1, r6.z  // r5.w <- <SampleTextureAndCompare_id71 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r15.zwzz, t3.xxxx, s1, r6.z  // r6.w <- <SampleTextureAndCompare_id71 return value>
...
#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r17.xyxx, t3.xxxx, s1, r6.z  // r6.w <- <SampleTextureAndCompare_id71 return value>

#line 698
  mad r5.w, r6.x, r6.w, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r18.xyxx, t3.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id71 return value>

#line 698
  mad r5.w, r13.x, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r16.xyxx, t3.xxxx, s1, r6.z

#line 698
  mad r5.w, r10.y, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r16.zwzz, t3.xxxx, s1, r6.z

#line 698
  mad r5.w, r20.x, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r17.zwzz, t3.xxxx, s1, r6.z

#line 698
  mad r5.w, r9.z, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r18.zwzz, t3.xxxx, s1, r6.z

#line 698
  mad r5.w, r12.x, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r19.xyxx, t3.xxxx, s1, r6.z
...
#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r14.zwzz, t3.xxxx, s1, r6.z

#line 698
  mad r5.w, r20.y, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r13.ywyy, t3.xxxx, s1, r6.z
...
#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r12.ywyy, t3.xxxx, s1, r6.z

#line 698
  mad r5.w, r10.w, r6.x, r5.w

#line 569
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r9.xyxx, t3.xxxx, s1, r6.z
...
#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r15.xyxx, t3.xxxx, s1, r3.z  // r2.w <- <SampleTextureAndCompare_id71 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.zwzz, t3.xxxx, s1, r3.z  // r3.w <- <SampleTextureAndCompare_id71 return value>
...
#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r17.xyxx, t3.xxxx, s1, r3.z  // r3.w <- <SampleTextureAndCompare_id71 return value>

#line 698
      mad r2.w, r3.x, r3.w, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r18.xyxx, t3.xxxx, s1, r3.z  // r3.x <- <SampleTextureAndCompare_id71 return value>

#line 698
      mad r2.w, r13.x, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r16.xyxx, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r10.y, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r16.zwzz, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r20.x, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r17.zwzz, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r9.z, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r18.zwzz, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r12.x, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r19.xyxx, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r3.y, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r19.zwzz, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r9.w, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r14.zwzz, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r20.y, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r13.ywyy, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r10.z, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r21.xyxx, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r13.z, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r21.zwzz, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r12.z, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r12.ywyy, t3.xxxx, s1, r3.z

#line 698
      mad r2.w, r10.w, r3.x, r2.w

#line 569
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.x, r9.xyxx, t3.xxxx, s1, r3.z
...
#line 1334
  mul r3.xyz, r3.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r3.x <- <ComputeDirectLightContribution_id622 return value>.x; r3.y <- <ComputeDirectLightContribution_id622 return value>.y; r3.z <- <ComputeDirectLightContribution_id622 return value>.z
...
#line 1091
mov r4.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r4.xyzw, t4.xyzw  // r0.x <- streams.lightData_id175.x; r0.y <- streams.lightData_id175.y
...
#line 1075
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r2.zzzz, t5.yzwx  // r5.w <- realLightIndex
...
#line 1078
  ishl r6.w, r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyzw, r6.wwww, t6.xyzw  // r13.x <- pointLight1.x; r13.y <- pointLight1.y; r13.z <- pointLight1.z; r13.w <- pointLight1.w

#line 1079
  bfi r5.w, l(31), l(1), r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r5.wwww, t6.xyzw  // r14.x <- pointLight2.x; r14.y <- pointLight2.y; r14.z <- pointLight2.z
...
#line 621
  add r13.xyz, -r0.xyzx, cb0[r2.z + 61].xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z
...
#line 353
  mul r2.w, r2.w, cb0[r2.z + 63].z  // r2.w <- factor
...
#line 479
  dp3 r3.w, -cb0[r2.z + 62].xyzx, r13.xyzx  // r3.w <- cd

#line 480
  mad_sat r3.w, r3.w, cb0[r2.z + 63].x, cb0[r2.z + 63].y  // r3.w <- attenuation
...
#line 1243
  mul r14.xyz, r2.wwww, cb0[r2.z + 64].xyzx
  mul r14.xyz, r3.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id46.x; r14.y <- streams.lightColorNdotL_id46.y; r14.z <- streams.lightColorNdotL_id46.z
...
#line 981
sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r2.xyxx, t2.zxyw, s0, l(0.000000)  // r0.y <- environmentLightingDFG.x; r0.z <- environmentLightingDFG.y

#line 982
mad r0.yzw, r7.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id444 return value>.x; r0.z <- <Compute_id444 return value>.y; r0.w <- <Compute_id444 return value>.z
...
#line 967
sample_l_indexable(texturecube)(float,float,float,float) r5.xyz, r5.xyzx, t8.xyzw, s0, r1.w  // r5.x <- <Compute_id316 return value>.x; r5.y <- <Compute_id316 return value>.y; r5.z <- <Compute_id316 return value>.z
...
#line 952
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r3.xyzx, t9.xyzw, s0, r0.x  // r3.x <- <Compute_id336 return value>.x; r3.y <- <Compute_id336 return value>.y; r3.z <- <Compute_id336 return value>.z
...
const static int TMaxLightCount_id185 = 16;
...
const static bool TInvert_id262 = true;
...
struct PS_STREAMS 
{
    ...
    float2 Input_3_id221;
    float2 Plus_4_id224;
    float2 Input_6_id229;
    float2 Multiply_7_id232;
    float2 Input_8_id236;
    float2 Plus_9_id239;
    float4 TextureValue_10_id243;
    float Input_11_id255;
    float Input_12_id264;
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id230;
    float2 InputValue_id237;
...
SamplerState DynamicSampler_id245;
...
{
    return streams.Plus_9_id239;
}
float2 Compute_id387(inout PS_STREAMS streams)
{
    return streams.Input_8_id236;
}
float2 Compute_id385(inout PS_STREAMS streams)
{
    return streams.Multiply_7_id232;
}
float2 Compute_id379(inout PS_STREAMS streams)
{
    return streams.Input_6_id229;
}
float2 Compute_id377(inout PS_STREAMS streams)
{
    return streams.Plus_4_id224;
}
float2 Compute_id371(inout PS_STREAMS streams)
{
    return streams.Input_3_id221;
}
...
{
    return DynamicTexture_id244.Sample(DynamicSampler_id245, Compute_id391(streams));
}
float2 Compute_id390(inout PS_STREAMS streams)
{
    return Compute_id385(streams) + Compute_id387(streams);
}
float2 Compute_id383()
{
...
{
    streams.Input_12_id264 = Compute_id432();
}
void Compute_id423(inout PS_STREAMS streams)
{
    streams.Input_11_id255 = Compute_id420();
}
void Compute_id411(inout PS_STREAMS streams)
{
    streams.TextureValue_10_id243 = Compute_id394(streams);
}
void Compute_id409(inout PS_STREAMS streams)
{
    streams.Plus_9_id239 = Compute_id390(streams);
}
void Compute_id407(inout PS_STREAMS streams)
{
    streams.Input_8_id236 = Compute_id383();
}
void Compute_id405(inout PS_STREAMS streams)
{
    streams.Multiply_7_id232 = Compute_id382(streams);
}
void Compute_id403(inout PS_STREAMS streams)
{
    streams.Input_6_id229 = Compute_id375();
}
void Compute_id401(inout PS_STREAMS streams)
{
    streams.Plus_4_id224 = Compute_id374(streams);
}
void Compute_id399(inout PS_STREAMS streams)
{
    streams.Input_3_id221 = Compute_id367();
}
void Compute_id397()
{
}
...
{
    return streams.TextureValue_10_id243;
}
...
float3 ComputeEnvironmentLightContribution_id623(inout PS_STREAMS streams)
{
    ...
    return Compute_id444(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
void Compute_id643(inout PS_STREAMS streams)
{
