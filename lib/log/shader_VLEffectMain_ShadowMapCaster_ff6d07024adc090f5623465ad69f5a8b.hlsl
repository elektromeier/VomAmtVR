...
//
#line 167 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_ff6d07024adc090f5623465ad69f5a8b.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id176;
    float2 Texture1TexelSize_id178;
    float2 Texture2TexelSize_id180;
    float2 Texture3TexelSize_id182;
    float2 Texture4TexelSize_id184;
    float2 Texture5TexelSize_id186;
    float2 Texture6TexelSize_id188;
    float2 Texture7TexelSize_id190;
    float2 Texture8TexelSize_id192;
    float2 Texture9TexelSize_id194;
};
Texture2D Texture0_id175;
Texture2D Texture1_id177;
Texture2D Texture2_id179;
Texture2D Texture3_id181;
Texture2D Texture4_id183;
Texture2D Texture5_id185;
Texture2D Texture6_id187;
Texture2D Texture7_id189;
Texture2D Texture8_id191;
Texture2D Texture9_id193;
TextureCube TextureCube0_id195;
TextureCube TextureCube1_id196;
TextureCube TextureCube2_id197;
TextureCube TextureCube3_id198;
Texture3D Texture3D0_id199;
Texture3D Texture3D1_id200;
Texture3D Texture3D2_id201;
Texture3D Texture3D3_id202;
SamplerState Sampler_id203;
SamplerState PointSampler_id204 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id205 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id206 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id207 
{
...
SamplerState AnisotropicSampler_id208 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id209 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id210 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id211 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id212 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id213;
SamplerState Sampler1_id214;
SamplerState Sampler2_id215;
SamplerState Sampler3_id216;
SamplerState Sampler4_id217;
SamplerState Sampler5_id218;
SamplerState Sampler6_id219;
SamplerState Sampler7_id220;
SamplerState Sampler8_id221;
SamplerState Sampler9_id222;
...
Texture2D DynamicTexture_id158;
SamplerState DynamicSampler_id159;
