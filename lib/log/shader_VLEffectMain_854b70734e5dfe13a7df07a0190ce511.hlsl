...
//
//   } Lights_id182[32];                // Offset:  448 Size:  1020 [unused]
//   int LightCount_id183;              // Offset: 1468 Size:     4 [unused]
//   
//   struct SpotLightData
//   {
//       
//       float3 PositionWS;             // Offset: 1472
//       float3 DirectionWS;            // Offset: 1488
//       float3 AngleOffsetAndInvSquareRadius;// Offset: 1504
//       float3 Color;                  // Offset: 1520
//
//   } Lights_id185[8];                 // Offset: 1472 Size:   508 [unused]
//   float4 _padding_PerDraw_Lighting;  // Offset: 1984 Size:    16 [unused]
//
// }
//
// cbuffer PerView
...
//
#line 1661 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_854b70734e5dfe13a7df07a0190ce511.hlsl"
...
@G    Pixel => bcbdb7b12b5a4f669d979b88b56153d5
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//       float3 Color;                  // Offset:  464
//
//   } Lights_id182[32];                // Offset:  448 Size:  1020
//   int LightCount_id183;              // Offset: 1468 Size:     4
//   
//   struct SpotLightData
//   {
//       
...
//       float3 Color;                  // Offset: 1520
//
//   } Lights_id185[8];                 // Offset: 1472 Size:   508
//   float4 _padding_PerDraw_Lighting;  // Offset: 1984 Size:    16 [unused]
//
// }
//
...
ps_5_0
dcl_globalFlags refactoringAllowed
dcl_constantbuffer CB0[124], dynamicIndexed
...
//
#line 1723 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_854b70734e5dfe13a7df07a0190ce511.hlsl"
...
#line 536
  add r13.xyz, -r0.xyzx, cb0[r2.w + 92].xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z
...
#line 320
  mul r3.w, r3.w, cb0[r2.w + 94].z  // r3.w <- factor
...
#line 418
  dp3 r4.w, -cb0[r2.w + 93].xyzx, r13.xyzx  // r4.w <- cd

#line 419
  mad_sat r4.w, r4.w, cb0[r2.w + 94].x, cb0[r2.w + 94].y  // r4.w <- attenuation
...
#line 1127
  mul r14.xyz, r3.wwww, cb0[r2.w + 95].xyzx
  mul r14.xyz, r4.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id43.x; r14.y <- streams.lightColorNdotL_id43.y; r14.z <- streams.lightColorNdotL_id43.z
...
const static int TMaxLightCount_id181 = 32;
