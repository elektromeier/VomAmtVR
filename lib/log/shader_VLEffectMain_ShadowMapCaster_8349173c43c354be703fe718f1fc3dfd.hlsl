...
//
#line 159 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_8349173c43c354be703fe718f1fc3dfd.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id125;
    float2 Texture1TexelSize_id127;
    float2 Texture2TexelSize_id129;
    float2 Texture3TexelSize_id131;
    float2 Texture4TexelSize_id133;
    float2 Texture5TexelSize_id135;
    float2 Texture6TexelSize_id137;
    float2 Texture7TexelSize_id139;
    float2 Texture8TexelSize_id141;
    float2 Texture9TexelSize_id143;
};
Texture2D Texture0_id124;
Texture2D Texture1_id126;
Texture2D Texture2_id128;
Texture2D Texture3_id130;
Texture2D Texture4_id132;
Texture2D Texture5_id134;
Texture2D Texture6_id136;
Texture2D Texture7_id138;
Texture2D Texture8_id140;
Texture2D Texture9_id142;
TextureCube TextureCube0_id144;
TextureCube TextureCube1_id145;
TextureCube TextureCube2_id146;
TextureCube TextureCube3_id147;
Texture3D Texture3D0_id148;
Texture3D Texture3D1_id149;
Texture3D Texture3D2_id150;
Texture3D Texture3D3_id151;
SamplerState Sampler_id152;
SamplerState PointSampler_id153 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id154 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id155 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id156 
{
...
SamplerState AnisotropicSampler_id157 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id158 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id159 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id160 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id161 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id162;
SamplerState Sampler1_id163;
SamplerState Sampler2_id164;
SamplerState Sampler3_id165;
SamplerState Sampler4_id166;
SamplerState Sampler5_id167;
SamplerState Sampler6_id168;
SamplerState Sampler7_id169;
SamplerState Sampler8_id170;
SamplerState Sampler9_id171;
StructuredBuffer<InstanceTransform> InstanceWorld_id39;
StructuredBuffer<InstanceTransform> InstanceWorldInverse_id40;
Texture2D EnvironmentLightingDFG_LUT_id182;
