...
@C    constantFloat_id250 => Material.MetalnessValue
...
@R    EnvironmentLightingDFG_LUT_id257 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1631 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_c8d35f72903e52dc39af41c3d310e5f5.hlsl"
...
@G    Pixel => 1172fda9918d658195f39d09a755eb5f
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float constantFloat_id250;         // Offset:   24 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id257    texture  float4          2d             t1      1 
...
//
#line 1699 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_c8d35f72903e52dc39af41c3d310e5f5.hlsl"
...
#line 633
  ...
  mul r1.w, r1.w, r1.w
  mul r0.z, r0.z, r1.w
  mad r8.xyz, r8.xyzx, r0.zzzz, r5.xyzx  // r8.x <- <FresnelSchlick_id183 return value>.x; r8.y <- <FresnelSchlick_id183 return value>.y; r8.z <- <FresnelSchlick_id183 return value>.z
...
#line 1258
  mul r7.xyz, r7.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id593 return value>.x; r7.y <- <ComputeDirectLightContribution_id593 return value>.y; r7.z <- <ComputeDirectLightContribution_id593 return value>.z
...
#line 633
  ...
  mul r7.w, r7.w, r7.w
  mul r5.w, r5.w, r7.w
  mad r14.xyz, r14.xyzx, r5.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id183 return value>.x; r14.y <- <FresnelSchlick_id183 return value>.y; r14.z <- <FresnelSchlick_id183 return value>.z
...
#line 629
  ...
  div r7.w, r1.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id199 return value>

#line 801
  mul r5.w, r5.w, r7.w
  mul r6.w, r1.w, r6.w
  div r5.w, r5.w, r6.w  // r5.w <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 629
  ...
  div r2.w, r5.w, r2.w  // r2.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 456
  dp3 r5.w, -cb0[r2.w + 158].xyzx, r12.xyzx  // r5.w <- cd
...
#line 916
mad r0.xyz, r5.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id415 return value>.x; r0.y <- <Compute_id415 return value>.y; r0.z <- <Compute_id415 return value>.z

#line 1148
mul r2.xyz, r0.xyzx, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id594 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id594 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id594 return value>.z
...
#line 901
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t7.xyzw, s0, cb2[97].w  // r6.x <- <Compute_id312 return value>.x; r6.y <- <Compute_id312 return value>.y; r6.z <- <Compute_id312 return value>.z
...
#line 886
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r5.xyzx, t8.xyzw, s0, cb2[111].w  // r3.x <- <Compute_id332 return value>.x; r3.y <- <Compute_id332 return value>.y; r3.z <- <Compute_id332 return value>.z
...
float3 Compute_id415(float3 specularColor, float alphaR, float nDotV)
{
    ...
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id257.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id256 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
float4 Compute_id413()
{
    return float4(constantFloat_id250, constantFloat_id250, constantFloat_id250, constantFloat_id250);
}
float4 Compute_id412()
{
    float x = Compute_id410();
...
void Compute_id625(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id256 + environmentLightingContribution;
...
{
    float metalness = Compute_id413().r;
...
{
    float glossiness = Compute_id412().r;
