...
//
#line 167 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_e8e9cdb647c6b8dea77d05c3d85f0881.hlsl"
...
Texture2D Texture0_id104;
Texture2D Texture1_id106;
Texture2D Texture2_id108;
Texture2D Texture3_id110;
Texture2D Texture4_id112;
Texture2D Texture5_id114;
Texture2D Texture6_id116;
Texture2D Texture7_id118;
Texture2D Texture8_id120;
Texture2D Texture9_id122;
TextureCube TextureCube0_id124;
TextureCube TextureCube1_id125;
TextureCube TextureCube2_id126;
TextureCube TextureCube3_id127;
Texture3D Texture3D0_id128;
Texture3D Texture3D1_id129;
Texture3D Texture3D2_id130;
Texture3D Texture3D3_id131;
SamplerState Sampler_id132;
SamplerState PointSampler_id133 
{
...
SamplerState LinearBorderSampler_id135 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
...
SamplerState AnisotropicSampler_id137 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id138 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id139 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id140 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id141 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id142;
SamplerState Sampler1_id143;
SamplerState Sampler2_id144;
SamplerState Sampler3_id145;
SamplerState Sampler4_id146;
SamplerState Sampler5_id147;
SamplerState Sampler6_id148;
SamplerState Sampler7_id149;
SamplerState Sampler8_id150;
SamplerState Sampler9_id151;
Texture2D EnvironmentLightingDFG_LUT_id162;
