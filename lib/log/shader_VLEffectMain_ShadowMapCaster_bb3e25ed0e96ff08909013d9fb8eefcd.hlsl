...
//
#line 171 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_bb3e25ed0e96ff08909013d9fb8eefcd.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id129;
    float2 Texture1TexelSize_id131;
    float2 Texture2TexelSize_id133;
    float2 Texture3TexelSize_id135;
    float2 Texture4TexelSize_id137;
    float2 Texture5TexelSize_id139;
    float2 Texture6TexelSize_id141;
    float2 Texture7TexelSize_id143;
    float2 Texture8TexelSize_id145;
    float2 Texture9TexelSize_id147;
};
Texture2D Texture0_id128;
Texture2D Texture1_id130;
Texture2D Texture2_id132;
Texture2D Texture3_id134;
Texture2D Texture4_id136;
Texture2D Texture5_id138;
Texture2D Texture6_id140;
Texture2D Texture7_id142;
Texture2D Texture8_id144;
Texture2D Texture9_id146;
TextureCube TextureCube0_id148;
TextureCube TextureCube1_id149;
TextureCube TextureCube2_id150;
TextureCube TextureCube3_id151;
Texture3D Texture3D0_id152;
Texture3D Texture3D1_id153;
Texture3D Texture3D2_id154;
Texture3D Texture3D3_id155;
SamplerState Sampler_id156;
SamplerState PointSampler_id157 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id158 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id159 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id160 
{
...
SamplerState AnisotropicSampler_id161 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id162 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id163 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id164 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id165 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id166;
SamplerState Sampler1_id167;
SamplerState Sampler2_id168;
SamplerState Sampler3_id169;
SamplerState Sampler4_id170;
SamplerState Sampler5_id171;
SamplerState Sampler6_id172;
SamplerState Sampler7_id173;
SamplerState Sampler8_id174;
SamplerState Sampler9_id175;
Texture2D DynamicTexture_id105;
SamplerState DynamicSampler_id106;
Texture2D EnvironmentLightingDFG_LUT_id186;
