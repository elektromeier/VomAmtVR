...
@C    InputValue_id264 => ShaderFX.InputValueFloat.i2
...
@R    DynamicSampler_id235 => ObjectSampler_fx1 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id300 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id300 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    EnvironmentLightingDFG_LUT_id300 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1832 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_9583d80f06243c5f6686c4b8f88a924d.hlsl"
...
@G    Pixel => 9693353a87fb3f6feec38500fdd56195
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float InputValue_id264;            // Offset:   32 Size:     4
//
// }
//
// cbuffer PerView
...
// EnvironmentLightingDFG_LUT_id300    texture  float4          2d             t1      1 
...
//
#line 1900 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_9583d80f06243c5f6686c4b8f88a924d.hlsl"
...
#line 552
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t2.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id69 return value>
...
#line 651
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id203 return value>.x; r8.y <- <FresnelSchlick_id203 return value>.y; r8.z <- <FresnelSchlick_id203 return value>.z
...
#line 647
  ...
  div r5.w, r1.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id219 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id219 return value>

#line 840
  mul r2.x, r2.x, r5.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id221 return value>
...
#line 836
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id233 return value>
...
#line 1393
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id674 return value>.x; r7.y <- <ComputeDirectLightContribution_id674 return value>.y; r7.z <- <ComputeDirectLightContribution_id674 return value>.z
...
#line 647
  ...
  div r12.w, r3.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 651
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r16.xyz, r16.xyzx, r3.wwww, r10.xyzx  // r16.x <- <FresnelSchlick_id203 return value>.x; r16.y <- <FresnelSchlick_id203 return value>.y; r16.z <- <FresnelSchlick_id203 return value>.z
...
#line 647
  ...
  div r6.w, r2.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id219 return value>
  mad r3.w, r11.z, r5.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id219 return value>
...
#line 836
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id233 return value>
...
#line 651
  ...
  mul r6.z, r6.z, r6.z
  mul r3.w, r3.w, r6.z
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id203 return value>.x; r15.y <- <FresnelSchlick_id203 return value>.y; r15.z <- <FresnelSchlick_id203 return value>.z
...
#line 647
  ...
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id219 return value>

#line 840
  mul r3.w, r3.w, r6.w
  mul r5.w, r10.z, r5.w
  div r3.w, r3.w, r5.w  // r3.w <- <VisibilitySmithSchlickGGX_id221 return value>
...
#line 604
  add r13.xyz, -r0.xyzx, cb0[r2.w + 61].xyzx  // r13.x <- lightVector.x; r13.y <- lightVector.y; r13.z <- lightVector.z
...
#line 462
  dp3 r5.w, -cb0[r2.w + 62].xyzx, r13.xyzx  // r5.w <- cd
...
#line 1302
  mul r14.xyz, r3.wwww, cb0[r2.w + 64].xyzx
  mul r14.xyz, r5.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id44.x; r14.y <- streams.lightColorNdotL_id44.y; r14.z <- streams.lightColorNdotL_id44.z
...
#line 1293
mul r0.xyz, cb1[2].xxxx, cb2[88].xyzx  // r0.x <- lightColor.x; r0.y <- lightColor.y; r0.z <- lightColor.z
...
#line 1021
mad r2.xyz, r5.xyzx, r2.xxxx, r2.yyyy  // r2.x <- <Compute_id496 return value>.x; r2.y <- <Compute_id496 return value>.y; r2.z <- <Compute_id496 return value>.z

#line 1283
mul r5.xyz, r0.xyzx, r2.xyzx  // r5.x <- <ComputeEnvironmentLightContribution_id675 return value>.x; r5.y <- <ComputeEnvironmentLightContribution_id675 return value>.y; r5.z <- <ComputeEnvironmentLightContribution_id675 return value>.z
...
mul r5.xyz, r5.xyzx, cb1[2].xxxx  // r5.x <- streams.envLightDiffuseColor_id47.x; r5.y <- streams.envLightDiffuseColor_id47.y; r5.z <- streams.envLightDiffuseColor_id47.z
...
#line 1005
mul r1.w, r0.w, cb2[97].w  // r1.w <- mipLevel

#line 1006
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t7.xyzw, s0, r1.w  // r6.x <- <Compute_id332 return value>.x; r6.y <- <Compute_id332 return value>.y; r6.z <- <Compute_id332 return value>.z

#line 1278
mul r6.xyz, r6.xyzx, cb2[102].xxxx
mul r6.xyz, r6.xyzx, cb1[2].xxxx  // r6.x <- streams.envLightSpecularColor_id48.x; r6.y <- streams.envLightSpecularColor_id48.y; r6.z <- streams.envLightSpecularColor_id48.z
...
mul r1.xyz, r1.xyzx, cb1[2].xxxx  // r1.x <- streams.envLightDiffuseColor_id47.x; r1.y <- streams.envLightDiffuseColor_id47.y; r1.z <- streams.envLightDiffuseColor_id47.z
...
#line 991
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r5.xyzx, t8.xyzw, s0, r0.w  // r3.x <- <Compute_id352 return value>.x; r3.y <- <Compute_id352 return value>.y; r3.z <- <Compute_id352 return value>.z

#line 1266
mul r3.xyz, r3.xyzx, cb2[116].xxxx
mul r3.xyz, r3.xyzx, cb1[2].xxxx  // r3.x <- streams.envLightSpecularColor_id48.x; r3.y <- streams.envLightSpecularColor_id48.y; r3.z <- streams.envLightSpecularColor_id48.z
...
const static float Value_id272 = 0;
const static float Value_id278 = 1;
const static bool TIsEnergyConservative_id297 = false;
static const float PI_id299 = 3.14159265358979323846;
struct PS_STREAMS 
{
...
Texture2D EnvironmentLightingDFG_LUT_id300;
...
{
    streams.Input_12_id263 = Compute_id448();
}
...
float3 Compute_id496(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id300.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
{
    Compute_id489();
    return Compute_id490();
}
float Compute_id484()
{
    Compute_id480();
    return Compute_id481();
}
float Compute_id475()
{
    Compute_id471();
...
void AfterLightingAndShading_id645()
{
}
void AfterLightingAndShading_id626()
{
}
...
float3 ComputeEnvironmentLightContribution_id675(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id496(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id619(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id674(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id528(streams, specularColor);
    float geometricShadowing = Compute_id558(streams);
    float normalDistribution = Compute_id588(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id618(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id299 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id642()
{
}
void PrepareForLightingAndShading_id623()
{
}
...
float4 Compute_id495()
{
    float x = Compute_id493();
    return float4(x, x, x, x);
}
float4 Compute_id486()
{
    float x = Compute_id484();
    return float4(x, x, x, x);
}
float4 Compute_id477()
{
    float x = Compute_id475();
    return float4(x, x, x, x);
}
float4 Compute_id468()
{
    float x = Compute_id466();
    return float4(x, x, x, x);
}
...
void Compute_id731(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id623();
    }

    {
        PrepareForLightingAndShading_id642();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id618(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id674(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id619(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id675(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id299 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id626();
    }

    {
        AfterLightingAndShading_id645();
    }
}
void Compute_id715(inout PS_STREAMS streams)
{
    streams.matCavitySpecular_id61 = Compute_id495().r;
}
void Compute_id710(inout PS_STREAMS streams)
{
    streams.matCavityDiffuse_id60 = Compute_id486().r;
}
void Compute_id705(inout PS_STREAMS streams)
{
    streams.matCavity_id59 = Compute_id477().r;
}
void Compute_id700(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusionDirectLightingFactor_id58 = Compute_id468().r;
}
void Compute_id695(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusion_id57 = Compute_id459(streams).r;
}
...
void Compute_id52(inout PS_STREAMS streams)
{
    ...
    {
        Compute_id715(streams);
    }

    {
        Compute_id731(streams);
    }
}
