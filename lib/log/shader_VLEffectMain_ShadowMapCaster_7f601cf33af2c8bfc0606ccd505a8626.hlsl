...
//
#line 181 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_7f601cf33af2c8bfc0606ccd505a8626.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id149;
    float2 InputValue_id157;
    float2 InputValue_id164;
    float2 InputValue_id185;
    float2 InputValue_id193;
    float2 InputValue_id200;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id225;
    float2 Texture1TexelSize_id227;
    float2 Texture2TexelSize_id229;
    float2 Texture3TexelSize_id231;
    float2 Texture4TexelSize_id233;
    float2 Texture5TexelSize_id235;
    float2 Texture6TexelSize_id237;
    float2 Texture7TexelSize_id239;
    float2 Texture8TexelSize_id241;
    float2 Texture9TexelSize_id243;
};
Texture2D Texture0_id224;
Texture2D Texture1_id226;
Texture2D Texture2_id228;
Texture2D Texture3_id230;
Texture2D Texture4_id232;
Texture2D Texture5_id234;
Texture2D Texture6_id236;
Texture2D Texture7_id238;
Texture2D Texture8_id240;
Texture2D Texture9_id242;
TextureCube TextureCube0_id244;
TextureCube TextureCube1_id245;
TextureCube TextureCube2_id246;
TextureCube TextureCube3_id247;
Texture3D Texture3D0_id248;
Texture3D Texture3D1_id249;
Texture3D Texture3D2_id250;
Texture3D Texture3D3_id251;
SamplerState Sampler_id252;
SamplerState PointSampler_id253 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id254 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id255 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id256 
{
...
SamplerState AnisotropicSampler_id257 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id258 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id259 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id260 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id261 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id262;
SamplerState Sampler1_id263;
SamplerState Sampler2_id264;
SamplerState Sampler3_id265;
SamplerState Sampler4_id266;
SamplerState Sampler5_id267;
SamplerState Sampler6_id268;
SamplerState Sampler7_id269;
SamplerState Sampler8_id270;
SamplerState Sampler9_id271;
...
Texture2D DynamicTexture_id171;
SamplerState DynamicSampler_id172;
Texture2D DynamicTexture_id207;
SamplerState DynamicSampler_id208;
Texture2D EnvironmentLightingDFG_LUT_id282;
