...
@R    EnvironmentLightingDFG_LUT_id243 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (0-0)]
...
//
#line 1497 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ddbc7deb0895b3ccdd3cad73b3ebb958.hlsl"
...
@G    Pixel => 1b61f124a3646f3f93843db15914ef2f
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// EnvironmentLightingDFG_LUT_id243    texture  float4          2d             t0      1 
...
//
#line 1606 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ddbc7deb0895b3ccdd3cad73b3ebb958.hlsl"
...
#line 1161
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id569 return value>.x; r7.y <- <ComputeDirectLightContribution_id569 return value>.y; r7.z <- <ComputeDirectLightContribution_id569 return value>.z
...
#line 814
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id391 return value>.x; r0.z <- <Compute_id391 return value>.y; r0.w <- <Compute_id391 return value>.z

#line 1051
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id570 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id570 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id570 return value>.z
...
{
    streams.Input_2_id230 = Compute_id379();
}
...
float3 Compute_id391(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id243.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
void AfterLightingAndShading_id540()
{
}
...
float3 ComputeEnvironmentLightContribution_id570(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    return Compute_id391(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
float3 ComputeEnvironmentLightContribution_id514(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id569(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id423(streams, specularColor);
    float geometricShadowing = Compute_id453(streams);
...
float3 ComputeDirectLightContribution_id513(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id242 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareForLightingAndShading_id537()
{
}
...
void Compute_id601(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id537();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id513(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id569(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id514(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id570(streams);
        }
    }
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id242 + environmentLightingContribution;
    ...
    {
        AfterLightingAndShading_id540();
    }
}
void Compute_id585(inout PS_STREAMS streams)
{
    float metalness = Compute_id390(streams).r;
...
{
    float glossiness = Compute_id378(streams).r;
