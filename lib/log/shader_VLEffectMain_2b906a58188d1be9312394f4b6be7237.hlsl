...
//
#line 1310 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_2b906a58188d1be9312394f4b6be7237.hlsl"
...
@G    Pixel => e50178260b23d42a3e55a7abaff65b95
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1377 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_2b906a58188d1be9312394f4b6be7237.hlsl"
...
#line 510
  add r6.xyz, -r0.xyzx, cb0[r1.w + 61].xyzx  // r6.x <- lightVector.x; r6.y <- lightVector.y; r6.z <- lightVector.z
...
#line 310
  mul r2.w, r2.w, cb0[r1.w + 63].z  // r2.w <- factor
...
#line 408
  dp3 r3.w, -cb0[r1.w + 62].xyzx, r6.xyzx  // r3.w <- cd

#line 409
  mad_sat r3.w, r3.w, cb0[r1.w + 63].x, cb0[r1.w + 63].y  // r3.w <- attenuation
...
#line 934
  mul r6.xyz, r2.wwww, cb0[r1.w + 64].xyzx
  mul r6.xyz, r3.wwww, r6.xyzx  // r6.x <- streams.lightColorNdotL_id44.x; r6.y <- streams.lightColorNdotL_id44.y; r6.z <- streams.lightColorNdotL_id44.z
