...
//
#line 1029 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b63b7846c22b634322c6e84f5a82e82c.hlsl"
...
@G    Pixel => a2959937771df79bf11fb4610f8057e1
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1095 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_b63b7846c22b634322c6e84f5a82e82c.hlsl"
...
#line 811
mov r0.z, r5.y  // r0.z <- streams.NdotV_id72
...
#line 721
  dp3 r2.w, r6.xyzx, -cb2[r1.w + 26].xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.NdotL_id49

#line 723
  mul r11.xyz, r2.wwww, cb2[r1.w + 27].xyzx  // r11.x <- streams.lightColorNdotL_id44.x; r11.y <- streams.lightColorNdotL_id44.y; r11.z <- streams.lightColorNdotL_id44.z

#line 713
  add r12.xyz, r7.xyzx, -cb2[r1.w + 26].xyzx
  dp3 r3.w, r12.xyzx, r12.xyzx
  rsq r3.w, r3.w
  mul r12.xyz, r3.wwww, r12.xyzx  // r12.x <- streams.H_id75.x; r12.y <- streams.H_id75.y; r12.z <- streams.H_id75.z

#line 715
  dp3_sat r1.w, -cb2[r1.w + 26].xyzx, r12.xyzx  // r1.w <- streams.LdotH_id77
...
#line 342
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r13.xyz, r13.xyzx, r1.wwww, r9.xyzx  // r13.x <- <FresnelSchlick_id143 return value>.x; r13.y <- <FresnelSchlick_id143 return value>.y; r13.z <- <FresnelSchlick_id143 return value>.z

#line 338
  mad r1.w, r2.w, l(0.500000), l(0.500000)
  div r1.w, r2.w, r1.w  // r1.w <- <VisibilityhSchlickGGX_id159 return value>
  mad r3.w, r0.z, l(0.500000), l(0.500000)
  div r3.w, r0.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id159 return value>

#line 426
  mul r1.w, r1.w, r3.w
  mul r2.w, r0.z, r2.w
  div r1.w, r1.w, r2.w  // r1.w <- <VisibilitySmithSchlickGGX_id161 return value>
...
#line 825
  mad r10.xyz, r11.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000), r12.xyzx  // r10.x <- directLightingContribution.x; r10.y <- directLightingContribution.y; r10.z <- directLightingContribution.z
...
#line 691
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id201 return value>
...
#line 541
  ishl r2.w, r1.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyzw, r2.wwww, t3.xyzw  // r13.x <- pointLight1.x; r13.y <- pointLight1.y; r13.z <- pointLight1.z; r13.w <- pointLight1.w

#line 542
  bfi r1.w, l(31), l(1), r1.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r1.wwww, t3.xyzw  // r14.x <- pointLight2.x; r14.y <- pointLight2.y; r14.z <- pointLight2.z
...
#line 287
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id64 return value>

#line 307
  mul r1.w, r1.w, r2.w  // r1.w <- attenuation

#line 677
  dp3 r2.w, r6.xyzx, r13.xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.NdotL_id49
...
#line 715
  dp3_sat r1.w, r13.xyzx, r8.xywx  // r1.w <- streams.LdotH_id77
...
#line 342
  ...
  mul r3.w, r3.w, r3.w
  mul r1.w, r1.w, r3.w
  mad r13.xyz, r13.xyzx, r1.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id143 return value>.x; r13.y <- <FresnelSchlick_id143 return value>.y; r13.z <- <FresnelSchlick_id143 return value>.z

#line 338
  mad r1.w, r2.w, l(0.500000), l(0.500000)
  div r1.w, r2.w, r1.w  // r1.w <- <VisibilityhSchlickGGX_id159 return value>
  mad r3.w, r5.w, l(0.500000), l(0.500000)
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id159 return value>
...
#line 849
  mad r12.xyz, r13.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000), r8.xywx  // r12.x <- directLightingContribution.x; r12.y <- directLightingContribution.y; r12.z <- directLightingContribution.z
...
mov r2.w, r5.z  // r2.w <- streams.lightIndex_id96
mov r3.w, l(0)  // r3.w <- i
loop 
  ige r4.w, r3.w, r0.x
  breakc_nz r4.w
...
#line 511
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id96

#line 513
  ishl r5.w, r4.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r11.xyz, r5.wwww, t4.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z
...
#line 342
  ...
  mul r6.w, r6.w, r6.w
  mul r4.w, r4.w, r6.w
  mad r14.xyz, r14.xyzx, r4.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id143 return value>.x; r14.y <- <FresnelSchlick_id143 return value>.y; r14.z <- <FresnelSchlick_id143 return value>.z
...
#line 426
  mul r4.w, r4.w, r6.w
  mul r5.w, r1.w, r5.w
  div r4.w, r4.w, r5.w  // r4.w <- <VisibilitySmithSchlickGGX_id161 return value>
...
#line 875
endloop   // r2.w <- streams.lightIndex_id96
...
#line 488
mad r0.xyz, r3.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <Compute_id296 return value>.x; r0.y <- <Compute_id296 return value>.y; r0.z <- <Compute_id296 return value>.z

#line 638
mul r3.xyz, r0.xyzx, cb2[43].xyzx  // r3.x <- <ComputeEnvironmentLightContribution_id475 return value>.x; r3.y <- <ComputeEnvironmentLightContribution_id475 return value>.y; r3.z <- <ComputeEnvironmentLightContribution_id475 return value>.z
...
#line 387
mad r5.xyz, cb2[45].xyzx, r1.wwww, cb2[44].xyzx  // r5.x <- color.x; r5.y <- color.y; r5.z <- color.z

#line 388
mad r5.xyz, cb2[46].xyzx, -r2.wwww, r5.xyzx

#line 389
mad r5.xyz, cb2[47].xyzx, r0.wwww, r5.xyzx

#line 392
mul r6.xyz, r1.wwww, cb2[48].xyzx
mad r5.xyz, r6.xyzx, r0.wwww, r5.xyzx

#line 393
mul r6.xyz, r1.wwww, cb2[49].xyzx
mad r5.xyz, r6.xyzx, -r2.wwww, r5.xyzx

#line 394
mad r1.w, r4.w, l(3.000000), l(-1.000000)
mad r5.xyz, cb2[50].xyzx, r1.wwww, r5.xyzx

#line 395
mul r6.xyz, r0.wwww, cb2[51].xyzx
mad r5.xyz, r6.xyzx, -r2.wwww, r5.xyzx

#line 396
mad r0.w, r0.w, r0.w, -r3.w
mad r5.xyz, cb2[52].xyzx, r0.wwww, r5.xyzx
...
#line 473
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t5.xyzw, s0, cb2[52].w  // r6.x <- <Compute_id234 return value>.x; r6.y <- <Compute_id234 return value>.y; r6.z <- <Compute_id234 return value>.z
...
#line 899
mad r3.xyz, r0.xyzx, r6.xyzx, r3.xyzx
...
#line 362
mad r5.xyz, cb2[59].xyzx, r1.wwww, cb2[58].xyzx  // r5.x <- color.x; r5.y <- color.y; r5.z <- color.z

#line 363
mad r5.xyz, cb2[60].xyzx, -r1.xxxx, r5.xyzx

#line 364
mad r5.xyz, cb2[61].xyzx, r0.wwww, r5.xyzx

#line 367
mul r6.xyz, r1.wwww, cb2[62].xyzx
mad r5.xyz, r6.xyzx, r0.wwww, r5.xyzx

#line 368
mul r6.xyz, r1.wwww, cb2[63].xyzx
...
#line 370
mul r6.xyz, r0.wwww, cb2[65].xyzx
...
dp3 r0.w, r2.xyzx, cb2[69].xyzx  // r0.w <- sampleDirection.z

#line 620
mov r5.z, -r0.w  // r5.z <- sampleDirection.z

#line 458
sample_l_indexable(texturecube)(float,float,float,float) r2.xyz, r5.xyzx, t6.xyzw, s0, cb2[66].w  // r2.x <- <Compute_id254 return value>.x; r2.y <- <Compute_id254 return value>.y; r2.z <- <Compute_id254 return value>.z
...
#line 911
mad r0.xyz, r0.xyzx, r2.xyzx, r1.xyzx  // r0.x <- environmentLightingContribution.x; r0.y <- environmentLightingContribution.y; r0.z <- environmentLightingContribution.z
...
const static bool TInvert_id198 = true;
const static float Value_id194 = 1;
...
float3 Compute_id296(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id207.SampleLevel(LinearSampler_id140, float2(glossiness, nDotV), 0);
...
void AfterLightingAndShading_id426()
{
}
...
float3 ComputeEnvironmentLightContribution_id475(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id296(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
float3 ComputeDirectLightContribution_id474(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id328(streams, specularColor);
    float geometricShadowing = Compute_id358(streams);
...
float3 ComputeDirectLightContribution_id418(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id206 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id423()
{
}
...
void Compute_id506(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id423();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id418(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id474(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id475(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id206 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id426();
    }
...
{
    float metalness = Compute_id294().r;
...
{
    float glossiness = Compute_id293().r;
