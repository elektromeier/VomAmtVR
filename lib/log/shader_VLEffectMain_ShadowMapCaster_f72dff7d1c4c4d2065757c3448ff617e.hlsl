...
//
#line 174 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_f72dff7d1c4c4d2065757c3448ff617e.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 InputValue_id109;
    float InputValue_id126;
    float InputValue_id135;
    float2 InputValue_id204;
    float2 InputValue_id212;
    float2 InputValue_id228;
};
cbuffer PerView 
{
    float4x4 View_id24;
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id146;
    float2 Texture1TexelSize_id148;
    float2 Texture2TexelSize_id150;
    float2 Texture3TexelSize_id152;
    float2 Texture4TexelSize_id154;
    float2 Texture5TexelSize_id156;
    float2 Texture6TexelSize_id158;
    float2 Texture7TexelSize_id160;
    float2 Texture8TexelSize_id162;
    float2 Texture9TexelSize_id164;
};
Texture2D Texture0_id145;
Texture2D Texture1_id147;
Texture2D Texture2_id149;
Texture2D Texture3_id151;
Texture2D Texture4_id153;
Texture2D Texture5_id155;
Texture2D Texture6_id157;
Texture2D Texture7_id159;
Texture2D Texture8_id161;
Texture2D Texture9_id163;
TextureCube TextureCube0_id165;
TextureCube TextureCube1_id166;
TextureCube TextureCube2_id167;
TextureCube TextureCube3_id168;
Texture3D Texture3D0_id169;
Texture3D Texture3D1_id170;
Texture3D Texture3D2_id171;
Texture3D Texture3D3_id172;
SamplerState Sampler_id173;
SamplerState PointSampler_id174 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id175 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id176 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id177 
{
...
SamplerState AnisotropicSampler_id178 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id179 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id180 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id181 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id182 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id183;
SamplerState Sampler1_id184;
SamplerState Sampler2_id185;
SamplerState Sampler3_id186;
SamplerState Sampler4_id187;
SamplerState Sampler5_id188;
SamplerState Sampler6_id189;
SamplerState Sampler7_id190;
SamplerState Sampler8_id191;
SamplerState Sampler9_id192;
StructuredBuffer<InstanceTransform> InstanceWorld_id39;
StructuredBuffer<InstanceTransform> InstanceWorldInverse_id40;
Buffer<float2> DynamicBuffer_id100;
Texture2D DynamicTexture_id116;
SamplerState DynamicSampler_id117;
Buffer<float2> DynamicBuffer_id219;
Texture2D DynamicTexture_id235;
SamplerState DynamicSampler_id236;
Buffer<float> DynamicBuffer_id245;
