...
@P   - Material.PixelStageSurfaceShaders: mixin MaterialSurfaceArray [{layers = [mixin MaterialSurfaceDiffuse [{diffuseMap = mixin Float4ToColor [{Value = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_2> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerMaterial>}], mixin AssignVarFloat2<Plus_3> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_4,TEXCOORD0>}, {Right = GetVarFloat2<Input_2>}]}], mixin AssignVarFloat2<Input_5> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i1,PerMaterial>}], mixin AssignVarFloat2<Multiply_6> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_3>}, {Right = GetVarFloat2<Input_5>}]}], mixin AssignVarFloat2<Input_7> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i2,PerMaterial>}], mixin AssignVarFloat2<Plus_8> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_6>}, {Right = GetVarFloat2<Input_7>}]}], mixin AssignVarFloat4<TextureValue_9> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx0,PerMaterial,ObjectSampler_fx1,PerMaterial> [{TexCd = GetVarFloat2<Plus_8>}]}]]}]}, {Value = GetVarFloat4<TextureValue_9>}]}]}], mixin MaterialSurfaceGlossinessMap<true> [{glossinessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_12> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i3,PerMaterial>}], mixin AssignVarFloat2<Plus_13> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_14,TEXCOORD0>}, {Right = GetVarFloat2<Input_12>}]}], mixin AssignVarFloat2<Input_15> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i4,PerMaterial>}], mixin AssignVarFloat2<Multiply_16> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_13>}, {Right = GetVarFloat2<Input_15>}]}], mixin AssignVarFloat2<Input_17> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i5,PerMaterial>}], mixin AssignVarFloat2<Plus_18> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_16>}, {Right = GetVarFloat2<Input_17>}]}], mixin AssignVarFloat4<TextureValue_19> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx10,PerMaterial,ObjectSampler_fx11,PerMaterial> [{TexCd = GetVarFloat2<Plus_18>}]}], mixin AssignVarFloat<Member_20> [{Value = mixin GetMemberFloat4Float<r> [{Value = GetVarFloat4<TextureValue_19>}]}]]}]}, {Value = GetVarFloat<Member_20>}]}]}], mixin MaterialSurfaceMetalness [{metalnessMap = mixin FloatToScalar [{Value = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [ComputeVoid, ComputeVoid, ComputeVoid, mixin AssignVarFloat2<Input_23> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i6,PerMaterial>}], mixin AssignVarFloat2<Plus_24> [{Value = mixin PlusFloat2 [{Left = GetSemanticFloat2<SemanticValue_25,TEXCOORD0>}, {Right = GetVarFloat2<Input_23>}]}], mixin AssignVarFloat2<Input_26> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i7,PerMaterial>}], mixin AssignVarFloat2<Multiply_27> [{Value = mixin MultiplyFloat2 [{Left = GetVarFloat2<Plus_24>}, {Right = GetVarFloat2<Input_26>}]}], mixin AssignVarFloat2<Input_28> [{Value = InputFloat2<ShaderFX.InputValueFloat2.i8,PerMaterial>}], mixin AssignVarFloat2<Plus_29> [{Value = mixin PlusFloat2 [{Left = GetVarFloat2<Multiply_27>}, {Right = GetVarFloat2<Input_28>}]}], mixin AssignVarFloat4<TextureValue_30> [{Value = mixin SampleTextureFloat4<ObjectTexture_fx21,PerMaterial,ObjectSampler_fx22,PerMaterial> [{TexCd = GetVarFloat2<Plus_29>}]}], mixin AssignVarFloat<Member_31> [{Value = mixin GetMemberFloat4Float<r> [{Value = GetVarFloat4<TextureValue_30>}]}]]}]}, {Value = GetVarFloat<Member_31>}]}]}], mixin MaterialSurfaceLightingAndShading [{surfaces = [MaterialSurfaceShadingDiffuseLambert<false>, mixin MaterialSurfaceShadingSpecularMicrofacet [{environmentFunction = MaterialSpecularMicrofacetEnvironmentGGXLUT}, {fresnelFunction = MaterialSpecularMicrofacetFresnelSchlick}, {geometricShadowingFunction = MaterialSpecularMicrofacetVisibilitySmithSchlickGGX}, {normalDistributionFunction = MaterialSpecularMicrofacetNormalDistributionGGX}]]}]]}]
...
@R    DynamicSampler_id267 => ObjectSampler_fx11 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id302 => ObjectTexture_fx21 [Stage: None, Slot: (-1--1)]
@R    DynamicTexture_id302 => ObjectTexture_fx21 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id303 => ObjectSampler_fx22 [Stage: None, Slot: (-1--1)]
@R    DynamicSampler_id303 => ObjectSampler_fx22 [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id319 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
@R    EnvironmentLightingDFG_LUT_id319 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: None, Slot: (-1--1)]
...
@R    DynamicSampler_id303 => ObjectSampler_fx22 [Stage: Pixel, Slot: (4-4)]
...
@R    DynamicTexture_id302 => ObjectTexture_fx21 [Stage: Pixel, Slot: (2-2)]
@R    EnvironmentLightingDFG_LUT_id319 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (3-3)]
...
//
#line 1959 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_c7abcdaf29bba232a7e88dcd5da4f062.hlsl"
...
@G    Pixel => 999da9dd12b0c7f175769d5b538c1243
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// DynamicTexture_id302              texture  float4          2d             t2      1 
// EnvironmentLightingDFG_LUT_id319    texture  float4          2d             t3      1 
...
//
#line 2027 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_c7abcdaf29bba232a7e88dcd5da4f062.hlsl"
...
#line 730
add r4.xy, v4.xyxx, cb1[0].xyxx  // r4.x <- <Compute_id358 return value>.x; r4.y <- <Compute_id358 return value>.y

#line 714
mad r4.xy, r4.xyxx, cb1[0].zwzz, cb1[1].xyxx  // r4.x <- <Compute_id374 return value>.x; r4.y <- <Compute_id374 return value>.y

#line 710
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t0.xyzw, s2  // r4.x <- <Compute_id378 return value>.x; r4.y <- <Compute_id378 return value>.y; r4.z <- <Compute_id378 return value>.z; r4.w <- <Compute_id378 return value>.w

#line 702
add r5.xy, v4.xyxx, cb1[1].zwzz  // r5.x <- <Compute_id411 return value>.x; r5.y <- <Compute_id411 return value>.y

#line 686
mad r5.xy, r5.xyxx, cb1[2].xyxx, cb1[2].zwzz  // r5.x <- <Compute_id427 return value>.x; r5.y <- <Compute_id427 return value>.y

#line 682
sample_indexable(texture2d)(float,float,float,float) r0.w, r5.xyxx, t1.yzwx, s3  // r0.w <- <Compute_id431 return value>.x

#line 1878
add r0.w, -r0.w, l(1.000000)  // r0.w <- glossiness

#line 670
add r5.xy, v4.xyxx, cb1[3].xyxx  // r5.x <- <Compute_id470 return value>.x; r5.y <- <Compute_id470 return value>.y

#line 654
mad r5.xy, r5.xyxx, cb1[3].zwzz, cb1[4].xyxx  // r5.x <- <Compute_id486 return value>.x; r5.y <- <Compute_id486 return value>.y

#line 650
sample_indexable(texture2d)(float,float,float,float) r1.w, r5.xyxx, t2.yzwx, s4  // r1.w <- <Compute_id490 return value>.x

#line 1870
add r5.xyz, r4.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r5.xyz, r1.wwww, r5.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r5.x <- streams.matSpecular_id55.x; r5.y <- streams.matSpecular_id55.y; r5.z <- streams.matSpecular_id55.z

#line 1871
mad r4.xyz, r1.wwww, -r4.xyzx, r4.xyzx  // r4.x <- streams.matDiffuse_id53.x; r4.y <- streams.matDiffuse_id53.y; r4.z <- streams.matDiffuse_id53.z
...
#line 634
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id69 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t4.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id69 return value>
...
#line 634
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t4.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id69 return value>

#line 815
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 634
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t4.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id69 return value>
...
#line 634
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t4.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id69 return value>
...
#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r15.xyxx, t4.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id69 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.zwzz, t4.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id69 return value>
...
#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r17.xyxx, t4.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id69 return value>

#line 815
      mad r3.w, r7.x, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r18.xyxx, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r13.x, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r16.xyxx, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r10.y, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r16.zwzz, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r20.x, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r17.zwzz, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r9.z, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r18.zwzz, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r12.x, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r19.xyxx, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r7.y, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r19.zwzz, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r9.w, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.zwzz, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r20.y, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r13.ywyy, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r10.z, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r21.xyxx, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r13.z, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r21.zwzz, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r12.z, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r12.ywyy, t4.xxxx, s1, r7.z

#line 815
      mad r3.w, r10.w, r5.w, r3.w

#line 634
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r9.xyxx, t4.xxxx, s1, r7.z
...
#line 785
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r5.xyzx  // r8.x <- <FresnelSchlick_id183 return value>.x; r8.y <- <FresnelSchlick_id183 return value>.y; r8.z <- <FresnelSchlick_id183 return value>.z
...
#line 781
  ...
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id199 return value>

#line 1032
  mul r2.x, r2.x, r5.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 1028
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id213 return value>
...
#line 1585
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id700 return value>.x; r7.y <- <ComputeDirectLightContribution_id700 return value>.y; r7.z <- <ComputeDirectLightContribution_id700 return value>.z
...
#line 1347
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r0.xy, r7.xyzw, t5.xyzw  // r0.x <- streams.lightData_id173.x; r0.y <- streams.lightData_id173.y
...
#line 1331
  ld_indexable(buffer)(uint,uint,uint,uint) r2.w, r6.zzzz, t6.yzwx  // r2.w <- realLightIndex
...
#line 374
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id83 return value>
...
#line 781
  ...
  div r12.w, r3.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 1032
  mul r5.w, r5.w, r12.w
  mul r3.w, r6.w, r3.w
  div r3.w, r5.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 1028
  ...
  div r2.w, r5.w, r2.w  // r2.w <- <NormalDistributionGGX_id213 return value>
...
#line 368
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id94 return value>
...
#line 781
  ...
  div r6.w, r2.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r3.w, r11.z, r5.w, r3.w
  div r3.w, r11.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id199 return value>
...
#line 785
  ...
  mul r6.z, r6.z, r6.z
  mul r3.w, r3.w, r6.z
  mad r15.xyz, r15.xyzx, r3.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id183 return value>.x; r15.y <- <FresnelSchlick_id183 return value>.y; r15.z <- <FresnelSchlick_id183 return value>.z

#line 780
  mul r3.w, r10.x, l(0.500000)  // r3.w <- k

#line 781
  mad r6.z, -r10.x, l(0.500000), l(1.000000)
  mad r6.w, r5.w, r6.z, r3.w
  div r6.w, r5.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id199 return value>
  mad r3.w, r10.z, r6.z, r3.w
  div r3.w, r10.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id199 return value>

#line 1032
  mul r3.w, r3.w, r6.w
  mul r5.w, r10.z, r5.w
  div r3.w, r3.w, r5.w  // r3.w <- <VisibilitySmithSchlickGGX_id201 return value>
...
#line 1027
  mul r2.w, r2.w, r2.w
  mad r6.z, r10.x, r10.x, l(-1.000000)
...
#line 544
  dp3 r5.w, -cb0[r2.w + 158].xyzx, r13.xyzx  // r5.w <- cd

#line 545
  mad_sat r5.w, r5.w, cb0[r2.w + 159].x, cb0[r2.w + 159].y  // r5.w <- attenuation
...
#line 1238
mad r0.yzw, r5.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id522 return value>.x; r0.z <- <Compute_id522 return value>.y; r0.w <- <Compute_id522 return value>.z

#line 1475
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id701 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id701 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id701 return value>.z
...
#line 1223
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t9.xyzw, s0, r1.w  // r6.x <- <Compute_id312 return value>.x; r6.y <- <Compute_id312 return value>.y; r6.z <- <Compute_id312 return value>.z
...
#line 1208
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r5.xyzx, t10.xyzw, s0, r0.x  // r3.x <- <Compute_id332 return value>.x; r3.y <- <Compute_id332 return value>.y; r3.z <- <Compute_id332 return value>.z
...
mov o0.w, r4.w
ret 
// Approximately 649 instruction slots used
***************************
*************************/
...
const static bool TInvert_id277 = true;
const static bool TIsEnergyConservative_id316 = false;
static const float PI_id318 = 3.14159265358979323846;
struct PS_STREAMS 
{
    ...
    float Member_20_id270;
    float2 Input_23_id279;
    float2 Plus_24_id282;
    float2 Input_26_id287;
    float2 Multiply_27_id290;
    float2 Input_28_id294;
    float2 Plus_29_id297;
    float4 TextureValue_30_id301;
    float Member_31_id306;
...
Texture2D EnvironmentLightingDFG_LUT_id319;
...
float4 Compute_id491(inout PS_STREAMS streams)
{
    return streams.TextureValue_30_id301;
}
float2 Compute_id487(inout PS_STREAMS streams)
{
    return streams.Plus_29_id297;
}
float2 Compute_id483(inout PS_STREAMS streams)
{
    return streams.Input_28_id294;
}
float2 Compute_id481(inout PS_STREAMS streams)
{
    return streams.Multiply_27_id290;
}
float2 Compute_id475(inout PS_STREAMS streams)
{
    return streams.Input_26_id287;
}
float2 Compute_id473(inout PS_STREAMS streams)
{
    return streams.Plus_24_id282;
}
float2 Compute_id467(inout PS_STREAMS streams)
{
    return streams.Input_23_id279;
}
...
float2 Compute_id416(inout PS_STREAMS streams)
{
    return streams.Input_15_id251;
}
float2 Compute_id414(inout PS_STREAMS streams)
{
    return streams.Plus_13_id246;
}
float2 Compute_id408(inout PS_STREAMS streams)
{
    return streams.Input_12_id243;
}
float2 Compute_id406(inout PS_STREAMS streams)
{
    return streams.TexCoord_id140;
}
...
float2 Compute_id355(inout PS_STREAMS streams)
{
    return streams.Input_2_id211;
}
float2 Compute_id353(inout PS_STREAMS streams)
{
    return streams.TexCoord_id140;
}
...
{
    return Compute_id491(streams).r;
}
float4 Compute_id490(inout PS_STREAMS streams)
{
    return DynamicTexture_id302.Sample(DynamicSampler_id303, Compute_id487(streams));
}
...
{
    return Compute_id473(streams) * Compute_id475(streams);
}
float2 Compute_id471()
{
    return InputValue_id288;
}
float2 Compute_id470(inout PS_STREAMS streams)
{
    return Compute_id465(streams) + Compute_id467(streams);
}
float2 Compute_id463()
{
    return InputValue_id280;
}
float Compute_id435(inout PS_STREAMS streams)
{
    return Compute_id432(streams).r;
}
float4 Compute_id431(inout PS_STREAMS streams)
{
    return DynamicTexture_id266.Sample(DynamicSampler_id267, Compute_id428(streams));
}
...
float2 Compute_id419(inout PS_STREAMS streams)
{
    return Compute_id414(streams) * Compute_id416(streams);
}
float2 Compute_id412()
{
    return InputValue_id252;
}
float2 Compute_id411(inout PS_STREAMS streams)
{
    return Compute_id406(streams) + Compute_id408(streams);
}
float2 Compute_id404()
{
    return InputValue_id244;
}
float4 Compute_id378(inout PS_STREAMS streams)
{
    return DynamicTexture_id234.Sample(DynamicSampler_id235, Compute_id375(streams));
}
...
float2 Compute_id358(inout PS_STREAMS streams)
{
    return Compute_id353(streams) + Compute_id355(streams);
}
float2 Compute_id351()
{
...
{
    streams.Member_31_id306 = Compute_id494(streams);
}
void Compute_id511(inout PS_STREAMS streams)
{
    streams.TextureValue_30_id301 = Compute_id490(streams);
}
void Compute_id509(inout PS_STREAMS streams)
{
    streams.Plus_29_id297 = Compute_id486(streams);
}
void Compute_id507(inout PS_STREAMS streams)
{
    streams.Input_28_id294 = Compute_id479();
}
void Compute_id505(inout PS_STREAMS streams)
{
    streams.Multiply_27_id290 = Compute_id478(streams);
}
void Compute_id503(inout PS_STREAMS streams)
{
    streams.Input_26_id287 = Compute_id471();
}
void Compute_id501(inout PS_STREAMS streams)
{
    streams.Plus_24_id282 = Compute_id470(streams);
}
void Compute_id499(inout PS_STREAMS streams)
{
    streams.Input_23_id279 = Compute_id463();
}
void Compute_id497()
{
}
...
{
    streams.Member_20_id270 = Compute_id435(streams);
}
void Compute_id452(inout PS_STREAMS streams)
{
    streams.TextureValue_19_id265 = Compute_id431(streams);
}
void Compute_id450(inout PS_STREAMS streams)
{
    streams.Plus_18_id261 = Compute_id427(streams);
}
void Compute_id448(inout PS_STREAMS streams)
{
    streams.Input_17_id258 = Compute_id420();
}
void Compute_id446(inout PS_STREAMS streams)
{
    streams.Multiply_16_id254 = Compute_id419(streams);
}
void Compute_id444(inout PS_STREAMS streams)
{
    streams.Input_15_id251 = Compute_id412();
}
void Compute_id442(inout PS_STREAMS streams)
{
    streams.Plus_13_id246 = Compute_id411(streams);
}
void Compute_id440(inout PS_STREAMS streams)
{
    streams.Input_12_id243 = Compute_id404();
}
void Compute_id438()
{
}
...
{
    streams.TextureValue_9_id233 = Compute_id378(streams);
}
void Compute_id393(inout PS_STREAMS streams)
{
    streams.Plus_8_id229 = Compute_id374(streams);
}
void Compute_id391(inout PS_STREAMS streams)
{
    streams.Input_7_id226 = Compute_id367();
}
void Compute_id389(inout PS_STREAMS streams)
{
    streams.Multiply_6_id222 = Compute_id366(streams);
}
void Compute_id387(inout PS_STREAMS streams)
{
    streams.Input_5_id219 = Compute_id359();
}
void Compute_id385(inout PS_STREAMS streams)
{
    streams.Plus_3_id214 = Compute_id358(streams);
}
void Compute_id383(inout PS_STREAMS streams)
{
    streams.Input_2_id211 = Compute_id351();
}
void Compute_id381()
{
}
...
float Compute_id516(inout PS_STREAMS streams)
{
    return streams.Member_31_id306;
}
...
{
    return streams.Member_20_id270;
}
...
float3 Compute_id522(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id319.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
float Compute_id519(inout PS_STREAMS streams)
{
    Compute_id515(streams);
    return Compute_id516(streams);
}
...
void AfterLightingAndShading_id671()
{
}
void AfterLightingAndShading_id652()
{
}
...
float3 ComputeEnvironmentLightContribution_id701(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    return Compute_id522(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id645(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id700(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id554(streams, specularColor);
    float geometricShadowing = Compute_id584(streams);
    float normalDistribution = Compute_id614(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id644(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id318 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
void PrepareForLightingAndShading_id668()
{
}
void PrepareForLightingAndShading_id649()
{
}
...
float4 Compute_id521(inout PS_STREAMS streams)
{
    float x = Compute_id519(streams);
    return float4(x, x, x, x);
}
float4 Compute_id462(inout PS_STREAMS streams)
{
    float x = Compute_id460(streams);
    return float4(x, x, x, x);
}
...
void Compute_id732(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id649();
    }

    {
        PrepareForLightingAndShading_id668();
    }
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id644(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id700(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id645(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id701(streams);
        }
    }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id318 + environmentLightingContribution;
    streams.shadingColorAlpha_id74 = streams.matDiffuse_id53.a;

    {
        AfterLightingAndShading_id652();
    }

    {
        AfterLightingAndShading_id671();
    }
}
void Compute_id716(inout PS_STREAMS streams)
{
    float metalness = Compute_id521(streams).r;
...
void Compute_id711(inout PS_STREAMS streams)
{
    float glossiness = Compute_id462(streams).r;
...
void Compute_id706(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id403(streams);
