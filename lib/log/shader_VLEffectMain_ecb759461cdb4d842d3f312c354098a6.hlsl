...
@R    InstanceWorldInverse_id41 => TransformationInstancing.InstanceWorldInverse [Stage: None, Slot: (-1--1)]
@R    DynamicBuffer_id248 => ObjectBuffer_fx3 [Stage: None, Slot: (-1--1)]
@R    DynamicBuffer_id248 => ObjectBuffer_fx3 [Stage: None, Slot: (-1--1)]
...
@R    DynamicBuffer_id248 => ObjectBuffer_fx3 [Stage: Pixel, Slot: (0-0)]
@R    EnvironmentLightingDFG_LUT_id262 => MaterialSpecularMicrofacetEnvironmentGGXLUT.EnvironmentLightingDFG_LUT [Stage: Pixel, Slot: (1-1)]
...
//
#line 1586 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ecb759461cdb4d842d3f312c354098a6.hlsl"
...
@G    Pixel => 6245f1331393751945ccd9a7283885a5
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
// DynamicBuffer_id248               texture   float         buf             t0      1 
// EnvironmentLightingDFG_LUT_id262    texture  float4          2d             t1      1 
...
//
#line 1708 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ecb759461cdb4d842d3f312c354098a6.hlsl"
...
#line 536
ld_indexable(buffer)(float,float,float,float) r1.w, v4.xxxx, t0.yzwx  // r1.w <- <Compute_id415 return value>
...
#line 524
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id74 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r10.z, r14.zwzz, t2.xxxx, s1, r8.z  // r10.z <- <SampleTextureAndCompare_id74 return value>
...
#line 524
  sample_c_lz_indexable(texture2d)(float,float,float,float) r9.x, r16.xyxx, t2.xxxx, s1, r8.z  // r9.x <- <SampleTextureAndCompare_id74 return value>

#line 629
  mad r6.z, r6.z, r9.x, r8.w  // r6.z <- shadow

#line 524
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t2.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id74 return value>
...
#line 524
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r18.zwzz, t2.xxxx, s1, r8.z  // r6.w <- <SampleTextureAndCompare_id74 return value>
...
#line 524
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r15.xyxx, t2.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id74 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r15.zwzz, t2.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id74 return value>
...
#line 524
      sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r17.xyxx, t2.xxxx, s1, r7.z  // r5.w <- <SampleTextureAndCompare_id74 return value>
...
#line 1229
  mul r2.xyz, r2.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id606 return value>.x; r2.y <- <ComputeDirectLightContribution_id606 return value>.y; r2.z <- <ComputeDirectLightContribution_id606 return value>.z
...
#line 599
  ...
  mul r5.w, r5.w, r10.w
  mad r13.xyz, r13.xyzx, r5.wwww, r11.xyzx  // r13.x <- <FresnelSchlick_id196 return value>.x; r13.y <- <FresnelSchlick_id196 return value>.y; r13.z <- <FresnelSchlick_id196 return value>.z
...
#line 595
  ...
  div r12.w, r4.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r5.w, r6.w, r10.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id212 return value>
...
#line 599
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r16.xyz, r16.xyzx, r4.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id196 return value>.x; r16.y <- <FresnelSchlick_id196 return value>.y; r16.z <- <FresnelSchlick_id196 return value>.z

#line 594
  mul r4.w, r7.y, l(0.500000)  // r4.w <- k

#line 595
  mad r5.w, -r7.y, l(0.500000), l(1.000000)
  mad r6.w, r3.w, r5.w, r4.w
  div r6.w, r3.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r4.w, r7.w, r5.w, r4.w
  div r4.w, r7.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id212 return value>
...
#line 746
  mul r4.w, r7.y, r7.y  // r4.w <- alphaR2
...
#line 595
  ...
  div r6.z, r4.w, r6.z  // r6.z <- <VisibilityhSchlickGGX_id212 return value>
...
#line 746
  mul r4.w, r2.y, r2.y  // r4.w <- alphaR2
...
#line 332
  mul r3.w, r3.w, cb0[r2.z + 63].z  // r3.w <- factor
...
#line 434
  dp3 r4.w, -cb0[r2.z + 62].xyzx, r13.xyzx  // r4.w <- cd

#line 435
  mad_sat r4.w, r4.w, cb0[r2.z + 63].x, cb0[r2.z + 63].y  // r4.w <- attenuation
...
#line 1138
  mul r14.xyz, r3.wwww, cb0[r2.z + 64].xyzx
  mul r14.xyz, r4.wwww, r14.xyzx  // r14.x <- streams.lightColorNdotL_id46.x; r14.y <- streams.lightColorNdotL_id46.y; r14.z <- streams.lightColorNdotL_id46.z
...
#line 872
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id428 return value>.x; r0.z <- <Compute_id428 return value>.y; r0.w <- <Compute_id428 return value>.z

#line 1119
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id607 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id607 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id607 return value>.z
...
#line 857
sample_l_indexable(texturecube)(float,float,float,float) r6.xyz, r6.xyzx, t7.xyzw, s0, r2.w  // r6.x <- <Compute_id328 return value>.x; r6.y <- <Compute_id328 return value>.y; r6.z <- <Compute_id328 return value>.z
...
#line 842
sample_l_indexable(texturecube)(float,float,float,float) r3.xyz, r4.xyzx, t8.xyzw, s0, r0.x  // r3.x <- <Compute_id348 return value>.x; r3.y <- <Compute_id348 return value>.y; r3.z <- <Compute_id348 return value>.z
...
Buffer<float> DynamicBuffer_id248;
...
uint Compute_id412(inout PS_STREAMS streams)
{
...
{
    return DynamicBuffer_id248[Compute_id412(streams)];
}
float Compute_id391()
{
...
{
    streams.BufferItem_4_id247 = Compute_id415(streams);
}
void Compute_id417()
{
}
...
{
    streams.Input_2_id230 = Compute_id391();
}
void Compute_id382(inout PS_STREAMS streams)
{
    streams.Input_1_id221 = Compute_id379();
}
void Compute_id370(inout PS_STREAMS streams)
{
    streams.Input_0_id213 = Compute_id367();
}
...
{
    return streams.BufferItem_4_id247;
}
...
float3 Compute_id428(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id262.SampleLevel(LinearSampler_id124, float2(glossiness, nDotV), 0);
...
float4 Compute_id409()
{
    Compute_id405();
    return Compute_id406();
}
...
void AfterLightingAndShading_id577()
{
}
void AfterLightingAndShading_id558()
{
}
...
float3 ComputeEnvironmentLightContribution_id607(inout PS_STREAMS streams)
{
    ...
    return Compute_id428(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
{
    float3 specularColor = streams.matSpecularVisible_id73;
    float3 fresnel = Compute_id460(streams, specularColor);
    float geometricShadowing = Compute_id490(streams);
    float normalDistribution = Compute_id520(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id71;
    return diffuseColor / PI_id261 * streams.lightColorNdotL_id46 * streams.matDiffuseSpecularAlphaBlend_id67.x;
}
...
void PrepareForLightingAndShading_id574()
{
}
void PrepareForLightingAndShading_id555()
{
}
...
float4 Compute_id427(inout PS_STREAMS streams)
{
    float x = Compute_id425(streams);
    return float4(x, x, x, x);
}
float4 Compute_id411()
{
    return Compute_id409();
}
...
void Compute_id648(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id555();
    }

    {
        PrepareForLightingAndShading_id574();
    }
    ...
    streams.shadingColor_id75 += directLightingContribution * PI_id261 + environmentLightingContribution;
    streams.shadingColorAlpha_id76 = streams.matDiffuse_id55.a;

    {
        AfterLightingAndShading_id558();
    }

    {
        AfterLightingAndShading_id577();
    }
}
void Compute_id632(inout PS_STREAMS streams)
{
    streams.matEmissiveIntensity_id65 = Compute_id427(streams).r;
}
void Compute_id627(inout PS_STREAMS streams)
{
    streams.matEmissive_id64 = Compute_id411().rgba;
}
