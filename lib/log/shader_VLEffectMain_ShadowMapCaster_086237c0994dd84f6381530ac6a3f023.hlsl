...
//
#line 175 "C:\Users\elektromeier\Desktop\VomAmt\VomAmtVR\lib\log\shader_VLEffectMain_ShadowMapCaster_086237c0994dd84f6381530ac6a3f023.hlsl"
...
cbuffer Globals 
{
    float2 Texture0TexelSize_id227;
    float2 Texture1TexelSize_id229;
    float2 Texture2TexelSize_id231;
    float2 Texture3TexelSize_id233;
    float2 Texture4TexelSize_id235;
    float2 Texture5TexelSize_id237;
    float2 Texture6TexelSize_id239;
    float2 Texture7TexelSize_id241;
    float2 Texture8TexelSize_id243;
    float2 Texture9TexelSize_id245;
};
Texture2D Texture0_id226;
Texture2D Texture1_id228;
Texture2D Texture2_id230;
Texture2D Texture3_id232;
Texture2D Texture4_id234;
Texture2D Texture5_id236;
Texture2D Texture6_id238;
Texture2D Texture7_id240;
Texture2D Texture8_id242;
Texture2D Texture9_id244;
TextureCube TextureCube0_id246;
TextureCube TextureCube1_id247;
TextureCube TextureCube2_id248;
TextureCube TextureCube3_id249;
Texture3D Texture3D0_id250;
Texture3D Texture3D1_id251;
Texture3D Texture3D2_id252;
Texture3D Texture3D3_id253;
SamplerState Sampler_id254;
SamplerState PointSampler_id255 
{
    Filter = MIN_MAG_MIP_POINT;
};
SamplerState LinearSampler_id256 
{
    Filter = MIN_MAG_MIP_LINEAR;
};
SamplerState LinearBorderSampler_id257 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Border;
    AddressV = Border;
};
SamplerComparisonState LinearClampCompareLessEqualSampler_id258 
{
...
SamplerState AnisotropicSampler_id259 
{
    Filter = ANISOTROPIC;
};
SamplerState AnisotropicRepeatSampler_id260 
{
    Filter = ANISOTROPIC;
    AddressU = Wrap;
    AddressV = Wrap;
...
SamplerState PointRepeatSampler_id261 
{
    Filter = MIN_MAG_MIP_POINT;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState LinearRepeatSampler_id262 
{
    Filter = MIN_MAG_MIP_LINEAR;
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState RepeatSampler_id263 
{
    AddressU = Wrap;
    AddressV = Wrap;
};
SamplerState Sampler0_id264;
SamplerState Sampler1_id265;
SamplerState Sampler2_id266;
SamplerState Sampler3_id267;
SamplerState Sampler4_id268;
SamplerState Sampler5_id269;
SamplerState Sampler6_id270;
SamplerState Sampler7_id271;
SamplerState Sampler8_id272;
SamplerState Sampler9_id273;
...
Texture2D DynamicTexture_id139;
SamplerState DynamicSampler_id140;
Texture2D DynamicTexture_id173;
SamplerState DynamicSampler_id174;
Texture2D DynamicTexture_id209;
SamplerState DynamicSampler_id210;
Texture2D EnvironmentLightingDFG_LUT_id284;
