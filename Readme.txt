...
For the speech recognition you need a microsoft azure key and copy it to a blank textfile named: "AzureKey.txt" and place it in the "configfiles" folder which is in the main app folder.
